...
const STORY_GENERATION_CONFIGS = [
  ...
  },
  {
    ...
    specTypeConst: 'TEST_SPEC_TYPE_DDL_API',
    displayName: 'DDL API',
    storyComponentName: 'DdlStoryComponent',
    storyArgsTypeName: 'DdlCompatibilitySuiteStoryArgs',
    storyArgsGetter: 'getDdlStoryArgs',
  },
]
