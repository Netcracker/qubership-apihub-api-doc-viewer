export const DDL_API_PRIMARY_KEY_BADGE_COLOR_SCHEMA = 'ux-badge_ddl-api_primary-key';
export const DDL_API_FOREIGN_KEY_BADGE_COLOR_SCHEMA = 'ux-badge_ddl-api_foreign-key';
