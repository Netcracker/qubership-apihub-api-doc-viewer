/**
 * Screenshot tests for JSON Schema Diffs Suite (Extensions) — Existing 1 Array.
 */
import { StoryPage } from "./service/story-page";
import { ViewComponent } from "./service/view-component";
import { storyPage } from "./service/storybook-service";

const META_ID = "json-schema-diffs-suite-extensions-existing-1-array";
...
describe("JSON Schema Diffs Suite (Extensions) - Existing 1 Array", () => {
  let story: StoryPage;
