 ...
 * Edit together with src/stories/json-schema-diffs-suite/extended-combiners-one-level.stories.tsx
 */
...
describe("JSON Schema Diffs Suite/Combiners/Extended Combiners One Level", () => {
  let story: StoryPage;
