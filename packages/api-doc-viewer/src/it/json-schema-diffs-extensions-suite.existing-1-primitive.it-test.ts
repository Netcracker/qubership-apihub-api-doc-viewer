/**
 * Screenshot tests for JSON Schema Diffs Suite (Extensions) — Existing 1 Primitive.
 */
import { StoryPage } from "./service/story-page";
import { ViewComponent } from "./service/view-component";
import { storyPage } from "./service/storybook-service";

const META_ID = "json-schema-diffs-suite-extensions-existing-1-primitive";
...
describe("JSON Schema Diffs Suite (Extensions) - Existing 1 Primitive", () => {
  let story: StoryPage;
