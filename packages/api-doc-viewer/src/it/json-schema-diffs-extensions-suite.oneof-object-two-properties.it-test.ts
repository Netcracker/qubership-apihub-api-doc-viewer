 ...
 * Inheritance — OneOf Object Two Properties.
 */
import { StoryPage } from "./service/story-page";
import { ViewComponent } from "./service/view-component";
import { storyPage } from "./service/storybook-service";

const META_ID = "json-schema-diffs-suite-extensions-node-diff-to-extension-inheritance-oneof-object-two-properties";
...
describe("JSON Schema Diffs Suite (Extensions) - Node Diff to Extension Inheritance - OneOf Object Two Properties", () => {
  let story: StoryPage;
