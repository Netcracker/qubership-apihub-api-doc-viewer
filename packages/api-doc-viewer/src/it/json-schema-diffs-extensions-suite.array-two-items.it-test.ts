 ...
 * Inheritance — Array Two Items.
 */
import { StoryPage } from "./service/story-page";
import { ViewComponent } from "./service/view-component";
import { storyPage } from "./service/storybook-service";

const META_ID = "json-schema-diffs-suite-extensions-node-diff-to-extension-inheritance-array-two-items";
...
describe("JSON Schema Diffs Suite (Extensions) - Node Diff to Extension Inheritance - Array Two Items", () => {
  let story: StoryPage;
