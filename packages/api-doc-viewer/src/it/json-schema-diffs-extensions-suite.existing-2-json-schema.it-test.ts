/**
 * Screenshot tests for JSON Schema Diffs Suite (Extensions) — Existing 2 JSON Schema.
 */
import { StoryPage } from "./service/story-page";
import { ViewComponent } from "./service/view-component";
import { storyPage } from "./service/storybook-service";

const META_ID = "json-schema-diffs-suite-extensions-existing-2-json-schema";
...
describe("JSON Schema Diffs Suite (Extensions) - Existing 2 JSON Schema", () => {
  let story: StoryPage;
