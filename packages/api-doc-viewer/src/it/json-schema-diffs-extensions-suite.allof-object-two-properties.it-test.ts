 ...
 * Inheritance — AllOf Object Two Properties.
 */
import { StoryPage } from "./service/story-page";
import { ViewComponent } from "./service/view-component";
import { storyPage } from "./service/storybook-service";

const META_ID = "json-schema-diffs-suite-extensions-node-diff-to-extension-inheritance-allof-object-two-properties";
...
describe("JSON Schema Diffs Suite (Extensions) - Node Diff to Extension Inheritance - AllOf Object Two Properties", () => {
  let story: StoryPage;
