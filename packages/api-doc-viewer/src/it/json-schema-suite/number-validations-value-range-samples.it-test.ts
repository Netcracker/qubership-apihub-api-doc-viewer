/**
 * Auto-generated screenshot tests for JSON Schema Suite/Number Validations Value Range stories.
 * Regenerate: node --experimental-strip-types bin/generate-json-schema-validation-suite-tests.mjs
 */
import path from 'path'
import { storyPage } from '../service/storybook-service'

const META_ID = 'json-schema-suite-number-validations-value-range'
