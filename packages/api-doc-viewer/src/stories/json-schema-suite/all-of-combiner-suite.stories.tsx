/**
 * Programmatic combiner (allOf) stories.
...
export const Case_026_string_schema_all_of: Story = createCaseStory("026-string-schema-all-of");
export const Case_027_number_schema_all_of: Story = createCaseStory("027-number-schema-all-of");
export const Case_028_integer_schema_all_of: Story = createCaseStory("028-integer-schema-all-of");
export const Case_029_boolean_schema_all_of: Story = createCaseStory("029-boolean-schema-all-of");
export const Case_030_array_schema_all_of: Story = createCaseStory("030-array-schema-all-of");
export const Case_031_object_schema_all_of: Story = createCaseStory("031-object-schema-all-of");
export const Case_032_string_schema_all_of_one_of: Story = createCaseStory("032-string-schema-all-of-one-of");
export const Case_033_number_schema_all_of_one_of: Story = createCaseStory("033-number-schema-all-of-one-of");
export const Case_034_integer_schema_all_of_one_of: Story = createCaseStory("034-integer-schema-all-of-one-of");
export const Case_035_boolean_schema_all_of_one_of: Story = createCaseStory("035-boolean-schema-all-of-one-of");
export const Case_036_array_schema_all_of_one_of: Story = createCaseStory("036-array-schema-all-of-one-of");
export const Case_037_object_schema_all_of_one_of: Story = createCaseStory("037-object-schema-all-of-one-of");
export const Case_038_string_schema_all_of_any_of: Story = createCaseStory("038-string-schema-all-of-any-of");
export const Case_039_number_schema_all_of_any_of: Story = createCaseStory("039-number-schema-all-of-any-of");
export const Case_040_integer_schema_all_of_any_of: Story = createCaseStory("040-integer-schema-all-of-any-of");
export const Case_041_boolean_schema_all_of_any_of: Story = createCaseStory("041-boolean-schema-all-of-any-of");
export const Case_042_array_schema_all_of_any_of: Story = createCaseStory("042-array-schema-all-of-any-of");
export const Case_043_object_schema_all_of_any_of: Story = createCaseStory("043-object-schema-all-of-any-of");
export const Case_044_string_schema_all_of_all_of: Story = createCaseStory("044-string-schema-all-of-all-of");
export const Case_045_number_schema_all_of_all_of: Story = createCaseStory("045-number-schema-all-of-all-of");
export const Case_046_integer_schema_all_of_all_of: Story = createCaseStory("046-integer-schema-all-of-all-of");
export const Case_047_boolean_schema_all_of_all_of: Story = createCaseStory("047-boolean-schema-all-of-all-of");
export const Case_048_array_schema_all_of_all_of: Story = createCaseStory("048-array-schema-all-of-all-of");
export const Case_049_object_schema_all_of_all_of: Story = createCaseStory("049-object-schema-all-of-all-of");
