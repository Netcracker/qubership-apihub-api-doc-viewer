...
const beforeFiles = import.meta.glob(
  "../../../../samples/json-schema-diffs/extensions/existing-2-json-schema/*/before.yaml",
  { as: "raw", eager: true },
) as Record<string, string>;

const afterFiles = import.meta.glob(
  "../../../../samples/json-schema-diffs/extensions/existing-2-json-schema/*/after.yaml",
  { as: "raw", eager: true },
) as Record<string, string>;
...
const meta = {
  title: "JSON Schema Diffs Suite (Extensions)/Existing 2 JSON Schema",
