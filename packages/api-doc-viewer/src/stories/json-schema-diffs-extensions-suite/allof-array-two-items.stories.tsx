...
const beforeFiles = import.meta.glob(
  "../../../../samples/json-schema-diffs/extensions/allof-array-two-items/*/before.yaml",
  { as: "raw", eager: true },
) as Record<string, string>;

const afterFiles = import.meta.glob(
  "../../../../samples/json-schema-diffs/extensions/allof-array-two-items/*/after.yaml",
  { as: "raw", eager: true },
) as Record<string, string>;
...
const meta = {
  title: "JSON Schema Diffs Suite (Extensions)/Node Diff to Extension Inheritance/AllOf Array Two Items",
