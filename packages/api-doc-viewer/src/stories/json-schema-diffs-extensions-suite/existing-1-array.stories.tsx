...
const beforeFiles = import.meta.glob(
  "../../../../samples/json-schema-diffs/extensions/existing-1-array/*/before.yaml",
  { as: "raw", eager: true },
) as Record<string, string>;

const afterFiles = import.meta.glob(
  "../../../../samples/json-schema-diffs/extensions/existing-1-array/*/after.yaml",
  { as: "raw", eager: true },
) as Record<string, string>;
...
const meta = {
  title: "JSON Schema Diffs Suite (Extensions)/Existing 1 Array",
