...
const sampleCases = buildValueRangePlainOas31ProgrammaticSampleCases({ includeOas31Only: true, type: "number" });
...
const meta = {
  ...jsonSchemaNextSamplesStoryMetaBase,
  id: "json-schema-next-number-validations-value-range-oas-3-1",
