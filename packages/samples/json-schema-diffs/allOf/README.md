# AllOf combiner diff samples

Programmatic `allOf` combiner diff cases (Suite 1 "simple combiner", Suite 2 "complex combiner") live
...
Storybook suite: `JSON Schema Diffs Suite/All Of Combiner Diffs Suite`
(`src/stories/json-schema-diffs-suite/all-of-combiner-diffs-suite.stories.tsx`,
`src/it/json-schema-diffs-suite/all-of-combiner-diffs-suite.it-test.ts`).
