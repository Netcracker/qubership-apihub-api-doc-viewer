# JSON Schema diff fixtures — `allOf` combiner

Programmatic `allOf` combiner diff cases. There are no YAML fixtures in this folder: before/after
...
| --- | --- |
| `JSON Schema Diffs Suite/Combiners/All Of Combiner Diffs Suite` | `src/stories/json-schema-diffs-suite/all-of-combiner-diffs-suite.stories.tsx`, `src/it/json-schema-diffs-suite/all-of-combiner-diffs-suite.it-test.ts` |
