# AnyOf combiner diff samples

Programmatic `anyOf` combiner diff cases (Suite 1 "simple combiner", Suite 2 "complex combiner") live
...
Storybook suite: `JSON Schema Diffs Suite/Any Of Combiner Diffs Suite`
(`src/stories/json-schema-diffs-suite/any-of-combiner-diffs-suite.stories.tsx`,
`src/it/json-schema-diffs-suite/any-of-combiner-diffs-suite.it-test.ts`).
