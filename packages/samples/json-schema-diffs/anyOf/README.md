# JSON Schema diff fixtures — `anyOf` combiner

Programmatic `anyOf` combiner diff cases. There are no YAML fixtures in this folder: before/after
...
| --- | --- |
| `JSON Schema Diffs Suite/Combiners/Any Of Combiner Diffs Suite` | `src/stories/json-schema-diffs-suite/any-of-combiner-diffs-suite.stories.tsx`, `src/it/json-schema-diffs-suite/any-of-combiner-diffs-suite.it-test.ts` |
