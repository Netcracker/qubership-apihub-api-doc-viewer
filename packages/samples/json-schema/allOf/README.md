# AllOf combiner samples

Programmatic `allOf` combiner cases (Suite 1 "simple combiner", Suite 2 "complex combiner") live in
...
Storybook suite: `JSON Schema Suite/All Of Combiner Suite`
(`src/stories/json-schema-suite/all-of-combiner-suite.stories.tsx`,
`src/it/json-schema-suite/all-of-combiner-suite.it-test.ts`).
