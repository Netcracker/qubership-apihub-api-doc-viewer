import{j as A}from"./_commonjs-dynamic-modules-6308e768.js";import{c as C,P as k,D as R,s as U,S as _,a as W}from"./ErrorBoundaryFallback-61ecfd83.js";import{g as z,r as V}from"./index-f46741a2.js";import{G as H}from"./GraphQLOperationDiffViewer-ae70b452.js";import{b as $}from"./graph-api-transformers-1aca29a2.js";const un="graphql";function Y(o,r,u){const m=`${o}/${r}/${u}`,p=J.get(m);return p?[p.before,p.after]:["",""]}const J=new Map([["graphql/directives/add-argument-default-value-for-schema-directive",{before:`directive @limit (offset: Int) on FIELD_DEFINITION
