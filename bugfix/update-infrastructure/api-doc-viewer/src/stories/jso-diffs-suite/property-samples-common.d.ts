...
export declare const JsoPropertySamplesStory: ({ beforeYaml, afterYaml, }: JsoCaseStoryComponentProps) => import("react").JSX.Element;
...
export declare const jsoPropertySamplesStoryMetaBase: {
    component: ({ beforeYaml, afterYaml, }: JsoCaseStoryComponentProps) => import("react").JSX.Element;
    argTypes: {
        beforeYaml: {
            control: {
                type: "text";
