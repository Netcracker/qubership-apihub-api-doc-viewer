...
import { BuildFromDdlOptions } from '@netcracker/qubership-apihub-ddlapi/parser';
export { emptyRealmLike, realmHasTables, resolveDdlDiffComparePair, resolveDdlDiffCompareSide, } from './ddl-story-realm-utils';
/**
