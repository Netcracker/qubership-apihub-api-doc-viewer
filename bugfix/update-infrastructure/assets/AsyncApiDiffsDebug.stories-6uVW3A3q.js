import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DRGMQe9r.js";import{f as n,p as r}from"./AsyncApiOperationViewer-BSRon3JG.js";import{r as i,t as a}from"./browser-ChQu38zI.js";import{f as o,g as s,h as c,i as l,p as u,r as d}from"./preprocess-CVyTm_I1.js";var f,p,m,h,g;function _(){return(_=e((()=>{r(),a(),u(),s(),d(),f=t(),p=e=>{let t;try{t=JSON.parse(e)}catch(e){console.error(`Cannot parse JSON:`,e),t=void 0}try{t||=i(e)}catch(e){console.error(`Cannot parse YAML:`,e),t=void 0}return!t||typeof t!=`object`?{}:t},m={title:`Debug/Async Api Diffs Viewer`,component:n,argTypes:{mergedSource:{control:{disable:!0},table:{disable:!0}},beforeSourceText:{control:`text`},afterSourceText:{control:`text`},displayMode:{control:`select`,options:[`simple`,`detailed`],defaultValue:`detailed`}},args:{beforeSourceText:`{
  "asyncapi": "3.0.0",
  "operations": {
