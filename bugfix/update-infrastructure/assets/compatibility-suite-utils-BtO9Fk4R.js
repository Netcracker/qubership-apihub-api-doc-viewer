import{a as e,n as t,t as n}from"./rolldown-runtime-DkW27tQK.js";import{t as r}from"./react-B6tGW3fj.js";import{t as i}from"./jsx-runtime-ATHzeHXA.js";import{Gr as a,Wr as o,cr as s,nn as c,rn as l,sn as u,tn as d,un as f,ur as p}from"./DiffBadge-D_rltRnu.js";import{n as m,t as h}from"./GraphQLOperationDiffViewer-Mx7Fbx8T.js";import{n as g,t as _}from"./graph-api-transformers-B0Y16AyJ.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,ee,te,I,L,R,z,B,V,H,U,W,G,K;function q(){return(q=t((()=>{v=new Map([[`graphql/directives/add-argument-default-value-for-schema-directive`,{before:`directive @limit (offset: Int) on FIELD_DEFINITION
...
xml:
  prefix: "p2"
  namespace: "http://example.com/schema"
`}}]]),x=new Map([[`asyncapi/operation-receive-message-headers`,`asyncapi: 3.0.0
info:
        ...
        "200":
          ...
          headers:
            X-Header-1:
              schema:
                __SCHEMA__
`]]),S=[`3.0.0`,`3.0.0`],C=(e,t)=>{let n=/^openapi:\s*.*$/m;if(!n.test(e))throw Error(`Invalid OpenAPI sample: missing root "openapi" field. Sample start: ${e.slice(0,100)}...`);return e.replace(n,`openapi: ${t}`)},w=`openapi`,T=`graphql`,E=`asyncapi`,D=(e,t,n)=>[e,t,n].join(`/`),O=(e,t)=>[e,t].join(`/`),k=[`parameters-schema`,`request-body-schema`,`response-body-schema`,`response-headers-schema`],A=[`operation-receive-message-headers`,`operation-send-message-headers`,`operation-receive-message-payload`,`operation-send-message-payload`,`operation-reply-receive-message-headers`,`operation-reply-send-message-headers`,`operation-reply-receive-message-payload`,`operation-reply-send-message-payload`],j={[w]:k,[T]:[],[E]:A},M=(e,t)=>j[e].includes(t),N=`__SCHEMA__`,P=e=>e.replace(/\r\n/g,`
`),F=(e,t)=>{let n=P(e).trimEnd();return n?t?t+n.replace(/\n(?=.)/g,`\n${t}`):n:``},ee=(e,t)=>{let n=P(e),r=n.split(`
`),i=r.map((e,t)=>e.trim()===N?t:-1).filter(e=>e!==-1);if(i.length===0)throw Error(`Template placeholder '${N}' not found. Template start: ${n.slice(0,120)}...`);if(i.length>1)throw Error(`Template placeholder '${N}' must appear only once. Found ${i.length} occurrences. Template start: ${n.slice(0,120)}...`);let a=i[0],o=F(t,r[a].match(/^\s*/)?.[0]??``);return o?(r.splice(a,1,...o.split(`
`)),r.join(`
`)):(r.splice(a,1),r.join(`
`))},te=(e,t)=>`${P(ee(e,t.schema)).trimEnd()}\n`,I=(e,t)=>M(e,t)?x.has(O(e,t)):!1,L=(e,t,n,r)=>{let i=O(e,t),a=x.get(i);if(!a)throw Error(`Schema suite template not found: ${i}`);let o=b.get(n);if(!o)throw Error(`JSON schema case not found: ${n}`);let s=o[r];return te(a,s)},R=[`3.0.0`,`3.0.0`],z=[`unversioned`,`unversioned`],B=(e,t,n)=>I(e,t)&&b.has(n),V=(e,t,n)=>{let r=D(e,t,n),i=v.get(r);if(i)return[i.before,i.after];if(!I(e,t))throw Error(`Unknown compatibility suite case: (${e}, ${t}, ${n})`);if(!b.has(n))throw Error(`Unknown JSON schema case '${n}' for schema suite (${e}, ${t})`);return[L(e,t,n,`before`),L(e,t,n,`after`)]},H={[w]:{defaultPair:S,patchSamples:(e,t,n)=>[C(e,n[0]),C(t,n[1])]},[T]:{defaultPair:z},[E]:{defaultPair:R}},U=e=>{let t=H[e];if(!t)throw Error(`Unknown suiteType for VersionPairPolicy lookup: ${e}`);return t},W=(e,t)=>{if(e===`openapi`)return y.get(t)?.versionPairs},G=(e,t,n)=>{let r=D(e,t,n);if(!v.has(r)&&!B(e,t,n))throw Error(`Unknown compatibility suite case: (${e}, ${t}, ${n})`);let i=U(e);return W(e,r)??[i.defaultPair]},K=(e,t,n,r)=>{let i=V(e,t,n);if(r===void 0)return i;let a=U(e),[o,s]=r;if(!G(e,t,n).some(e=>e[0]===o&&e[1]===s))throw Error(`Unsupported specificationVersionPair [${o}, ${s}] for case (${e}, ${t}, ${n})`);return!a.patchSamples||!W(e,D(e,t,n))?i:a.patchSamples(i[0],i[1],r)}})))()}var ne=n(((e,t)=>{(function(){function e(e,t){document.addEventListener?e.addEventListener(`scroll`,t,!1):e.attachEvent(`scroll`,t)}function n(e){document.body?e():document.addEventListener?document.addEventListener(`DOMContentLoaded`,function t(){document.removeEventListener(`DOMContentLoaded`,t),e()}):document.attachEvent(`onreadystatechange`,function t(){(document.readyState==`interactive`||document.readyState==`complete`)&&(document.detachEvent(`onreadystatechange`,t),e())})}function r(e){this.g=document.createElement(`div`),this.g.setAttribute(`aria-hidden`,`true`),this.g.appendChild(document.createTextNode(e)),this.h=document.createElement(`span`),this.i=document.createElement(`span`),this.m=document.createElement(`span`),this.j=document.createElement(`span`),this.l=-1,this.h.style.cssText=`max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;`,this.i.style.cssText=`max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;`,this.j.style.cssText=`max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;`,this.m.style.cssText=`display:inline-block;width:200%;height:200%;font-size:16px;max-width:none;`,this.h.appendChild(this.m),this.i.appendChild(this.j),this.g.appendChild(this.h),this.g.appendChild(this.i)}function i(e,t){e.g.style.cssText=`max-width:none;min-width:20px;min-height:20px;display:inline-block;overflow:hidden;position:absolute;width:auto;margin:0;padding:0;top:-999px;white-space:nowrap;font-synthesis:none;font:`+t+`;`}function a(e){var t=e.g.offsetWidth,n=t+100;return e.j.style.width=n+`px`,e.i.scrollLeft=n,e.h.scrollLeft=e.h.scrollWidth+100,e.l!==t&&(e.l=t,!0)}function o(t,n){function r(){var e=i;a(e)&&e.g.parentNode!==null&&n(e.l)}var i=t;e(t.h,r),e(t.i,r),a(t)}function s(e,t,n){t||={},n||=window,this.family=e,this.style=t.style||`normal`,this.weight=t.weight||`normal`,this.stretch=t.stretch||`normal`,this.context=n}var c=null,l=null,u=null,d=null;function f(e){return l===null&&(p(e)&&/Apple/.test(window.navigator.vendor)?(e=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))(?:\.([0-9]+))/.exec(window.navigator.userAgent),l=!!e&&603>parseInt(e[1],10)):l=!1),l}function p(e){return d===null&&(d=!!e.document.fonts),d}function m(e,t){var n=e.style,r=e.weight;if(u===null){var i=document.createElement(`div`);try{i.style.font=`condensed 100px sans-serif`}catch{}u=i.style.font!==``}return[n,r,u?e.stretch:``,`100px`,t].join(` `)}s.prototype.load=function(e,t){var a=this,s=e||`BESbswy`,l=0,u=t||3e3,d=new Date().getTime();return new Promise(function(e,t){if(p(a.context)&&!f(a.context)){var h=new Promise(function(e,t){function n(){new Date().getTime()-d>=u?t(Error(``+u+`ms timeout exceeded`)):a.context.document.fonts.load(m(a,`"`+a.family+`"`),s).then(function(t){1<=t.length?e():setTimeout(n,25)},t)}n()}),g=new Promise(function(e,t){l=setTimeout(function(){t(Error(``+u+`ms timeout exceeded`))},u)});Promise.race([g,h]).then(function(){clearTimeout(l),e(a)},t)}else n(function(){function n(){var t;(t=_!=-1&&v!=-1||_!=-1&&y!=-1||v!=-1&&y!=-1)&&((t=_!=v&&_!=y&&v!=y)||(c===null&&(t=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),c=!!t&&(536>parseInt(t[1],10)||parseInt(t[1],10)===536&&11>=parseInt(t[2],10))),t=c&&(_==b&&v==b&&y==b||_==x&&v==x&&y==x||_==S&&v==S&&y==S)),t=!t),t&&(C.parentNode!==null&&C.parentNode.removeChild(C),clearTimeout(l),e(a))}function f(){if(new Date().getTime()-d>=u)C.parentNode!==null&&C.parentNode.removeChild(C),t(Error(``+u+`ms timeout exceeded`));else{var e=a.context.document.hidden;(!0===e||e===void 0)&&(_=p.g.offsetWidth,v=h.g.offsetWidth,y=g.g.offsetWidth,n()),l=setTimeout(f,50)}}var p=new r(s),h=new r(s),g=new r(s),_=-1,v=-1,y=-1,b=-1,x=-1,S=-1,C=document.createElement(`div`);C.dir=`ltr`,i(p,m(a,`sans-serif`)),i(h,m(a,`serif`)),i(g,m(a,`monospace`)),C.appendChild(p.g),C.appendChild(h.g),C.appendChild(g.g),a.context.document.body.appendChild(C),b=p.g.offsetWidth,x=h.g.offsetWidth,S=g.g.offsetWidth,f(),o(p,function(e){_=e,n()}),i(p,m(a,`"`+a.family+`",sans-serif`)),o(h,function(e){v=e,n()}),i(h,m(a,`"`+a.family+`",serif`)),o(g,function(e){y=e,n()}),i(g,m(a,`"`+a.family+`",monospace`))})})},typeof t==`object`?t.exports=s:(window.FontFaceObserver=s,window.FontFaceObserver.prototype.load=s.prototype.load)})()}));function re(e){return typeof e==`object`&&!!e}var J,Y;function X(){return(X=t((()=>{f(),s(),J={validate:!0,liftCombiners:!0,syntheticTitleFlag:Symbol(`synthetic-title`),unify:!0,allowNotValidSyntheticChanges:!0},Y=(e,t)=>{let n=u(e,t,{...J,beforeSource:e,afterSource:t,mode:d,metaKey:l});return re(n.merged)&&(n.merged.toJSON=()=>p(n.merged)),n}})))()}function ie(){let[e,t]=(0,se.useState)(!1),n=ce.map(e=>new oe.default(e).load(null,1e4));return Promise.all(n).then(()=>{t(!0)}),e}function Z({before:e,after:t}){let{merged:n}=Y(_(e),_(t));return ie()?(0,Q.jsx)(h,{layoutMode:o,metaKeys:le,source:n}):(0,Q.jsx)(Q.Fragment,{})}function ae(e,t,n){let[r,i]=K(e,t,n);return{before:r,after:i}}var oe,se,Q,ce,le;function $(){return($=t((()=>{f(),s(),q(),oe=e(ne(),1),se=r(),m(),g(),a(),X(),Q=i(),ce=[`Inter`],le={diffsMetaKey:l,aggregatedDiffsMetaKey:c},Z.__docgenInfo={description:``,methods:[],displayName:`GraphQLStoryComponent`,props:{before:{required:!0,tsType:{name:`string`},description:``},after:{required:!0,tsType:{name:`string`},description:``}}}})))()}export{q as a,T as i,ae as n,$ as r,Z as t};