import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{r as t}from"./AsyncApiOperationViewer-BMUjObKz.js";import{a as n,i as r,n as i,r as a,t as o}from"./compatibility-suite-utils-AfaDf0N6.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;function w(){return(w=e((()=>{t(),a(),n(),s={id:`graphql-compatibility-suite-interface-output-type-of-root-type`,title:`GraphQL Compatibility Suite/interface-output-type-of-root-type`,render:o},c=`interface-output-type-of-root-type`,l={name:`add-description-for-field-of-output-interface`,args:i(r,c,`add-description-for-field-of-output-interface`)},u={name:`add-description-for-output-interface`,args:i(r,c,`add-description-for-output-interface`)},d={name:`add-enum-value-of-field-in-output-interface`,args:i(r,c,`add-enum-value-of-field-in-output-interface`)},f={name:`add-new-field-in-output-interface`,args:i(r,c,`add-new-field-in-output-interface`)},p={name:`change-field-type-of-output-interface`,args:i(r,c,`change-field-type-of-output-interface`)},m={name:`change-field-type-of-output-interface-from-enum-to-string`,args:i(r,c,`change-field-type-of-output-interface-from-enum-to-string`)},h={name:`delete-description-for-field-of-output-interface`,args:i(r,c,`delete-description-for-field-of-output-interface`)},g={name:`delete-description-of-output-interface`,args:i(r,c,`delete-description-of-output-interface`)},_={name:`mark-mandatory-field-of-output-interface-as-optional`,args:i(r,c,`mark-mandatory-field-of-output-interface-as-optional`)},v={name:`mark-optional-field-of-output-interface-as-mandatory`,args:i(r,c,`mark-optional-field-of-output-interface-as-mandatory`)},y={name:`remove-enum-value-of-field-in-output-interface`,args:i(r,c,`remove-enum-value-of-field-in-output-interface`)},b={name:`remove-field-from-output-interface`,args:i(r,c,`remove-field-from-output-interface`)},x={name:`update-description-for-field-of-output-interface`,args:i(r,c,`update-description-for-field-of-output-interface`)},S={name:`update-description-of-output-interface`,args:i(r,c,`update-description-of-output-interface`)},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
