import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-ATHzeHXA.js";import{f as n,p as r}from"./AsyncApiOperationViewer-MuAs1xMh.js";import{i,r as a}from"./parse-yaml-source-D28NqUrf.js";import{a as o,i as s,n as c,r as l,t as u}from"./async-api-diffs-utils-D7il5i1G.js";var d;function f(){return(f=e((()=>{d=`asyncapi: 3.0.0
  ...
  messageBindings:
    amqpMessageBinding:
      amqp:
        contentEncoding: utf-8
        bindingVersion: 0.3.0
`})))()}var y,b,x,S,C,w,T,E,D,O,k,A,j;function M(){return(M=e((()=>{f(),m(),g(),v(),r(),i(),o(),y=t(),b=a(Object.assign({"../../../../samples/async-api-diffs/whole-apihub-operation/1.1-message-removed-from-operation-channel-and-document/before.yaml":d,"../../../../samples/async-api-diffs/whole-apihub-operation/1.2-message-added-to-operation-channel-and-document/before.yaml":p}),Object.assign({"../../../../samples/async-api-diffs/whole-apihub-operation/1.1-message-removed-from-operation-channel-and-document/after.yaml":h,"../../../../samples/async-api-diffs/whole-apihub-operation/1.2-message-added-to-operation-channel-and-document/after.yaml":_})),x=l(b),S=({beforeYaml:e,afterYaml:t})=>(0,y.jsx)(n,{...E(e,t)}),C={title:`Async API Diffs Suite/Whole Apihub Operation Samples`,component:S,argTypes:u},w=`ConsumeUserSignups`,T=`UserMessage`,E=(e,t)=>s(e,t,{operationKey:w,messageKey:T}),D=c(S,x),O=e=>D(e),k=O(`1.1-message-removed-from-operation-channel-and-document`),A=O(`1.2-message-added-to-operation-channel-and-document`),k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`createCaseStory("1.1-message-removed-from-operation-channel-and-document")`,...k.parameters?.docs?.source}}},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`createCaseStory("1.2-message-added-to-operation-channel-and-document")`,...A.parameters?.docs?.source}}},j=[`Case_1_1_message_removed_from_operation_channel_and_document`,`Case_1_2_message_added_to_operation_channel_and_document`]})))()}M();export{k as Case_1_1_message_removed_from_operation_channel_and_document,A as Case_1_2_message_added_to_operation_channel_and_document,j as __namedExportsOrder,C as default};