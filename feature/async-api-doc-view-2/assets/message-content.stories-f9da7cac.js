import{A as Ee}from"./AsyncApiOperationViewer-fb008189.js";import{p as ye,T as Ae,E as y}from"./preprocess-22112daa.js";import"./_commonjs-dynamic-modules-6308e768.js";import"./index-f46741a2.js";import"./GraphPropNodeViewer-7b903ebd.js";import"./index-415bee12.js";import"./GraphQLOperationViewer-883c5723.js";import"./GraphQLOperationDiffViewer-212bd7b5.js";const Pe={title:"Async API Suite/Message Content",component:Ee,parameters:{},argTypes:{source:{control:"object"}},args:{source:{}}},ue="send-operation",I="ChannelID",h="MessageID",A={type:"object",properties:{traceId:{type:"string"},requestId:{type:"string"}}},be={schemaFormat:"application/schema+json;version=draft-07",schema:{type:"object",properties:{traceId:{type:"string"},requestId:{type:"string"}}}},b={type:"object",properties:{id:{type:"string"},status:{type:"string"}}},Oe={schemaFormat:"application/schema+json;version=draft-07",schema:{type:"object",properties:{id:{type:"string"},status:{type:"string"}}}},e=({message:O,operationType:H="send"})=>({asyncapi:"3.0.0",operations:{[ue]:{action:H,channel:{$ref:`#/channels/${I}`},messages:[{$ref:`#/channels/${I}/messages/${h}`}]}},channels:{[I]:{messages:{[h]:{name:"Message Name",...O}}}}}),s=(O,H)=>({args:{source:ye({source:O,storyName:H}),operationKeys:{operationKey:ue,messageKey:h},referenceNamePropertyKey:Ae}}),n=s(e({message:{headers:A}})),a=s(e({message:{headers:be}})),r=s(e({message:{...y}})),t=s(e({message:{bindings:{kafka:{bindingVersion:"0.5.0",topic:"events.message.created",clientId:"api-doc-viewer-client"}}}})),o=s(e({message:{bindings:{kafka:{bindingVersion:"0.5.0",topic:"events.message.first"},mqtt:{bindingVersion:"0.2.0",clientId:"mqtt-client-01"}}}})),i=s(e({message:{bindings:{kafka:{bindingVersion:"0.5.0",topic:"events.message.second"},mqtt:{bindingVersion:"0.2.0",clientId:"mqtt-client-02"}}}})),c=s(e({message:{payload:b}})),d=s(e({message:{payload:Oe}})),p=s(e({message:{headers:A,...y}})),m=s(e({message:{headers:A,bindings:{kafka:{bindingVersion:"0.5.0",topic:"events.message.headers",clientId:"api-doc-viewer-client"}}}})),g=s(e({message:{headers:A,payload:b}})),S=s(e({message:{...y,bindings:{kafka:{bindingVersion:"0.5.0",topic:"events.message.extension",clientId:"api-doc-viewer-client"}}}})),l=s(e({message:{...y,payload:b}})),u=s(e({message:{bindings:{kafka:{bindingVersion:"0.5.0",topic:"events.message.payload",clientId:"api-doc-viewer-client"}},payload:b}})),E=s(e({message:{bindings:{$ref:"#/components/bindings/not-existing-bindings"}}}));var M,f,k;n.parameters={...n.parameters,docs:{...(M=n.parameters)==null?void 0:M.docs,source:{originalSource:`createStory(createSource({
  message: {
