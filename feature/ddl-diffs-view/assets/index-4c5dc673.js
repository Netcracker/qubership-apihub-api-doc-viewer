...
| typeof CHANGED_LAYOUT_SIDE`,elements:[{name:"ORIGIN_LAYOUT_SIDE"},{name:"CHANGED_LAYOUT_SIDE"}]},description:""}}};const $i=i=>{const{node:e,additionalInfoPrecededBy:n=A.DDL_COLUMN_ROW,isLastInList:t=!1,[$]:r}=i,a=le(),o=e.value(),s=d.useMemo(()=>Bi(e),[e]),g=d.useMemo(()=>Wi(e),[e]),f=d.useMemo(()=>Ut(e),[e]),u=d.useMemo(()=>Gt(e),[e]),c=d.useMemo(()=>Qn(e),[e]),p=d.useMemo(()=>Jn(e),[e]),D=d.useMemo(()=>qi(e),[e]),H=d.useMemo(()=>Zn(e),[e]),h=d.useMemo(()=>Ni(e),[e]),y=d.useMemo(()=>et(e),[e]),v=d.useCallback(N=>o?wi(s,N)?l.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[l.jsx(Yi,{node:e,layoutSide:N}),l.jsx(pe,{columnId:e.id,layoutSide:N,value:o,flagDiffs:f,foreignKeyTargetDiffs:u})]}):l.jsx(l.Fragment,{}):l.jsx(l.Fragment,{}),[f,u,e,s,o]),M=d.useCallback(N=>{const W=it(e,N);return X(W)?l.jsx(ie,{isVisible:!0,value:W,textHighlighterColor:te(h,N),borderShadowColor:fi(h,N)}):l.jsx(l.Fragment,{})},[h,e]),m=d.useCallback(N=>{const W=(()=>{const G=p==null?void 0:p.data;return G?N===E?K(G)||B(G)?G.beforeValue:void 0:Y(G)||B(G)?G.afterValue:void 0:o==null?void 0:o.generatedExpression})();return X(W)?l.jsx(ie,{isVisible:!0,value:W,textHighlighterColor:te(p,N)}):l.jsx(l.Fragment,{})},[p,o]),V=d.useCallback(N=>{const W=nt(e,N);return W.length===0?l.jsx(l.Fragment,{}):l.jsx("div",{className:"flex flex-wrap items-center gap-2",children:W.map((G,en)=>l.jsx(ie,{isVisible:!0,value:G.literal,textHighlighterColor:te(G.diff,N),borderShadowColor:fi(G.diff,N),isFontMuted:Pt(G.diff,N)},`${G.literal}-${en}`))})},[e]),b=a===se,w=!!s,C=b&&(!!(o!=null&&o.description)||!!c),T=!!(o!=null&&o.enumValues&&o.enumValues.length>0||D),q=!!(X(o==null?void 0:o.defaultValue)||h||y),_=X(o==null?void 0:o.generatedExpression)||!!p,k=b&&(T||q||_),F=t&&!C&&!k,ae=t&&C&&!k,Z=t&&T&&!q&&!_,P=t&&q&&!_,z=t&&_;return o?l.jsxs("div",{"data-testid":"ddl-column-node-viewer",className:"flex flex-col ddlapi-property",children:[l.jsx(ee,{"data-precededby":r,[U]:F||void 0,value:o.columnName,expandable:!1,expanded:!0,variant:x.body2,subheader:v,usage:j.DdlApiProperty,...g}),C&&l.jsx(de,{"data-precededby":A.DDL_COLUMN_ROW,[U]:ae||void 0,value:o.description??"",variant:x.body2,textFontWeight:"normal",textColor:ce,usage:Q.DdlApiProperty,diff:c,diffsSeverities:e.diffsSeverities}),b&&T&&l.jsx(ne,{"data-precededby":n,[U]:Z||void 0,label:Ri,subheader:V,colorizingDiff:H,diffsSeverities:D?e.diffsSeverities:void 0}),b&&!w&&q&&l.jsx(ne,{"data-precededby":T?A.DDL_COLUMN_AFTER_ADDITIONAL_INFO_ROW:n,[U]:P||void 0,label:Fi,subheader:M,colorizingDiff:y,diffsSeverities:h||y?e.diffsSeverities:void 0}),b&&_&&l.jsx(ne,{"data-precededby":q||T?A.DDL_COLUMN_AFTER_ADDITIONAL_INFO_ROW:n,[U]:z||void 0,label:Oi,subheader:m,diff:p,colorizingDiff:e.diffs[fe],diffsSeverities:e.diffsSeverities})]}):null};$i.__docgenInfo={description:"",methods:[],displayName:"ColumnNodeViewerWithDiffs",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},node:{required:!0,tsType:{name:"ITreeNodeWithDiffs",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.COLUMN"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  readonly _fragment: unknown
}`,signature:{properties:[{key:"_fragment",value:{name:"unknown",required:!0}}]}}],raw:`Partial<{
  readonly _fragment: unknown
}>`},{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]}],raw:`ITreeNodeWithDiffs<
