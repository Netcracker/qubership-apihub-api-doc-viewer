import{j as m}from"./_commonjs-dynamic-modules-6308e768.js";import{a as u}from"./AsyncApiOperationViewer-e1bc9dd1.js";import{p as l}from"./public-api-d6a34651.js";import{T as g,a,b as S}from"./preprocess-49192cfc.js";import"./index-f46741a2.js";import"./UxBadge-0da8dd7b.js";import"./DdlTableViewer-55f8f2db.js";import"./GraphPropNodeViewer-d0bd3285.js";import"./index-415bee12.js";import"./GraphQLOperationDiffViewer-b3350f26.js";import"./GraphQLOperationViewer-31a8ac53.js";const c=n=>{let e;try{e=JSON.parse(n)}catch(s){console.error("Cannot parse JSON:",s),e=void 0}try{e||(e=l(n))}catch(s){console.error("Cannot parse YAML:",s),e=void 0}return!e||typeof e!="object"?{}:e},K={title:"Debug/Async Api Diffs Viewer",component:u,argTypes:{mergedSource:{control:{disable:!0},table:{disable:!0}},beforeSourceText:{control:"text"},afterSourceText:{control:"text"},displayMode:{control:"select",options:["simple","detailed"],defaultValue:"detailed"}},args:{beforeSourceText:`{
  "asyncapi": "3.0.0",
  "operations": {
