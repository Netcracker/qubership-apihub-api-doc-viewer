import{j as A}from"./_commonjs-dynamic-modules-6308e768.js";import{c as k,R as U,D as T,e as _,s as W,a as E,S as z}from"./ErrorBoundaryFallback-bbe3ecbe.js";import{g as V,r as H}from"./index-f46741a2.js";import{G as Y}from"./GraphQLOperationDiffViewer-bdcaa673.js";import{b as Q}from"./graph-api-transformers-c5140458.js";const un="graphql";function J(o,r,u){const m=`${o}/${r}/${u}`,s=Z.get(m);return s?[s.before,s.after]:["",""]}const Z=new Map([["graphql/directives/add-argument-default-value-for-schema-directive",{before:`directive @limit (offset: Int) on FIELD_DEFINITION
