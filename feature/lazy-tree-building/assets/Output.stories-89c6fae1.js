import{p as Ne,I as we,S as Q,D as ve,a as xe}from"./ErrorBoundaryFallback-fa025ca7.js";import{b as e}from"./graph-api-transformers-885e72f2.js";import{j as je}from"./_commonjs-dynamic-modules-6308e768.js";import{p as ze}from"./preprocess-dc2301aa.js";import{G as Ce}from"./GraphQLOperationDiffViewer-d2904735.js";import"./index-f46741a2.js";import"./index-415bee12.js";import"./buildASTSchema-2a8d1afe.js";import"./model-3319f9fa.js";const Oe=f=>{const{beforeSource:Ge,afterSource:Pe,circular:Be=!1}=f,De=ze({beforeSource:Ge,afterSource:Pe,circular:Be});return je.jsx(Ce,{...f,source:De})};Oe.__docgenInfo={description:"",methods:[],displayName:"TestGraphQLOperationDiffViewer",props:{beforeSource:{required:!1,tsType:{name:"unknown"},description:""},afterSource:{required:!0,tsType:{name:"unknown"},description:""},circular:{required:!1,tsType:{name:"boolean"},description:""}}};const Ye={title:"GraphQL Operation Diff Viewer/Output",component:Oe,parameters:{},argTypes:{beforeSource:{control:"object"},afterSource:{control:"object"},layoutMode:{control:"radio",options:[Ne,we,Q]},filters:{control:"check",options:["breaking","non-breaking","annotation","unclassified","deprecated"]}},args:{layoutMode:Q,metaKeys:{diffsMetaKey:ve,aggregatedDiffsMetaKey:xe}}},r={args:{beforeSource:e(`
      type Query {
...
}`,...(F=(W=u.parameters)==null?void 0:W.docs)==null?void 0:F.source}}};var Y,K,V;p.parameters={...p.parameters,docs:{...(Y=p.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  args: {
    beforeSource: buildGraphApiSchema(\`
      type Query {
        """Returns a book model by its ID"""
