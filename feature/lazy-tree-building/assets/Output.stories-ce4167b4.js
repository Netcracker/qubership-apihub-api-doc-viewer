import{m as Ne,I as we,S as Q,D as ve}from"./ErrorBoundaryFallback-1b53b0f5.js";import{b as e}from"./graph-api-transformers-5dc4200d.js";import{j as xe}from"./_commonjs-dynamic-modules-6308e768.js";import{p as je}from"./preprocess-a80a6175.js";import{G as ze}from"./GraphQLOperationDiffViewer-8533fecb.js";import"./index-f46741a2.js";import"./index-415bee12.js";import"./buildASTSchema-71d4f451.js";import"./model-2d31871b.js";const Oe=f=>{const{beforeSource:Ge,afterSource:Pe,circular:Be=!1}=f,De=je({beforeSource:Ge,afterSource:Pe,circular:Be});return xe.jsx(ze,{...f,source:De})};Oe.__docgenInfo={description:"",methods:[],displayName:"TestGraphQLOperationDiffViewer",props:{beforeSource:{required:!1,tsType:{name:"unknown"},description:""},afterSource:{required:!0,tsType:{name:"unknown"},description:""},circular:{required:!1,tsType:{name:"boolean"},description:""}}};const Fe={title:"GraphQL Operation Diff Viewer/Output",component:Oe,parameters:{},argTypes:{beforeSource:{control:"object"},afterSource:{control:"object"},layoutMode:{control:"radio",options:[Ne,we,Q]},filters:{control:"check",options:["breaking","non-breaking","annotation","unclassified","deprecated"]}},args:{layoutMode:Q,diffMetaKey:ve}},r={args:{beforeSource:e(`
      type Query {
