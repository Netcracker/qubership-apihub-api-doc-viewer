import{j as Q}from"./jsx-runtime-beaa2906.js";import{a as un,a4 as dn,D as sn,s as pn,a5 as G,S as hn}from"./ErrorBoundaryFallback-bd21562a.js";import{g as gn,r as bn}from"./index-f46741a2.js";import{G as vn}from"./GraphQLOperationDiffViewer-6635f3f4.js";import{b as H}from"./graph-api-transformers-6ed67bcc.js";import{h as on,j as On,k as M,l as _,m as C,n as X,o as U,p as jn,q as N,r as B,s as rn,t as qn,v as an,w as xn,x as Kn,y as In,z as Sn,A as Y,b as J}from"./buildASTSchema-5ca424f2.js";var f;(function(n){n.TYPE_REMOVED="TYPE_REMOVED",n.TYPE_CHANGED_KIND="TYPE_CHANGED_KIND",n.TYPE_REMOVED_FROM_UNION="TYPE_REMOVED_FROM_UNION",n.VALUE_REMOVED_FROM_ENUM="VALUE_REMOVED_FROM_ENUM",n.REQUIRED_INPUT_FIELD_ADDED="REQUIRED_INPUT_FIELD_ADDED",n.IMPLEMENTED_INTERFACE_REMOVED="IMPLEMENTED_INTERFACE_REMOVED",n.FIELD_REMOVED="FIELD_REMOVED",n.FIELD_CHANGED_KIND="FIELD_CHANGED_KIND",n.REQUIRED_ARG_ADDED="REQUIRED_ARG_ADDED",n.ARG_REMOVED="ARG_REMOVED",n.ARG_CHANGED_KIND="ARG_CHANGED_KIND",n.DIRECTIVE_REMOVED="DIRECTIVE_REMOVED",n.DIRECTIVE_ARG_REMOVED="DIRECTIVE_ARG_REMOVED",n.REQUIRED_DIRECTIVE_ARG_ADDED="REQUIRED_DIRECTIVE_ARG_ADDED",n.DIRECTIVE_REPEATABLE_REMOVED="DIRECTIVE_REPEATABLE_REMOVED",n.DIRECTIVE_LOCATION_REMOVED="DIRECTIVE_LOCATION_REMOVED"})(f||(f={}));var g;(function(n){n.VALUE_ADDED_TO_ENUM="VALUE_ADDED_TO_ENUM",n.TYPE_ADDED_TO_UNION="TYPE_ADDED_TO_UNION",n.OPTIONAL_INPUT_FIELD_ADDED="OPTIONAL_INPUT_FIELD_ADDED",n.OPTIONAL_ARG_ADDED="OPTIONAL_ARG_ADDED",n.IMPLEMENTED_INTERFACE_ADDED="IMPLEMENTED_INTERFACE_ADDED",n.ARG_DEFAULT_VALUE_CHANGE="ARG_DEFAULT_VALUE_CHANGE"})(g||(g={}));function Pn(n,t){return mn(n,t).filter(s=>s.type in f)}function An(n,t){return mn(n,t).filter(s=>s.type in g)}function mn(n,t){return[...Bn(n,t),...Fn(n,t)]}function Fn(n,t){const s=[],o=q(n.getDirectives(),t.getDirectives());for(const e of o.removed)s.push({type:f.DIRECTIVE_REMOVED,description:`${e.name} was removed.`});for(const[e,p]of o.persisted){const c=q(e.args,p.args);for(const a of c.added)on(a)&&s.push({type:f.REQUIRED_DIRECTIVE_ARG_ADDED,description:`A required arg ${a.name} on directive ${e.name} was added.`});for(const a of c.removed)s.push({type:f.DIRECTIVE_ARG_REMOVED,description:`${a.name} was removed from ${e.name}.`});e.isRepeatable&&!p.isRepeatable&&s.push({type:f.DIRECTIVE_REPEATABLE_REMOVED,description:`Repeatable flag was removed from ${e.name}.`});for(const a of e.locations)p.locations.includes(a)||s.push({type:f.DIRECTIVE_LOCATION_REMOVED,description:`${a} was removed from ${e.name}.`})}return s}function Bn(n,t){const s=[],o=q(Object.values(n.getTypeMap()),Object.values(t.getTypeMap()));for(const e of o.removed)s.push({type:f.TYPE_REMOVED,description:On(e)?`Standard scalar ${e.name} was removed because it is not referenced anymore.`:`${e.name} was removed.`});for(const[e,p]of o.persisted)M(e)&&M(p)?s.push(...En(e,p)):_(e)&&_(p)?s.push(...Dn(e,p)):C(e)&&C(p)?s.push(...wn(e,p)):X(e)&&X(p)?s.push(...nn(e,p),...Z(e,p)):U(e)&&U(p)?s.push(...nn(e,p),...Z(e,p)):e.constructor!==p.constructor&&s.push({type:f.TYPE_CHANGED_KIND,description:`${e.name} changed from ${en(e)} to ${en(p)}.`});return s}function wn(n,t){const s=[],o=q(Object.values(n.getFields()),Object.values(t.getFields()));for(const e of o.added)jn(e)?s.push({type:f.REQUIRED_INPUT_FIELD_ADDED,description:`A required field ${e.name} on input type ${n.name} was added.`}):s.push({type:g.OPTIONAL_INPUT_FIELD_ADDED,description:`An optional field ${e.name} on input type ${n.name} was added.`});for(const e of o.removed)s.push({type:f.FIELD_REMOVED,description:`${n.name}.${e.name} was removed.`});for(const[e,p]of o.persisted)T(e.type,p.type)||s.push({type:f.FIELD_CHANGED_KIND,description:`${n.name}.${e.name} changed type from ${String(e.type)} to ${String(p.type)}.`});return s}function Dn(n,t){const s=[],o=q(n.getTypes(),t.getTypes());for(const e of o.added)s.push({type:g.TYPE_ADDED_TO_UNION,description:`${e.name} was added to union type ${n.name}.`});for(const e of o.removed)s.push({type:f.TYPE_REMOVED_FROM_UNION,description:`${e.name} was removed from union type ${n.name}.`});return s}function En(n,t){const s=[],o=q(n.getValues(),t.getValues());for(const e of o.added)s.push({type:g.VALUE_ADDED_TO_ENUM,description:`${e.name} was added to enum type ${n.name}.`});for(const e of o.removed)s.push({type:f.VALUE_REMOVED_FROM_ENUM,description:`${e.name} was removed from enum type ${n.name}.`});return s}function Z(n,t){const s=[],o=q(n.getInterfaces(),t.getInterfaces());for(const e of o.added)s.push({type:g.IMPLEMENTED_INTERFACE_ADDED,description:`${e.name} added to interfaces implemented by ${n.name}.`});for(const e of o.removed)s.push({type:f.IMPLEMENTED_INTERFACE_REMOVED,description:`${n.name} no longer implements interface ${e.name}.`});return s}function nn(n,t){const s=[],o=q(Object.values(n.getFields()),Object.values(t.getFields()));for(const e of o.removed)s.push({type:f.FIELD_REMOVED,description:`${n.name}.${e.name} was removed.`});for(const[e,p]of o.persisted)s.push(...Tn(n,e,p)),E(e.type,p.type)||s.push({type:f.FIELD_CHANGED_KIND,description:`${n.name}.${e.name} changed type from ${String(e.type)} to ${String(p.type)}.`});return s}function Tn(n,t,s){const o=[],e=q(t.args,s.args);for(const p of e.removed)o.push({type:f.ARG_REMOVED,description:`${n.name}.${t.name} arg ${p.name} was removed.`});for(const[p,c]of e.persisted)if(!T(p.type,c.type))o.push({type:f.ARG_CHANGED_KIND,description:`${n.name}.${t.name} arg ${p.name} has changed type from ${String(p.type)} to ${String(c.type)}.`});else if(p.defaultValue!==void 0)if(c.defaultValue===void 0)o.push({type:g.ARG_DEFAULT_VALUE_CHANGE,description:`${n.name}.${t.name} arg ${p.name} defaultValue was removed.`});else{const y=tn(p.defaultValue,p.type),h=tn(c.defaultValue,c.type);y!==h&&o.push({type:g.ARG_DEFAULT_VALUE_CHANGE,description:`${n.name}.${t.name} arg ${p.name} has changed defaultValue from ${y} to ${h}.`})}for(const p of e.added)on(p)?o.push({type:f.REQUIRED_ARG_ADDED,description:`A required arg ${p.name} on ${n.name}.${t.name} was added.`}):o.push({type:g.OPTIONAL_ARG_ADDED,description:`An optional arg ${p.name} on ${n.name}.${t.name} was added.`});return o}function E(n,t){return N(n)?N(t)&&E(n.ofType,t.ofType)||B(t)&&E(n,t.ofType):B(n)?B(t)&&E(n.ofType,t.ofType):rn(t)&&n.name===t.name||B(t)&&E(n,t.ofType)}function T(n,t){return N(n)?N(t)&&T(n.ofType,t.ofType):B(n)?B(t)&&T(n.ofType,t.ofType)||!B(t)&&T(n.ofType,t):rn(t)&&n.name===t.name}function en(n){if(qn(n))return"a Scalar type";if(X(n))return"an Object type";if(U(n))return"an Interface type";if(_(n))return"a Union type";if(M(n))return"an Enum type";if(C(n))return"an Input type";an(!1,"Unexpected type: "+xn(n))}function tn(n,t){const s=Kn(n,t);return s!=null||an(!1),In(Sn(s))}function q(n,t){const s=[],o=[],e=[],p=Y(n,({name:a})=>a),c=Y(t,({name:a})=>a);for(const a of n){const y=c[a.name];y===void 0?o.push(a):e.push([a,y])}for(const a of t)p[a.name]===void 0&&s.push(a);return{added:s,persisted:e,removed:o}}var cn={exports:{}};(function(n){(function(){function t(r,m){document.addEventListener?r.addEventListener("scroll",m,!1):r.attachEvent("scroll",m)}function s(r){document.body?r():document.addEventListener?document.addEventListener("DOMContentLoaded",function m(){document.removeEventListener("DOMContentLoaded",m),r()}):document.attachEvent("onreadystatechange",function m(){(document.readyState=="interactive"||document.readyState=="complete")&&(document.detachEvent("onreadystatechange",m),r())})}function o(r){this.g=document.createElement("div"),this.g.setAttribute("aria-hidden","true"),this.g.appendChild(document.createTextNode(r)),this.h=document.createElement("span"),this.i=document.createElement("span"),this.m=document.createElement("span"),this.j=document.createElement("span"),this.l=-1,this.h.style.cssText="max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;",this.i.style.cssText="max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;",this.j.style.cssText="max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;",this.m.style.cssText="display:inline-block;width:200%;height:200%;font-size:16px;max-width:none;",this.h.appendChild(this.m),this.i.appendChild(this.j),this.g.appendChild(this.h),this.g.appendChild(this.i)}function e(r,m){r.g.style.cssText="max-width:none;min-width:20px;min-height:20px;display:inline-block;overflow:hidden;position:absolute;width:auto;margin:0;padding:0;top:-999px;white-space:nowrap;font-synthesis:none;font:"+m+";"}function p(r){var m=r.g.offsetWidth,i=m+100;return r.j.style.width=i+"px",r.i.scrollLeft=i,r.h.scrollLeft=r.h.scrollWidth+100,r.l!==m?(r.l=m,!0):!1}function c(r,m){function i(){var u=x;p(u)&&u.g.parentNode!==null&&m(u.l)}var x=r;t(r.h,i),t(r.i,i),p(r)}function a(r,m,i){m=m||{},i=i||window,this.family=r,this.style=m.style||"normal",this.weight=m.weight||"normal",this.stretch=m.stretch||"normal",this.context=i}var y=null,h=null,D=null,I=null;function fn(r){return h===null&&(k(r)&&/Apple/.test(window.navigator.vendor)?(r=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))(?:\.([0-9]+))/.exec(window.navigator.userAgent),h=!!r&&603>parseInt(r[1],10)):h=!1),h}function k(r){return I===null&&(I=!!r.document.fonts),I}function S(r,m){var i=r.style,x=r.weight;if(D===null){var u=document.createElement("div");try{u.style.font="condensed 100px sans-serif"}catch{}D=u.style.font!==""}return[i,x,D?r.stretch:"","100px",m].join(" ")}a.prototype.load=function(r,m){var i=this,x=r||"BESbswy",u=0,P=m||3e3,V=new Date().getTime();return new Promise(function(W,z){if(k(i.context)&&!fn(i.context)){var ln=new Promise(function(A,F){function b(){new Date().getTime()-V>=P?F(Error(""+P+"ms timeout exceeded")):i.context.document.fonts.load(S(i,'"'+i.family+'"'),x).then(function(K){1<=K.length?A():setTimeout(b,25)},F)}b()}),yn=new Promise(function(A,F){u=setTimeout(function(){F(Error(""+P+"ms timeout exceeded"))},P)});Promise.race([yn,ln]).then(function(){clearTimeout(u),W(i)},z)}else s(function(){function A(){var l;(l=v!=-1&&O!=-1||v!=-1&&j!=-1||O!=-1&&j!=-1)&&((l=v!=O&&v!=j&&O!=j)||(y===null&&(l=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),y=!!l&&(536>parseInt(l[1],10)||parseInt(l[1],10)===536&&11>=parseInt(l[2],10))),l=y&&(v==L&&O==L&&j==L||v==R&&O==R&&j==R||v==$&&O==$&&j==$)),l=!l),l&&(d.parentNode!==null&&d.parentNode.removeChild(d),clearTimeout(u),W(i))}function F(){if(new Date().getTime()-V>=P)d.parentNode!==null&&d.parentNode.removeChild(d),z(Error(""+P+"ms timeout exceeded"));else{var l=i.context.document.hidden;(l===!0||l===void 0)&&(v=b.g.offsetWidth,O=K.g.offsetWidth,j=w.g.offsetWidth,A()),u=setTimeout(F,50)}}var b=new o(x),K=new o(x),w=new o(x),v=-1,O=-1,j=-1,L=-1,R=-1,$=-1,d=document.createElement("div");d.dir="ltr",e(b,S(i,"sans-serif")),e(K,S(i,"serif")),e(w,S(i,"monospace")),d.appendChild(b.g),d.appendChild(K.g),d.appendChild(w.g),i.context.document.body.appendChild(d),L=b.g.offsetWidth,R=K.g.offsetWidth,$=w.g.offsetWidth,F(),c(b,function(l){v=l,A()}),e(b,S(i,'"'+i.family+'",sans-serif')),c(K,function(l){O=l,A()}),e(K,S(i,'"'+i.family+'",serif')),c(w,function(l){j=l,A()}),e(w,S(i,'"'+i.family+'",monospace'))})})},n.exports=a})()})(cn);var Ln=cn.exports;const Rn=gn(Ln),Jn="graphql";function $n(n,t,s){const o=`${n}/${t}/${s}`,e=Gn.get(o);return e?[e.before,e.after]:["",""]}const Gn=new Map([["graphql/directives/add-argument-default-value-for-schema-directive",{before:`directive @limit (offset: Int) on FIELD_DEFINITION
...
paths:
  /pets:
    get: 
      ...
      responses:
        '200':
          description: OK`}],["openapi/parameters-schema/add-minimum-for-number-property",{before:`openapi: 3.0.3
info:
  title: test
  version: 0.1.0
paths:
  ...
  schemas:
    Pet:
      ...
      properties:
        ...
        name:
          type: string
          example: doggie`}],["openapi/parameters-schema/add-union-type",{before:`openapi: 3.1.0
info:
...
paths:
  /pets:
    get: 
      ...
      responses:
        '200':
          description: OK`}],["openapi/parameters-schema/remove-minimum-for-number-property",{before:`openapi: 3.0.3
info:
  title: test
  version: 0.1.0
paths:
    ...
    post:
      ...
      responses:
        '200':
          description: OK
          content: { }
`}],["openapi/request/add-allowReserved-with-default-value-for-requestBody-parameter-encoding",{before:`openapi: 3.0.0
info:
  title: test
  version: 0.1.0
paths:
          ...
          schema:
            ...
            properties:
              ...
              petId:
                type: integer
                format: int64
                example: 198772`}],["openapi/request-body/change-overriden-description",{before:`openapi: 3.1.0
info:
  title: Swagger Petstore - OpenAPI 3.1
  version: 1.0.12
paths:
          ...
          schema:
            ...
            properties:
              ...
              petId:
                type: integer
                format: int64
                example: 198772`}],["openapi/request-body-examples/add-additional-examples-object",{before:`openapi: 3.0.3
info:
  title: test
  version: 0.1.0
paths:
...
paths:
  /pets:
    post: 
      ...
      responses:
        '200':
          description: OK `}],["openapi/request-body-schema/add-minimum-for-number-property",{before:`openapi: 3.0.3
info:
  title: test
  version: 0.1.0
paths:
  ...
  schemas:
    Pet:
      ...
      properties:
        ...
        name:
          type: string
          example: doggie`}],["openapi/request-body-schema/add-union-type",{before:`openapi: 3.1.0
info:
  title: Change to union type
  version: 1.0.0
paths:
...
paths:
  /pets:
    post: 
      ...
      responses:
        '200':
          description: OK`}],["openapi/request-body-schema/remove-minimum-for-number-property",{before:`openapi: 3.0.3
info:
  title: test
  version: 0.1.0
paths:
        ...
        application/json:
          schema:
            ...
            properties:
              ...
              name:
                type: string
                example: doggie`}],["openapi/response/add-required-attribute-with-default-value-for-header",{before:`openapi: 3.0.0
info:
  title: test
  version: 0.1.0
paths:
        ...
        application/json:
          schema:
            ...
            properties:
              ...
              name:
                type: string
                example: doggie`}],["openapi/response/remove-required-attribute-with-default-value-from-header",{before:`openapi: 3.0.0
info:
  title: test
  version: 0.1.0
paths:
          ...
          content:
            'application/json':
              schema:
                ...
                properties:
                  prop1:
                    type: string`}],["openapi/response-body-schema/add-minimum-for-number-property",{before:`openapi: 3.0.3
info:
  title: test
  version: 0.1.0
paths:
  ...
  schemas:
    Pet:
      ...
      properties:
        ...
        name:
          type: string
          example: doggie`}],["openapi/response-body-schema/add-union-type",{before:`openapi: 3.1.0
info:
  title: Change to union type
  version: 1.0.0
paths:
              ...
              schema:
                properties:
                  ...
                  option2:
                    type: string
                    nullable: true
`}],["openapi/response-body-schema/nullable-is-equivalent-to-anyOf-with-null-type",{before:`openapi: 3.0.4
info:
  title: test
  version: 0.1.0
paths:
            ...
            application/json:
              schema:
                anyOf:
                  - type: string
                  - type: 'null'
`}],["openapi/response-body-schema/nullable-is-equivalent-to-union-with-null-type",{before:`openapi: 3.0.4
info:
  title: test
  version: 0.1.0
paths:
          ...
          content:
            'application/json':
              schema:
                ...
                properties:
                  prop1:
                    type: string          `}],["openapi/response-body-schema/remove-minimum-for-number-property",{before:`openapi: 3.0.3
info:
  title: test
  version: 0.1.0
paths:
  ...
  schemas:
    Pet:
      ...
      properties:
        ...
        name:
          type: string
          example: doggie`}],["openapi/response-headers-schema/add-union-type",{before:`openapi: 3.1.0
info:
  title: Change to union type
  version: 1.0.0
paths:
...
components:
  schemas:
    Color:
      type: string
      enum:
        - black`}],["openapi/response-headers-schema/remove-null-from-union-type",{before:`openapi: 3.1.0
info:
  title: Remove Type from Union
  version: 1.0.0
paths:
        ...
        '200':
          ...
          headers:
            X-Header-1:
              schema:
                type: [string, "null"]
`}]]),Nn=Symbol("synthetic-title"),Qn={validate:!0,liftCombiners:!0,syntheticTitleFlag:Nn,unify:!0,allowNotValidSyntheticChanges:!0},Mn=(n,t)=>{const e=un(n,t,{...Qn,beforeSource:n,afterSource:t,mode:dn,metaKey:sn});return _n(e.merged)&&(e.merged.toJSON=()=>pn(e.merged)),e};function _n(n){return n!=null&&typeof n=="object"}const Cn=["Inter"];function Xn({before:n,after:t}){const{diffs:s,merged:o}=Mn(H(n),H(t)),[e,p]=bn.useState(!1),c=Cn.map(a=>new Rn(a).load(null,1e4));return Promise.all(c).then(()=>{p(!0)}),e?(console.log("apihub-diff:",pn(s.map(a=>{const{beforeDeclarationPaths:y=[],afterDeclarationPaths:h=[],...D}={...a};return{...D,...G.isNotEmpty(y)?{beforeDeclarationPaths:`[${y.map(I=>`[${I.join()}]`).join()}]`}:{},...G.isNotEmpty(h)?{afterDeclarationPaths:`[${h.map(I=>`[${I.join()}]`).join()}]`}:{}}}))),Un(n,t),Q.jsx(vn,{layoutMode:hn,diffMetaKey:sn,source:o})):Q.jsx(Q.Fragment,{})}function Un(n,t){const s=J(n,{noLocation:!0}),o=J(t,{noLocation:!0}),e=Pn(s,o),p=An(s,o);console.log("GraphQL Changes:"),G.isNotEmpty(e)?console.log("Breaking Changes:",e.map(c=>`
${c.description}`).join()):console.log("No Breaking Changes"),G.isNotEmpty(p)?console.log("Dangerous Changes:",p.map(c=>`
${c.description}`).join()):console.log("No Dangerous Changes")}function Zn(n,t,s){const[o,e]=$n(n,t,s);return{before:o,after:e}}Xn.__docgenInfo={description:"",methods:[],displayName:"GraphQLStoryComponent",props:{before:{required:!0,tsType:{name:"string"},description:""},after:{required:!0,tsType:{name:"string"},description:""}}};export{Xn as G,Jn as T,Zn as g};
