...
export declare const Case_13_index_lost_unique: Story;
...
export declare const Case_17_unnamed_index_became_titled: Story;
export declare const Case_18_titled_index_became_unnamed: Story;
export declare const Case_19_unnamed_index_append_column: Story;
export declare const Case_20_unnamed_index_pop_column: Story;
export declare const Case_21_unnamed_index_replaced_column: Story;
export declare const Case_22_unnamed_index_became_unique: Story;
export declare const Case_23_unnamed_index_lost_unique: Story;
export declare const Case_24_add_index_description: Story;
export declare const Case_25_remove_index_description: Story;
export declare const Case_26_replace_index_description: Story;
