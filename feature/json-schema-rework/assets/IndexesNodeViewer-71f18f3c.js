...
| typeof CHANGED_LAYOUT_SIDE`,elements:[{name:"ORIGIN_LAYOUT_SIDE"},{name:"CHANGED_LAYOUT_SIDE"}]},name:"layoutSide"}],return:{name:"ReactElement"}}},description:""},usage:{required:!1,tsType:{name:"TitleRowUsage"},description:""},highlightingMode:{required:!1,tsType:{name:"Map",elements:[{name:"DiffHiglightingApplicationArea"},{name:"DiffHighlightingApplicationMode"}],raw:"Map<DiffHiglightingApplicationArea, DiffHighlightingApplicationMode>"},description:""},diff:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  type: DiffType
  causedAt: JsonPath
}`,signature:{properties:[{key:"type",value:{name:"DiffType",required:!0}},{key:"causedAt",value:{name:"JsonPath",required:!0}}]}}],raw:"Record<NodeDiffsSeverityPlacemennt, NodeDiffsSeverity>"}],raw:"Partial<Record<NodeDiffsSeverityPlacemennt, NodeDiffsSeverity>>"},description:""},hideLevelIndicatorWhenSideEmpty:{required:!1,tsType:{name:"boolean"},description:""}}};function oo(i,e){return u.useMemo(()=>e(i)?we(i):{},[e,i])}function we(i){return{nodeDiffs:i.diffs,nodeDescendantDiffs:i.descendantDiffs,nodeDiffsSeverities:i.diffsSeverities}}function Ye(i,e={}){const{diffKey:t,fallbackToNodeDiff:n=!0,includeDescendantDiffs:r=!0,diffsSeverityPlacement:a,resolveDiff:s}=e,{nodeDiffs:l,nodeDescendantDiffs:d,nodeDiffsSeverities:f}=i;if(!l)return{};const g=Object.entries(l),c=h=>{const D=g.find(([C])=>C===String(h));return D==null?void 0:D[1]},p=t?c(t):void 0;return{diff:s?s(l,c):n?l[Q]??p:p,...r?{descendantDiffs:d}:{},diffsSeverities:f,...a?{diffsSeverityPlacement:a}:{}}}function Ir(i){return et.includes(i.kind)}function so(i){return i.childrenNodes().filter(Ir)}function Lr(i){return i.kind===M.TABLE}function lo(i){return Lr(i)&&i instanceof ue}function Mr(i){return i.kind===M.COLUMNS}function Rr(i){return Mr(i)&&i instanceof ue}function Pr(i){return jr(i)&&i instanceof ue}function wt(i){return i.kind===M.COLUMN}function xi(i){return wt(i)&&i instanceof ue}function jr(i){return i.kind===M.INDEXES}function Nt(i){return i.kind===M.INDEX}function xt(i){return Nt(i)&&i instanceof ue}function Ht(i){return i.filter(wt)}function St(i){return i.filter(Nt)}const Fr=u.createContext(null);function Or(){const i=u.useContext(Fr);if(!i)throw new Error("useDdlTableViewerContext must be used within DdlTableViewer");return i}const Gr=({href:i,className:e,children:t})=>o.jsx("a",{href:i,className:e,children:t});Gr.__docgenInfo={description:"",methods:[],displayName:"DefaultNavigationLink"};const kt=gr;function Ct(i){const e=Ye(we(i),{resolveDiff:()=>fr(i)});return e.diff?{...e,highlightingMode:e.diff.highlightingMode}:{}}function uo(i){const e=Ye(we(i),{resolveDiff:()=>lr(i)});return e.diff?{...e,highlightingMode:e.diff.highlightingMode}:{}}const fo=dr,Ur="ux-badge_ddlapi_primary-key",At="ux-badge_ddlapi_foreign-key",Kr="ux-badge_ddlapi_unique",Br="ux-badge_ddlapi_not-null",Wr="ux-badge_ddlapi_generated",Yr="public",_t="Default",Et="As",Tt="Values";function $r(i){return i?!!(Le(i.defaultValue)||Le(i.generatedExpression)||i.enumValues&&i.enumValues.length>0):!1}const Jr="detailed";function X(i){return i===Jr}function Me(i){return i!=null}let qt=class{resolveNodeVisibility(e,t){const n=e.value(),r=this.resolveDescriptionRowVisible(n,t),a=this.resolveEnumValuesRowVisible(n,t),s=this.resolveDefaultRowVisible(n,t),l=this.resolveGeneratedRowVisible(n,t);return{showDescription:r,showEnumValuesRow:a,showDefaultRow:s,showGeneratedRow:l,showAnyAdditionalInfoRow:a||s||l}}resolveListLastRowFlags(e,t){return this.resolveListLastRowFlagsFromVisibility(e,t)}resolveAdditionalInfoRowUsesAfterRowPrecededBy(e,t){return this.resolveAdditionalInfoRowUsesAfterRowPrecededByFromVisibility(e,t)}resolveListLastRowFlagsFromVisibility(e,t){const{showDescription:n,showAnyAdditionalInfoRow:r,showEnumValuesRow:a,showDefaultRow:s,showGeneratedRow:l}=t;return{isTitleListLastRow:e&&!n&&!r,isDescriptionListLastRow:e&&n&&!r,isEnumAdditionalInfoListLastRow:e&&a&&!s&&!l,isDefaultAdditionalInfoListLastRow:e&&s&&!l,isGeneratedAdditionalInfoListLastRow:e&&l}}resolveAdditionalInfoRowUsesAfterRowPrecededByFromVisibility(e,t){return t==="default"?e.showEnumValuesRow:e.showEnumValuesRow||e.showDefaultRow}resolveDescriptionRowVisible(e,t){return X(t)&&!!(e!=null&&e.description)}resolveEnumValuesRowVisible(e,t){return X(t)&&!!(e!=null&&e.enumValues&&e.enumValues.length>0)}resolveDefaultRowVisible(e,t){return X(t)&&Me(e==null?void 0:e.defaultValue)}resolveGeneratedRowVisible(e,t){return X(t)&&Me(e==null?void 0:e.generatedExpression)}};const Hi=new qt;function Xr(i,e){return Hi.resolveNodeVisibility(i,e)}function zr(i,e){return Hi.resolveListLastRowFlags(i,e)}function Ki(i,e){return Hi.resolveAdditionalInfoRowUsesAfterRowPrecededBy(i,e)}const It=u.memo(i=>{const{isVisible:e,value:t,blockClassName:n,valueClassName:r}=i;return e?o.jsx("span",{className:n,children:o.jsx("span",{className:r||void 0,children:`${t}`})}):null});It.__docgenInfo={description:"",methods:[],displayName:"AdditionalInfoPieceBase",props:{isVisible:{required:!0,tsType:{name:"boolean"},description:""},value:{required:!0,tsType:{name:"unknown"},description:""},blockClassName:{required:!1,tsType:{name:"string"},description:""},valueClassName:{required:!1,tsType:{name:"string"},description:""}}};var Re=(i=>(i.Default="default",i.DdlApiProperty="ddlapi-property",i.JsonSchemaValidation="json-schema-validation",i))(Re||{});function Qr(i={}){const{usage:e=Re.Default,textHighlighterColor:t,borderShadowColor:n,isFontMuted:r,isEmptyStringPlaceholder:a}=i;return u.useMemo(()=>({blockClassName:["additional-info-piece","subheader","block",e===Re.JsonSchemaValidation?"additional-info-piece_json-schema-validation":"",G.borderShadow(n)].filter(Boolean).join(" "),valueClassName:["inline",G.highlighter(t),r?G.fontMuted():"",a?"additional-info-piece_empty-string-placeholder":""].filter(Boolean).join(" ")}),[n,a,r,t,e])}const se=u.memo(i=>{const{isVisible:e,value:t,usage:n=Re.Default,textHighlighterColor:r,borderShadowColor:a,isFontMuted:s,isEmptyStringPlaceholder:l}=i,{blockClassName:d,valueClassName:f}=Qr({usage:n,textHighlighterColor:r,borderShadowColor:a,isFontMuted:s,isEmptyStringPlaceholder:l});return o.jsx(It,{isVisible:e,value:t,blockClassName:d,valueClassName:f})});se.__docgenInfo={description:"",methods:[],displayName:"AdditionalInfoPiece",props:{isVisible:{required:!0,tsType:{name:"boolean"},description:""},value:{required:!0,tsType:{name:"unknown"},description:""},usage:{required:!1,tsType:{name:"AdditionalInfoPieceUsage"},description:""},textHighlighterColor:{required:!1,tsType:{name:"Exclude",elements:[{name:"HighlightVariant"},{name:"HighlightVariant.Gray"}],raw:"Exclude<HighlightVariant, HighlightVariant.Gray>"},description:""},borderShadowColor:{required:!1,tsType:{name:"HighlightVariant"},description:""},isFontMuted:{required:!1,tsType:{name:"boolean"},description:""},isEmptyStringPlaceholder:{required:!1,tsType:{name:"boolean"},description:""}}};function Zr(i){const e=de(),t=Dt();return u.useMemo(()=>t?i===I?t.beforeLevel:t.afterLevel:e,[i,e,t])}var O=(i=>(i.Default="default",i.DdlApiProperty="ddlapi-property",i.JsonSchemaValidation="json-schema-validation",i))(O||{});const ea={[O.DdlApiProperty]:wi,[O.JsonSchemaValidation]:oi},ia={[O.DdlApiProperty]:"ddlapi-property-row-body",[O.Default]:"additional-info-row-body",[O.JsonSchemaValidation]:"json-schema-property-row-body"},ta={[O.DdlApiProperty]:"min-h-[26px]"};function na(i,e={}){return{xPaddingClass:e.xPaddingClass??ea[i]??Vi,bodyClass:e.bodyClass??ia[i]??"additional-info-row-body",minHeightClass:e.minHeightClass??ta[i]??"",stretchLevelIndicator:i===O.DdlApiProperty}}const qe=u.memo(i=>{var E;const{label:e,subheader:t,layoutSide:n,diff:r,colorizingDiff:a,hideLevelIndicatorWhenSideEmpty:s=!1,usage:l=O.Default,xPaddingClass:d,bodyClass:f,minHeightClass:g}=i,{[Y]:c,[j]:p}=i,b=Zr(n),h=u.useMemo(()=>na(l,{xPaddingClass:d,bodyClass:f,minHeightClass:g}),[l,d,f,g]),D=n===I?r==null?void 0:r.styles.before:r==null?void 0:r.styles.after,A=(E=(n===I?a==null?void 0:a.styles.before:a==null?void 0:a.styles.after)??D)==null?void 0:E.backgroundColor,y=u.useMemo(()=>A?[G.background(A)]:[],[A]),m=u.useMemo(()=>{const v=a==null?void 0:a.data;if(v){if(B(v))return n!==I;if(U(v))return n===I}return(D==null?void 0:D.isContentVisible)??!0},[a,D==null?void 0:D.isContentVisible,n]),R=l===O.JsonSchemaValidation&&b===0,_=b>0&&(!s||m);return o.jsxs("div",{"data-testid":"additional-info-row-content","data-precededby":c,"data-ddl-list-last-row":p?!0:void 0,className:["additional-info-row-content flex w-full items-stretch h-full gap-2",h.xPaddingClass,h.minHeightClass,h.stretchLevelIndicator?"items-stretch":"",y.join(" ")].filter(Boolean).join(" "),children:[R&&o.jsx(Ni,{}),_&&o.jsxs("div",{"data-precededby":c,className:"level-indicator-column flex items-stretch self-stretch",children:[o.jsx(De,{level:b}),o.jsx("div",{className:"w-4","aria-hidden":"true"})]}),m&&o.jsxs("div",{className:`${h.bodyClass} flex min-w-0 flex-1 items-center gap-2`,children:[o.jsx("span",{className:"additional-info-row-label",children:`${e}:`}),t==null?void 0:t(n)]})]})});qe.__docgenInfo={description:"",methods:[],displayName:"AdditionalInfoRowContent",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},"data-ddl-list-last-row":{required:!1,tsType:{name:"boolean"},description:""},xPaddingClass:{required:!1,tsType:{name:"string"},description:""},bodyClass:{required:!1,tsType:{name:"string"},description:""},minHeightClass:{required:!1,tsType:{name:"string"},description:""},label:{required:!0,tsType:{name:"string"},description:""},subheader:{required:!1,tsType:{name:"signature",type:"function",raw:"(layoutSide: LayoutSide) => ReactElement",signature:{arguments:[{type:{name:"union",raw:`| typeof ORIGIN_LAYOUT_SIDE
...
| typeof CHANGED_LAYOUT_SIDE`,elements:[{name:"ORIGIN_LAYOUT_SIDE"},{name:"CHANGED_LAYOUT_SIDE"}]},name:"layoutSide"}],return:{name:"ReactElement"}}},description:""},diff:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  type: DiffType
  causedAt: JsonPath
}`,signature:{properties:[{key:"type",value:{name:"DiffType",required:!0}},{key:"causedAt",value:{name:"JsonPath",required:!0}}]}}],raw:"Record<NodeDiffsSeverityPlacemennt, NodeDiffsSeverity>"}],raw:"Partial<Record<NodeDiffsSeverityPlacemennt, NodeDiffsSeverity>>"},description:""},diffsSeverityPlacement:{required:!1,tsType:{name:"NodeDiffsSeverityPlacemennt"},description:"Defaults to `NodeDiffsSeverityPlacemennt.AdditionalInfoRow`. Pass a dedicated placement when\na viewer renders several `AdditionalInfoRow`s for one node (e.g. JSON Schema's Default /\nExamples / Allowed values / validation-constraint rows) so each row's floating badge reflects\nonly its own diff, not the node's overall max severity."},hideLevelIndicatorWhenSideEmpty:{required:!1,tsType:{name:"boolean"},description:""},usage:{required:!1,tsType:{name:"AdditionalInfoRowUsage"},description:""}}};function pe(i,e){return i?(e===I?i.styles.before:i.styles.after).textHighlighterColor:void 0}function Lt(i){const e=`${i.tableName}.${i.columnName}`;return!i.schemaName||i.schemaName===Yr?e:`${i.schemaName}.${e}`}function ra(i){return i.join(", ")}const ui=u.memo(i=>{const{target:e,hideBadge:t=!1,textHighlighterColor:n}=i,{navigationLinkBuilder:r,navigationLinkComponent:a}=Or(),s=u.useMemo(()=>r(e.schemaName,e.tableName,e.columnName),[r,e]),l=u.useMemo(()=>["ddlapi-foreign-key-link",G.highlighter(n)].filter(Boolean).join(" "),[n]),d=o.jsx(a,{href:s,className:l,children:Lt(e)});return t?d:o.jsxs("div",{className:"ddlapi-foreign-key inline-flex flex-row items-center gap-1",children:[o.jsx(mn,{text:"FK",colorSchema:At,inline:!0}),d]})});ui.__docgenInfo={description:"",methods:[],displayName:"ForeignKey",props:{target:{required:!0,tsType:{name:"DdlApiForeignKeyTarget"},description:""},hideBadge:{required:!1,tsType:{name:"boolean"},description:"When true, only the navigation link is rendered (FK badge supplied by the caller)."},textHighlighterColor:{required:!1,tsType:{name:"Exclude",elements:[{name:"HighlightVariant"},{name:"HighlightVariant.Gray"}],raw:"Exclude<HighlightVariant, HighlightVariant.Gray>"},description:""}}};function aa(){return o.jsx("span",{className:"inline-block min-h-[19px]","aria-hidden":"true"})}function Mt(i,e){return!!i||!!e}function Si(i,e){return i?e===I?i.styles.before.isContentVisible:i.styles.after.isContentVisible:!0}function oa(i,e,t){return Mt(i,e)&&Si(e,t)}function Ae(i){const{columnId:e,label:t,colorSchema:n,flagValue:r,flagDiff:a,layoutMode:s,layoutSide:l}=i;if(!Mt(r,a))return null;if(!Si(a,l))return aa();const d=Dr(a)?a==null?void 0:a.data:void 0;return o.jsx(Xi,{label:t,colorSchema:n,layoutMode:s,layoutSide:l,isNodeChanged:!1,isContentChanged:!!d,$changes:d},la(e,t))}function sa(i){const{columnId:e,target:t,targetDiff:n,layoutMode:r,layoutSide:a}=i,s=da(e,t),l=pe(n,a);if(n&&!Si(n,a))return o.jsx("span",{className:"inline-block min-h-[19px]","aria-hidden":"true"},s);if(!n)return o.jsx(ui,{target:t},s);const d=n.data;return o.jsxs("div",{className:"ddlapi-foreign-key inline-flex flex-row items-center gap-1",children:[o.jsx(Xi,{label:"FK",colorSchema:At,layoutMode:r,layoutSide:a,isNodeChanged:!1,isContentChanged:!0,$changes:d}),o.jsx(ui,{target:t,hideBadge:!0,textHighlighterColor:l})]},s)}const Ne=u.memo(i=>{const{columnId:e,value:t,flagDiffs:n,foreignKeyTargetDiffs:r,layoutSide:a}=i,s=je(),l=u.useMemo(()=>n??{},[n]),d=u.useMemo(()=>r??{},[r]),f=u.useMemo(()=>Ae({columnId:e,label:"PK",colorSchema:Ur,flagValue:t.isPrimaryKey,flagDiff:l.isPrimaryKey,layoutMode:s,layoutSide:a}),[e,l.isPrimaryKey,s,a,t.isPrimaryKey]),g=u.useMemo(()=>oa(t.isPrimaryKey,l.isPrimaryKey,a),[l.isPrimaryKey,a,t.isPrimaryKey]),c=u.useMemo(()=>Ae({columnId:e,label:"unique",colorSchema:Kr,flagValue:t.isUnique,flagDiff:l.isUnique,layoutMode:s,layoutSide:a}),[e,l.isUnique,s,a,t.isUnique]),p=u.useMemo(()=>g?null:Ae({columnId:e,label:"not null",colorSchema:Br,flagValue:t.isNotNull,flagDiff:l.isNotNull,layoutMode:s,layoutSide:a}),[e,l.isNotNull,g,s,a,t.isNotNull]),b=u.useMemo(()=>Ae({columnId:e,label:"generated",colorSchema:Wr,flagValue:t.isGenerated,flagDiff:l.isGenerated,layoutMode:s,layoutSide:a}),[e,l.isGenerated,s,a,t.isGenerated]),h=u.useMemo(()=>{const C=t.foreignKeyTargets??[];return C.length===0?[]:C.map(A=>sa({columnId:e,target:A,targetDiff:d[Jn(A)],layoutMode:s,layoutSide:a}))},[e,s,a,d,t.foreignKeyTargets]),D=u.useMemo(()=>[f,c,p,b,...h].filter(Boolean),[h,b,p,f,c]);return D.length===0?null:o.jsx("div",{className:"flex flex-wrap items-center gap-2",children:D})});function la(i,e){return`${i}-${e}`}function da(i,e){return`${i}-FK-${Lt(e)}`}Ne.__docgenInfo={description:"",methods:[],displayName:"ColumnRowBadgesContent",props:{columnId:{required:!0,tsType:{name:"string"},description:""},value:{required:!0,tsType:{name:"signature",type:"object",raw:`{
...
| {
  ...
  readonly kind: typeof SideListDisplayKinds.PARTIAL_DIFFS
  readonly segments: readonly ListSideSegment[]
}`,signature:{properties:[{key:"kind",value:{name:"SideListDisplayKinds.PARTIAL_DIFFS",required:!0}},{key:"segments",value:{name:"unknown",required:!0}}]}}]},description:""}}};function wa(i){const e=i.findIndex(t=>t.text.startsWith("(")||t.text.startsWith(" ("));return e===-1?{typeNameSegments:i,parameterSegments:[]}:{typeNameSegments:i.slice(0,e),parameterSegments:i.slice(e)}}function Na(i,e,t){return i.diff?o.jsx(Ai,{isVisible:!0,value:i.text,appearance:ne.Text,textHighlighterColor:pe(i.diff,t)},`${i.text}-${e}`):o.jsx(xe,{isVisible:!0,value:i.text,appearance:ne.Text},`${i.text}-${e}`)}const Pt=u.memo(i=>{const{node:e,layoutSide:t}=i,n=er(e,t);if(n.kind===W.NO_DIFFS||n.kind===W.WHOLE_DIFFS)return o.jsx(Pe,{layoutSide:t,display:n});const{typeNameSegments:r,parameterSegments:a}=wa(n.segments);return o.jsxs("span",{className:"inline-flex items-center gap-1",children:[r.map((s,l)=>Na(s,l,t)),a.length>0&&o.jsx(Pe,{layoutSide:t,display:{kind:W.PARTIAL_DIFFS,segments:a}})]})});Pt.__docgenInfo={description:"",methods:[],displayName:"ColumnTypeLabelWithDiffs",props:{node:{required:!0,tsType:{name:"ITreeNodeWithDiffs",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.COLUMN"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  readonly _fragment: unknown
}`,signature:{properties:[{key:"_fragment",value:{name:"unknown",required:!0}}]}}],raw:`Partial<{
  readonly _fragment: unknown
...
| typeof CHANGED_LAYOUT_SIDE`,elements:[{name:"ORIGIN_LAYOUT_SIDE"},{name:"CHANGED_LAYOUT_SIDE"}]},description:""}}};const jt=i=>{const{node:e,additionalInfoPrecededBy:t=F.DDL_COLUMN_ROW,isLastInList:n=!1,hideLevelIndicatorWhenSideEmpty:r=!1,[Y]:a}=i,s=he(),l=e.value(),d=u.useMemo(()=>kt(e),[e]),f=u.useMemo(()=>Ct(e),[e]),g=u.useMemo(()=>ga(e),[e]),c=u.useMemo(()=>fa(e),[e]),p=u.useMemo(()=>pt(e),[e]),b=u.useMemo(()=>ai(e),[e]),h=u.useMemo(()=>Di(e),[e]),D=u.useMemo(()=>mr(e),[e]),C=u.useMemo(()=>vi(e),[e]),A=u.useMemo(()=>mt(e),[e]),y=u.useMemo(()=>ha(e,s),[e,s]),m=u.useMemo(()=>ma(n,y),[n,y]),R=u.useCallback(V=>l?gt(d,V)?o.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[o.jsx(Pt,{node:e,layoutSide:V}),o.jsx(Ne,{columnId:e.id,layoutSide:V,value:l,flagDiffs:g,foreignKeyTargetDiffs:c})]}):o.jsx(o.Fragment,{}):o.jsx(o.Fragment,{}),[g,c,e,d,l]),_=u.useCallback(V=>{const w=yr(e,V);return w===void 0?o.jsx(o.Fragment,{}):o.jsx(se,{isVisible:!0,value:w,textHighlighterColor:pe(C,V),borderShadowColor:Bi(C,V)})},[C,e]),E=u.useCallback(V=>{const w=ya(e,V);return w===void 0?o.jsx(o.Fragment,{}):o.jsx(se,{isVisible:!0,value:w,textHighlighterColor:pe(b,V)})},[b,e]),v=u.useCallback(V=>{const w=br(e,V);return w.length===0?o.jsx(o.Fragment,{}):o.jsx("div",{className:"flex flex-wrap items-center gap-2",children:w.map((S,N)=>o.jsx(se,{isVisible:!0,value:S.literal,textHighlighterColor:pe(S.diff,V),borderShadowColor:Bi(S.diff,V),isFontMuted:ua(S.diff,V)},`${S.literal}-${N}`))})},[e]);return l?o.jsxs("div",{"data-testid":"ddl-column-node-viewer",className:"flex flex-col ddlapi-property",children:[o.jsx(re,{"data-precededby":a,[j]:m.isTitleListLastRow||void 0,value:l.columnName,expandable:!1,expanded:!0,variant:H.body2,subheader:R,usage:q.DdlApiProperty,hideLevelIndicatorWhenSideEmpty:r,...f}),y.showDescription&&o.jsx(Ve,{"data-precededby":F.DDL_COLUMN_ROW,[j]:m.isDescriptionListLastRow||void 0,value:l.description??"",variant:H.body2,textFontWeight:"normal",textColor:We,usage:te.DdlApiProperty,diff:p,diffsSeverities:e.diffsSeverities,hideLevelIndicatorWhenSideEmpty:r}),y.showEnumValuesRow&&o.jsx(le,{usage:O.DdlApiProperty,"data-precededby":t,[j]:m.isEnumAdditionalInfoListLastRow||void 0,label:Tt,subheader:v,colorizingDiff:D,diffsSeverities:h||D?e.diffsSeverities:void 0,hideLevelIndicatorWhenSideEmpty:r}),y.showDefaultRow&&o.jsx(le,{usage:O.DdlApiProperty,"data-precededby":Yi(y,"default")?F.DDL_COLUMN_AFTER_ADDITIONAL_INFO_ROW:t,[j]:m.isDefaultAdditionalInfoListLastRow||void 0,label:_t,subheader:_,colorizingDiff:A,diffsSeverities:C||A?e.diffsSeverities:void 0,hideLevelIndicatorWhenSideEmpty:r}),y.showGeneratedRow&&o.jsx(le,{usage:O.DdlApiProperty,"data-precededby":Yi(y,"generated")?F.DDL_COLUMN_AFTER_ADDITIONAL_INFO_ROW:t,[j]:m.isGeneratedAdditionalInfoListLastRow||void 0,label:Et,subheader:E,diff:b,colorizingDiff:e.diffs[Q],diffsSeverities:e.diffsSeverities,hideLevelIndicatorWhenSideEmpty:r})]}):null};jt.__docgenInfo={description:"",methods:[],displayName:"ColumnNodeViewerWithDiffs",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},node:{required:!0,tsType:{name:"ITreeNodeWithDiffs",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.COLUMN"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  ...
  DdlApiTreeNodeMeta,
  DdlApiTreeNodeValue<K> | null
>`},description:""},additionalInfoPrecededBy:{required:!1,tsType:{name:"PrecededBy"},description:""},isLastInList:{required:!1,tsType:{name:"boolean"},description:""},hideLevelIndicatorWhenSideEmpty:{required:!1,tsType:{name:"boolean"},description:""}}};function Ft(i,e){let t=!1;return i.map((n,r)=>{const a=r===i.length-1,s=t?F.DDL_COLUMN_AFTER_ADDITIONAL_INFO_ROW:F.DDL_COLUMN_ROW,l=t?F.DDL_COLUMN_AFTER_ADDITIONAL_INFO_ROW:F.DDL_COLUMN_ROW,d={columnNode:n,titlePrecededBy:s,additionalInfoPrecededBy:l,isLastInList:a};return t=e&&$r(n.value()),d})}const xa=i=>{const{node:e,[Y]:t}=i;return Rr(e)?o.jsx(Sa,{"data-precededby":t,node:e}):o.jsx(Ha,{"data-precededby":t,node:e})},Ha=i=>{const{node:e,[Y]:t}=i,n=de(),r=he(),a=e.value(),s=Ht(e.childrenNodes()),l=r===zi,d=u.useMemo(()=>Ft(s,l),[s,l]);return s.length===0?null:o.jsxs("div",{"data-testid":"ddl-columns-node-viewer",className:"flex flex-col",children:[o.jsx(re,{"data-precededby":t,value:(a==null?void 0:a.title)??"Columns",expandable:!1,expanded:!0,variant:H.h2,usage:q.DdlApiSection}),o.jsx(Fe.Provider,{value:n+1,children:d.map(({columnNode:f,titlePrecededBy:g,additionalInfoPrecededBy:c,isLastInList:p})=>o.jsx(Ci,{"data-precededby":g,additionalInfoPrecededBy:c,isLastInList:p,node:f},f.id))})]})},Sa=i=>{const{node:e,[Y]:t}=i,n=de(),r=he(),a=e.value(),s=Ht(e.childrenNodes()),l=r===zi,d=u.useMemo(()=>Ye(we(e)),[e]),f=u.useMemo(()=>Ft(s,l),[s,l]),g=u.useMemo(()=>ct(e),[e]);return s.length===0?null:o.jsxs("div",{"data-testid":"ddl-columns-node-viewer",className:"flex flex-col",children:[o.jsx(re,{"data-precededby":t,value:(a==null?void 0:a.title)??"Columns",expandable:!1,expanded:!0,variant:H.h2,usage:q.DdlApiSection,...d}),o.jsx(Fe.Provider,{value:n+1,children:f.map(({columnNode:c,titlePrecededBy:p,additionalInfoPrecededBy:b,isLastInList:h})=>xi(c)?o.jsx(jt,{"data-precededby":p,additionalInfoPrecededBy:b,isLastInList:h,hideLevelIndicatorWhenSideEmpty:g,node:c},c.id):o.jsx(Ci,{"data-precededby":p,additionalInfoPrecededBy:b,isLastInList:h,node:c},c.id))})]})};xa.__docgenInfo={description:"",methods:[],displayName:"ColumnsNodeViewer",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},node:{required:!0,tsType:{name:"union",raw:`| DdlApiTreeNode<typeof DdlApiTreeNodeKinds.COLUMNS>
| DdlApiTreeNodeWithDiffs<typeof DdlApiTreeNodeKinds.COLUMNS>`,elements:[{name:"ITreeNode",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.COLUMNS"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  ...
  DdlApiTreeNodeMeta,
  DdlApiTreeNodeValue<K> | null
>`}]},description:""}}};let Ot=class{resolveNodeVisibility(e,t){const n=e.value();return{showDescription:this.resolveDescriptionRowVisible(n,t),showSubheader:this.resolveSubheaderVisible(n)}}resolveListLastRowFlags(e,t){return this.resolveListLastRowFlagsFromVisibility(e,t)}resolveListLastRowFlagsFromVisibility(e,t){const{showDescription:n}=t;return{isTitleListLastRow:e&&!n,isDescriptionListLastRow:e&&n}}resolveDescriptionRowVisible(e,t){return X(t)&&!!(e!=null&&e.description)}resolveSubheaderVisible(e){return!!e&&(e.partNames.length>0||e.isUnique)}};const Gt=new Ot;function ka(i,e){return Gt.resolveNodeVisibility(i,e)}function Ca(i,e){return Gt.resolveListLastRowFlags(i,e)}const _i=i=>{const{node:e,isLastInList:t=!1,[Y]:n}=i,r=he(),a=e.value(),s=u.useMemo(()=>ka(e,r),[e,r]),l=u.useMemo(()=>Ca(t,s),[t,s]),d=(a==null?void 0:a.indexName)??"",f=u.useCallback(c=>{if(!a)return o.jsx(o.Fragment,{});const p=ra(a.partNames);return o.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[a.partNames.length>0&&o.jsx(xe,{isVisible:!0,value:`(${p})`,appearance:ne.Text}),o.jsx(Ne,{columnId:e.id,layoutSide:c,value:a})]})},[e.id,a]),g=s.showDescription;return a?o.jsxs("div",{"data-testid":"ddl-index-node-viewer",className:"flex flex-col ddlapi-property",children:[o.jsx(re,{"data-precededby":n,[j]:l.isTitleListLastRow||void 0,value:d,expandable:!1,expanded:!0,variant:H.body2,subheader:s.showSubheader?f:void 0,usage:q.DdlApiProperty}),g&&o.jsx(Ve,{"data-precededby":F.DDL_INDEX_ROW,[j]:l.isDescriptionListLastRow||void 0,value:a.description??"",variant:H.body1,textFontWeight:"normal",textColor:We,usage:te.DdlApiProperty})]}):null};_i.__docgenInfo={description:"",methods:[],displayName:"IndexNodeViewer",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},node:{required:!0,tsType:{name:"ITreeNode",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.INDEX"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  readonly _fragment: unknown
}`,signature:{properties:[{key:"_fragment",value:{name:"unknown",required:!0}}]}}],raw:`Partial<{
  readonly _fragment: unknown
}>`}],raw:"ITreeNode<DdlApiTreeNodeValue<K> | null, K, DdlApiTreeNodeMeta>"},description:""},isLastInList:{required:!1,tsType:{name:"boolean"},description:""}}};const Aa=new Ot;class _a{resolveNodeVisibility(e,t){var r;const n=e.value();return{showDescription:this.resolveDescriptionRowVisible(n,ht(e),t),showSubheader:this.resolveSubheaderVisible(n,(r=yt(e))==null?void 0:r.isUnique)}}resolveListLastRowFlags(e,t){return Aa.resolveListLastRowFlags(e,t)}resolveDescriptionRowVisible(e,t,n){return X(n)&&(!!(e!=null&&e.description)||!!t)}resolveSubheaderVisible(e,t){return!!e&&(e.partNames.length>0||e.isUnique||!!t)}}const Ut=new _a;function Ea(i,e){return Ut.resolveNodeVisibility(i,e)}function Ta(i,e){return Ut.resolveListLastRowFlags(i,e)}const Kt=i=>{const{node:e,isLastInList:t=!1,hideLevelIndicatorWhenSideEmpty:n=!1,[Y]:r}=i,a=he(),s=e.value(),l=u.useMemo(()=>Ea(e,a),[e,a]),d=u.useMemo(()=>Ta(t,l),[t,l]),f=u.useMemo(()=>kt(e),[e]),g=u.useMemo(()=>Ct(e),[e]),c=u.useMemo(()=>ca(e),[e]),p=u.useMemo(()=>ht(e),[e]),b=(s==null?void 0:s.indexName)??"",h=u.useCallback(A=>{const y=sr(e,A);return o.jsx(Pe,{layoutSide:A,display:y})},[e]),D=u.useCallback(A=>{if(!s)return o.jsx(o.Fragment,{});if(!gt(f,A))return o.jsx(o.Fragment,{});const y=s.partNames.length>0;return o.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[y&&h(A),o.jsx(Ne,{columnId:e.id,layoutSide:A,value:s,flagDiffs:c})]})},[c,e.id,f,h,s]),C=l.showDescription;return s?o.jsxs("div",{"data-testid":"ddl-index-node-viewer",className:"flex flex-col ddlapi-property",children:[o.jsx(re,{"data-precededby":r,[j]:d.isTitleListLastRow||void 0,value:b,expandable:!1,expanded:!0,variant:H.body2,subheader:l.showSubheader?D:void 0,usage:q.DdlApiProperty,hideLevelIndicatorWhenSideEmpty:n,...g}),C&&o.jsx(Ve,{"data-precededby":F.DDL_INDEX_ROW,[j]:d.isDescriptionListLastRow||void 0,value:s.description??"",variant:H.body1,textFontWeight:"normal",textColor:We,usage:te.DdlApiProperty,diff:p,diffsSeverities:e.diffsSeverities,hideLevelIndicatorWhenSideEmpty:n})]}):null};Kt.__docgenInfo={description:"",methods:[],displayName:"IndexNodeViewerWithDiffs",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},node:{required:!0,tsType:{name:"ITreeNodeWithDiffs",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.INDEX"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  readonly _fragment: unknown
}`,signature:{properties:[{key:"_fragment",value:{name:"unknown",required:!0}}]}}],raw:`Partial<{
  readonly _fragment: unknown
}>`},{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]}],raw:`ITreeNodeWithDiffs<
  ...
  DdlApiTreeNodeMeta,
  DdlApiTreeNodeValue<K> | null
>`},description:""},isLastInList:{required:!1,tsType:{name:"boolean"},description:""},hideLevelIndicatorWhenSideEmpty:{required:!1,tsType:{name:"boolean"},description:""}}};function Bt(i){return i.map((e,t)=>({indexNode:e,titlePrecededBy:F.DDL_INDEX_ROW,isLastInList:t===i.length-1}))}const qa=i=>{const{node:e,[Y]:t}=i;return Pr(e)?o.jsx(La,{"data-precededby":t,node:e}):o.jsx(Ia,{"data-precededby":t,node:e})},Ia=i=>{const{node:e,[Y]:t}=i,n=de(),r=e.value(),a=St(e.childrenNodes()),s=u.useMemo(()=>Bt(a),[a]);return a.length===0?null:o.jsxs("div",{"data-testid":"ddl-indexes-node-viewer",className:"flex flex-col",children:[o.jsx(re,{"data-precededby":t,value:(r==null?void 0:r.title)??"Indexes",expandable:!1,expanded:!0,variant:H.h2,usage:q.DdlApiSection}),o.jsx(Fe.Provider,{value:n+1,children:s.map(({indexNode:l,titlePrecededBy:d,isLastInList:f})=>o.jsx(_i,{"data-precededby":d,isLastInList:f,node:l},l.id))})]})},La=i=>{const{node:e,[Y]:t}=i,n=de(),r=e.value(),a=St(e.childrenNodes()),s=u.useMemo(()=>Ye(we(e)),[e]),l=u.useMemo(()=>Bt(a),[a]),d=u.useMemo(()=>ct(e),[e]);return a.length===0?null:o.jsxs("div",{"data-testid":"ddl-indexes-node-viewer",className:"flex flex-col",children:[o.jsx(re,{"data-precededby":t,value:(r==null?void 0:r.title)??"Indexes",expandable:!1,expanded:!0,variant:H.h2,usage:q.DdlApiSection,...s}),o.jsx(Fe.Provider,{value:n+1,children:l.map(({indexNode:f,titlePrecededBy:g,isLastInList:c})=>xt(f)?o.jsx(Kt,{"data-precededby":g,isLastInList:c,hideLevelIndicatorWhenSideEmpty:d,node:f},f.id):o.jsx(_i,{"data-precededby":g,isLastInList:c,node:f},f.id))})]})};qa.__docgenInfo={description:"",methods:[],displayName:"IndexesNodeViewer",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},node:{required:!0,tsType:{name:"union",raw:`| DdlApiTreeNode<typeof DdlApiTreeNodeKinds.INDEXES>
| DdlApiTreeNodeWithDiffs<typeof DdlApiTreeNodeKinds.INDEXES>`,elements:[{name:"ITreeNode",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.INDEXES"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  ...
  DdlApiTreeNodeMeta,
  DdlApiTreeNodeValue<K> | null
>`}]},description:""}}};export{ze as $,Y as A,Qa as B,xa as C,Yr as D,me as E,Ja as F,Xa as G,qn as H,qa as I,Za as J,za as K,et as L,pe as M,Ue as N,Ke as O,F as P,Be as Q,fo as R,ue as S,re as T,uo as U,ur as V,io as W,Vi as X,to as Y,lo as Z,yn as _,jr as a,bn as a0,xn as a1,Hn as a2,vn as a3,Vn as a4,Dn as a5,ae as a6,Zi as a7,Ga as a8,Qi as a9,te as aA,Hr as aB,wi as aC,Ni as aD,cr as aE,se as aF,Re as aG,Bi as aH,ua as aI,oo as aJ,le as aK,O as aL,Qn as aM,zn as aN,Xn as aO,Ua as aa,Oa as ab,Fa as ac,Ba as ad,Wa as ae,L as af,ro as ag,no as ah,ao as ai,bt as aj,Vr as ak,_r as al,Dt as am,we as an,Ye as ao,q as ap,Ya as aq,vr as ar,X as as,W as at,ve as au,oi as av,Zr as aw,ba as ax,xr as ay,Nr as az,H as b,Ve as c,We as d,wn as e,eo as f,so as g,Lr as h,Mr as i,Fr as j,Gr as k,k as l,Bn as m,Qe as n,Jn as o,Gn as p,ot as q,$a as r,tt as s,Ka as t,yi as u,Ge as v,M as w,nt as x,rt as y,In as z};
