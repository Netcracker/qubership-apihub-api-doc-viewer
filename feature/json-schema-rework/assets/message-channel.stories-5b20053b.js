...
}))`,...(U=(J=i.parameters)==null?void 0:J.docs)==null?void 0:U.source}}};var Z,ee,re;p.parameters={...p.parameters,docs:{...(Z=p.parameters)==null?void 0:Z.docs,source:{originalSource:`createStory(createSource({
  channel: {
    parameters: {
      param1: {
...
}))`,...(re=(ee=p.parameters)==null?void 0:ee.docs)==null?void 0:re.source}}};var ne,te,se;d.parameters={...d.parameters,docs:{...(ne=d.parameters)==null?void 0:ne.docs,source:{originalSource:`createStory(createSource({
  channel: {
    parameters: {
      param1: {
        description: "Parameter description",
...
}))`,...(se=(te=d.parameters)==null?void 0:te.docs)==null?void 0:se.source}}};var oe,ae,ce;l.parameters={...l.parameters,docs:{...(oe=l.parameters)==null?void 0:oe.docs,source:{originalSource:`createStory(createSource({
  channel: {
    ...EXTENSIONS
  }
}))`,...(ce=(ae=l.parameters)==null?void 0:ae.docs)==null?void 0:ce.source}}};var ie,pe,de;m.parameters={...m.parameters,docs:{...(ie=m.parameters)==null?void 0:ie.docs,source:{originalSource:`createStory(createSource({
  channel: {
    bindings: {
      kafka: {
...
}))`,...(de=(pe=m.parameters)==null?void 0:pe.docs)==null?void 0:de.source}}};var le,me,he;h.parameters={...h.parameters,docs:{...(le=h.parameters)==null?void 0:le.docs,source:{originalSource:`createStory(createSource({
  channel: {
    bindings: {
      kafka: {
        bindingVersion: "0.5.0",
...
}))`,...(cr=(ar=C.parameters)==null?void 0:ar.docs)==null?void 0:cr.source}}};var ir,pr,dr;V.parameters={...V.parameters,docs:{...(ir=V.parameters)==null?void 0:ir.docs,source:{originalSource:`createStory(createSource({
  channel: {
    parameters: {
      param1: {
        description: "Parameter description"
...
}))`,...(dr=(pr=V.parameters)==null?void 0:pr.docs)==null?void 0:dr.source}}};var lr,mr,hr;D.parameters={...D.parameters,docs:{...(lr=D.parameters)==null?void 0:lr.docs,source:{originalSource:`createStory(createSource({
  channel: {
    ...EXTENSIONS,
    bindings: {
      kafka: {
