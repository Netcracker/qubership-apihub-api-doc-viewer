...
>`}]},description:""}}};let Lt=class{resolveNodeVisibility(e,t){const n=e.value();return{showDescription:this.resolveDescriptionRowVisible(n,t),showSubheader:this.resolveSubheaderVisible(n)}}resolveListLastRowFlags(e,t){return this.resolveListLastRowFlagsFromVisibility(e,t)}resolveListLastRowFlagsFromVisibility(e,t){const{showDescription:n}=t;return{isTitleListLastRow:e&&!n,isDescriptionListLastRow:e&&n}}resolveDescriptionRowVisible(e,t){return X(t)&&!!(e!=null&&e.description)}resolveSubheaderVisible(e){return!!e&&(e.partNames.length>0||e.isUnique)}};const It=new Lt;function sa(i,e){return It.resolveNodeVisibility(i,e)}function la(i,e){return It.resolveListLastRowFlags(i,e)}const ki=i=>{const{node:e,isLastInList:t=!1,[B]:n}=i,r=ge(),a=e.value(),o=d.useMemo(()=>sa(e,r),[e,r]),l=d.useMemo(()=>la(t,o),[t,o]),u=(a==null?void 0:a.indexName)??"",f=d.useCallback(c=>{if(!a)return s.jsx(s.Fragment,{});const m=jr(a.partNames);return s.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[a.partNames.length>0&&s.jsx(Ve,{isVisible:!0,value:`(${m})`,appearance:ie.Text}),s.jsx(ve,{columnId:e.id,layoutSide:c,value:a})]})},[e.id,a]),g=o.showDescription;return a?s.jsxs("div",{"data-testid":"ddl-index-node-viewer",className:"flex flex-col ddlapi-property",children:[s.jsx(te,{"data-precededby":n,[F]:l.isTitleListLastRow||void 0,value:u,expandable:!1,expanded:!0,variant:x.body2,subheader:o.showSubheader?f:void 0,usage:E.DdlApiProperty}),g&&s.jsx(be,{"data-precededby":j.DDL_INDEX_ROW,[F]:l.isDescriptionListLastRow||void 0,value:a.description??"",variant:x.body1,textFontWeight:"normal",textColor:Ue,usage:ee.DdlApiProperty})]}):null};ki.__docgenInfo={description:"",methods:[],displayName:"IndexNodeViewer",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},node:{required:!0,tsType:{name:"ITreeNode",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.INDEX"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  ...
  DdlApiTreeNodeMeta,
  DdlApiTreeNodeValue<K> | null
>`},description:""},isLastInList:{required:!1,tsType:{name:"boolean"},description:""},hideLevelIndicatorWhenSideEmpty:{required:!1,tsType:{name:"boolean"},description:""}}};function jt(i){return i.map((e,t)=>({indexNode:e,titlePrecededBy:j.DDL_INDEX_ROW,isLastInList:t===i.length-1}))}const ca=i=>{const{node:e,[B]:t}=i;return Dr(e)?s.jsx(pa,{"data-precededby":t,node:e}):s.jsx(ha,{"data-precededby":t,node:e})},ha=i=>{const{node:e,[B]:t}=i,n=se(),r=e.value(),a=Dt(e.childrenNodes()),o=d.useMemo(()=>jt(a),[a]);return a.length===0?null:s.jsxs("div",{"data-testid":"ddl-indexes-node-viewer",className:"flex flex-col",children:[s.jsx(te,{"data-precededby":t,value:(r==null?void 0:r.title)??"Indexes",expandable:!1,expanded:!0,variant:x.h2,usage:E.DdlApiSection}),s.jsx(Fe.Provider,{value:n+1,children:o.map(({indexNode:l,titlePrecededBy:u,isLastInList:f})=>s.jsx(ki,{"data-precededby":u,isLastInList:f,node:l},l.id))})]})},pa=i=>{const{node:e,[B]:t}=i,n=se(),r=e.value(),a=Dt(e.childrenNodes()),o=d.useMemo(()=>Be(De(e)),[e]),l=d.useMemo(()=>jt(a),[a]),u=d.useMemo(()=>lt(e),[e]);return a.length===0?null:s.jsxs("div",{"data-testid":"ddl-indexes-node-viewer",className:"flex flex-col",children:[s.jsx(te,{"data-precededby":t,value:(r==null?void 0:r.title)??"Indexes",expandable:!1,expanded:!0,variant:x.h2,usage:E.DdlApiSection,...o}),s.jsx(Fe.Provider,{value:n+1,children:l.map(({indexNode:f,titlePrecededBy:g,isLastInList:c})=>yt(f)?s.jsx(Ft,{"data-precededby":g,isLastInList:c,hideLevelIndicatorWhenSideEmpty:u,node:f},f.id):s.jsx(ki,{"data-precededby":g,isLastInList:c,node:f},f.id))})]})};ca.__docgenInfo={description:"",methods:[],displayName:"IndexesNodeViewer",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},node:{required:!0,tsType:{name:"union",raw:`| DdlApiTreeNode<typeof DdlApiTreeNodeKinds.INDEXES>
| DdlApiTreeNodeWithDiffs<typeof DdlApiTreeNodeKinds.INDEXES>`,elements:[{name:"ITreeNode",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.INDEXES"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  ...
  DdlApiTreeNodeMeta,
  DdlApiTreeNodeValue<K> | null
>`}]},description:""}}};export{Xe as $,B as A,_a as B,ra as C,Sr as D,ce as E,Aa as F,qa as G,hn as H,ca as I,Ea as J,Ta as K,Xi as L,fe as M,Pe as N,Oe as O,j as P,Ge as Q,Oa as R,le as S,te as T,Pa as U,Bn as V,Ia as W,Ke as X,Ma as Y,Ra as Z,Jt as _,vr as a,Qt as a0,an as a1,on as a2,en as a3,tn as a4,Zt as a5,ne as a6,$i as a7,wa as a8,Yi as a9,O as aA,ka as aa,Va as ab,va as ac,xa as ad,Na as ae,ct as af,ir as ag,ur as ah,fr as ai,De as aj,Be as ak,E as al,Ca as am,X as an,ee as ao,pi as ap,Fi as aq,$n as ar,Ve as as,ie as at,ae as au,bi as av,Fa as aw,_n as ax,En as ay,oe as az,x as b,be as c,Ue as d,nn as e,La as f,ja as g,mr as h,yr as i,Vr as j,kr as k,A as l,Nn as m,ze as n,qn as o,kn as p,it as q,Sa as r,Ji as s,Ha as t,fi as u,Re as v,I as w,Qi as x,Zi as y,pn as z};
