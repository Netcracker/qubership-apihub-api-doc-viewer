import{l as Pe,I as Te,S as Q,D as we,a as ve}from"./index-71f1bfe0.js";import{b as e}from"./graph-api-transformers-4646d964.js";import{j as qe}from"./_commonjs-dynamic-modules-6308e768.js";import{c as xe}from"./preprocess-3be277e1.js";import{G as je}from"./GraphQLOperationDiffViewer-aadc8f99.js";import"./index-f46741a2.js";import"./buildASTSchema-f14864f0.js";/* empty css              */import"./GraphPropNodeViewer-49e74551.js";import"./DiffBadge-51a3ec54.js";import"./index-c19463f3.js";import"./index-415bee12.js";const Oe=f=>{const{beforeSource:Ge,afterSource:Ne,circular:Be=!1}=f,De=xe({beforeSource:Ge,afterSource:Ne,circular:Be});return qe.jsx(je,{...f,source:De})};Oe.__docgenInfo={description:"",methods:[],displayName:"TestGraphQLOperationDiffViewer",props:{beforeSource:{required:!1,tsType:{name:"unknown"},description:""},afterSource:{required:!0,tsType:{name:"unknown"},description:""},circular:{required:!1,tsType:{name:"boolean"},description:""}}};const He={title:"GraphQL Operation Diff Viewer/Output",component:Oe,parameters:{},argTypes:{beforeSource:{control:"object"},afterSource:{control:"object"},layoutMode:{control:"radio",options:[Pe,Te,Q]},filters:{control:"check",options:["breaking","non-breaking","annotation","unclassified","deprecated"]}},args:{layoutMode:Q,metaKeys:{diffsMetaKey:we,aggregatedDiffsMetaKey:ve}}},r={args:{beforeSource:e(`
      type Query {
