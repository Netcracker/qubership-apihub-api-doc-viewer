...
| typeof CHANGED_LAYOUT_SIDE`,elements:[{name:"ORIGIN_LAYOUT_SIDE"},{name:"CHANGED_LAYOUT_SIDE"}]},name:"layoutSide"}],return:{name:"ReactElement"}}},description:""},usage:{required:!1,tsType:{name:"TitleRowUsage"},description:""},highlightingMode:{required:!1,tsType:{name:"Map",elements:[{name:"DiffHiglightingApplicationArea"},{name:"DiffHighlightingApplicationMode"}],raw:"Map<DiffHiglightingApplicationArea, DiffHighlightingApplicationMode>"},description:""},diff:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  type: DiffType
  causedAt: JsonPath
}`,signature:{properties:[{key:"type",value:{name:"DiffType",required:!0}},{key:"causedAt",value:{name:"JsonPath",required:!0}}]}}],raw:"Record<NodeDiffsSeverityPlacemennt, NodeDiffsSeverity>"}],raw:"Partial<Record<NodeDiffsSeverityPlacemennt, NodeDiffsSeverity>>"},description:""},hideLevelIndicatorWhenSideEmpty:{required:!1,tsType:{name:"boolean"},description:""}}};function Oa(i,e){return u.useMemo(()=>e(i)?ve(i):{},[e,i])}function ve(i){return{nodeDiffs:i.diffs,nodeDescendantDiffs:i.descendantDiffs,nodeDiffsSeverities:i.diffsSeverities}}function Be(i,e={}){const{diffKey:t,fallbackToNodeDiff:n=!0,includeDescendantDiffs:r=!0,diffsSeverityPlacement:a,resolveDiff:s}=e,{nodeDiffs:l,nodeDescendantDiffs:d,nodeDiffsSeverities:f}=i;if(!l)return{};const g=Object.entries(l),c=h=>{const D=g.find(([S])=>S===String(h));return D==null?void 0:D[1]},p=t?c(t):void 0;return{diff:s?s(l,c):n?l[z]??p:p,...r?{descendantDiffs:d}:{},diffsSeverities:f,...a?{diffsSeverityPlacement:a}:{}}}function br(i){return Zi.includes(i.kind)}function Ga(i){return i.childrenNodes().filter(br)}function Dr(i){return i.kind===I.TABLE}function Ka(i){return Dr(i)&&i instanceof le}function vr(i){return i.kind===I.COLUMNS}function Vr(i){return vr(i)&&i instanceof le}function wr(i){return xr(i)&&i instanceof le}function Vt(i){return i.kind===I.COLUMN}function Vi(i){return Vt(i)&&i instanceof le}function xr(i){return i.kind===I.INDEXES}function wt(i){return i.kind===I.INDEX}function xt(i){return wt(i)&&i instanceof le}function kt(i){return i.filter(Vt)}function Ht(i){return i.filter(wt)}const kr=u.createContext(null);function Hr(){const i=u.useContext(kr);if(!i)throw new Error("useDdlTableViewerContext must be used within DdlTableViewer");return i}const Nr=({href:i,className:e,children:t})=>o.jsx("a",{href:i,className:e,children:t});Nr.__docgenInfo={description:"",methods:[],displayName:"DefaultNavigationLink"};const Nt=zn;function Ct(i){const e=Be(ve(i),{resolveDiff:()=>Jn(i)});return e.diff?{...e,highlightingMode:e.diff.highlightingMode}:{}}function Ua(i){const e=Be(ve(i),{resolveDiff:()=>Yn(i)});return e.diff?{...e,highlightingMode:e.diff.highlightingMode}:{}}const Ba=$n,Cr="ux-badge_ddlapi_primary-key",St="ux-badge_ddlapi_foreign-key",Sr="ux-badge_ddlapi_unique",Ar="ux-badge_ddlapi_not-null",qr="ux-badge_ddlapi_generated",Tr="public",At="Default",qt="As",Tt="Values";function _r(i){return i?!!(Le(i.defaultValue)||Le(i.generatedExpression)||i.enumValues&&i.enumValues.length>0):!1}const Er="detailed";function X(i){return i===Er}function Ie(i){return i!=null}let _t=class{resolveNodeVisibility(e,t){const n=e.value(),r=this.resolveDescriptionRowVisible(n,t),a=this.resolveEnumValuesRowVisible(n,t),s=this.resolveDefaultRowVisible(n,t),l=this.resolveGeneratedRowVisible(n,t);return{showDescription:r,showEnumValuesRow:a,showDefaultRow:s,showGeneratedRow:l,showAnyAdditionalInfoRow:a||s||l}}resolveListLastRowFlags(e,t){return this.resolveListLastRowFlagsFromVisibility(e,t)}resolveAdditionalInfoRowUsesAfterRowPrecededBy(e,t){return this.resolveAdditionalInfoRowUsesAfterRowPrecededByFromVisibility(e,t)}resolveListLastRowFlagsFromVisibility(e,t){const{showDescription:n,showAnyAdditionalInfoRow:r,showEnumValuesRow:a,showDefaultRow:s,showGeneratedRow:l}=t;return{isTitleListLastRow:e&&!n&&!r,isDescriptionListLastRow:e&&n&&!r,isEnumAdditionalInfoListLastRow:e&&a&&!s&&!l,isDefaultAdditionalInfoListLastRow:e&&s&&!l,isGeneratedAdditionalInfoListLastRow:e&&l}}resolveAdditionalInfoRowUsesAfterRowPrecededByFromVisibility(e,t){return t==="default"?e.showEnumValuesRow:e.showEnumValuesRow||e.showDefaultRow}resolveDescriptionRowVisible(e,t){return X(t)&&!!(e!=null&&e.description)}resolveEnumValuesRowVisible(e,t){return X(t)&&!!(e!=null&&e.enumValues&&e.enumValues.length>0)}resolveDefaultRowVisible(e,t){return X(t)&&Ie(e==null?void 0:e.defaultValue)}resolveGeneratedRowVisible(e,t){return X(t)&&Ie(e==null?void 0:e.generatedExpression)}};const wi=new _t;function Lr(i,e){return wi.resolveNodeVisibility(i,e)}function Ir(i,e){return wi.resolveListLastRowFlags(i,e)}function Gi(i,e){return wi.resolveAdditionalInfoRowUsesAfterRowPrecededBy(i,e)}const Et=u.memo(i=>{const{isVisible:e,value:t,blockClassName:n,valueClassName:r}=i;return e?o.jsx("span",{className:n,children:o.jsx("span",{className:r||void 0,children:`${t}`})}):null});Et.__docgenInfo={description:"",methods:[],displayName:"AdditionalInfoPieceBase",props:{isVisible:{required:!0,tsType:{name:"boolean"},description:""},value:{required:!0,tsType:{name:"unknown"},description:""},blockClassName:{required:!1,tsType:{name:"string"},description:""},valueClassName:{required:!1,tsType:{name:"string"},description:""}}};var xi=(i=>(i.Default="default",i.DdlApiProperty="ddlapi-property",i.JsonSchemaValidation="json-schema-validation",i))(xi||{});function Mr(i={}){const{usage:e=xi.Default,textHighlighterColor:t,borderShadowColor:n,isFontMuted:r}=i;return u.useMemo(()=>({blockClassName:["additional-info-piece","subheader","block",O.borderShadow(n)].filter(Boolean).join(" "),valueClassName:[O.highlighter(t),r?O.fontMuted():""].filter(Boolean).join(" ")}),[n,r,t,e])}const ae=u.memo(i=>{const{isVisible:e,value:t,usage:n=xi.Default,textHighlighterColor:r,borderShadowColor:a,isFontMuted:s}=i,{blockClassName:l,valueClassName:d}=Mr({usage:n,textHighlighterColor:r,borderShadowColor:a,isFontMuted:s});return o.jsx(Et,{isVisible:e,value:t,blockClassName:l,valueClassName:d})});ae.__docgenInfo={description:"",methods:[],displayName:"AdditionalInfoPiece",props:{isVisible:{required:!0,tsType:{name:"boolean"},description:""},value:{required:!0,tsType:{name:"unknown"},description:""},usage:{required:!1,tsType:{name:"AdditionalInfoPieceUsage"},description:""},textHighlighterColor:{required:!1,tsType:{name:"Exclude",elements:[{name:"HighlightVariant"},{name:"HighlightVariant.Gray"}],raw:"Exclude<HighlightVariant, HighlightVariant.Gray>"},description:""},borderShadowColor:{required:!1,tsType:{name:"HighlightVariant"},description:""},isFontMuted:{required:!1,tsType:{name:"boolean"},description:""}}};function jr(i){const e=se(),t=bt();return u.useMemo(()=>t?i===L?t.beforeLevel:t.afterLevel:e,[i,e,t])}var P=(i=>(i.Default="default",i.DdlApiProperty="ddlapi-property",i.JsonSchemaValidation="json-schema-validation",i))(P||{});const Fr={[P.DdlApiProperty]:Di,[P.JsonSchemaValidation]:ri},Rr={[P.DdlApiProperty]:"ddlapi-property-row-body",[P.Default]:"additional-info-row-body",[P.JsonSchemaValidation]:"json-schema-property-row-body"},Pr={[P.DdlApiProperty]:"min-h-[26px]"};function Or(i,e={}){return{xPaddingClass:e.xPaddingClass??Fr[i]??bi,bodyClass:e.bodyClass??Rr[i]??"additional-info-row-body",minHeightClass:e.minHeightClass??Pr[i]??"",stretchLevelIndicator:i===P.DdlApiProperty}}const _e=u.memo(i=>{var T;const{label:e,subheader:t,layoutSide:n,diff:r,colorizingDiff:a,hideLevelIndicatorWhenSideEmpty:s=!1,usage:l=P.Default,xPaddingClass:d,bodyClass:f,minHeightClass:g}=i,{[W]:c,[F]:p}=i,b=jr(n),h=u.useMemo(()=>Or(l,{xPaddingClass:d,bodyClass:f,minHeightClass:g}),[l,d,f,g]),D=n===L?r==null?void 0:r.styles.before:r==null?void 0:r.styles.after,A=(T=(n===L?a==null?void 0:a.styles.before:a==null?void 0:a.styles.after)??D)==null?void 0:T.backgroundColor,y=u.useMemo(()=>A?[O.background(A)]:[],[A]),m=u.useMemo(()=>{const v=a==null?void 0:a.data;if(v){if(U(v))return n!==L;if(G(v))return n===L}return(D==null?void 0:D.isContentVisible)??!0},[a,D==null?void 0:D.isContentVisible,n]),M=l===P.JsonSchemaValidation&&b===0,q=b>0&&(!s||m);return o.jsxs("div",{"data-testid":"additional-info-row-content","data-precededby":c,"data-ddl-list-last-row":p?!0:void 0,className:["additional-info-row-content flex w-full items-stretch h-full gap-2",h.xPaddingClass,h.minHeightClass,h.stretchLevelIndicator?"items-stretch":"",y.join(" ")].filter(Boolean).join(" "),children:[M&&o.jsx(vi,{}),q&&o.jsxs("div",{"data-precededby":c,className:"level-indicator-column flex items-stretch self-stretch",children:[o.jsx(ye,{level:b}),o.jsx("div",{className:"w-4","aria-hidden":"true"})]}),m&&o.jsxs("div",{className:`${h.bodyClass} flex min-w-0 flex-1 items-center gap-2`,children:[o.jsx("span",{className:"additional-info-row-label",children:`${e}:`}),t==null?void 0:t(n)]})]})});_e.__docgenInfo={description:"",methods:[],displayName:"AdditionalInfoRowContent",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},"data-ddl-list-last-row":{required:!1,tsType:{name:"boolean"},description:""},xPaddingClass:{required:!1,tsType:{name:"string"},description:""},bodyClass:{required:!1,tsType:{name:"string"},description:""},minHeightClass:{required:!1,tsType:{name:"string"},description:""},label:{required:!0,tsType:{name:"string"},description:""},subheader:{required:!1,tsType:{name:"signature",type:"function",raw:"(layoutSide: LayoutSide) => ReactElement",signature:{arguments:[{type:{name:"union",raw:`| typeof ORIGIN_LAYOUT_SIDE
...
| typeof CHANGED_LAYOUT_SIDE`,elements:[{name:"ORIGIN_LAYOUT_SIDE"},{name:"CHANGED_LAYOUT_SIDE"}]},name:"layoutSide"}],return:{name:"ReactElement"}}},description:""},diff:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  type: DiffType
  causedAt: JsonPath
}`,signature:{properties:[{key:"type",value:{name:"DiffType",required:!0}},{key:"causedAt",value:{name:"JsonPath",required:!0}}]}}],raw:"Record<NodeDiffsSeverityPlacemennt, NodeDiffsSeverity>"}],raw:"Partial<Record<NodeDiffsSeverityPlacemennt, NodeDiffsSeverity>>"},description:""},hideLevelIndicatorWhenSideEmpty:{required:!1,tsType:{name:"boolean"},description:""},usage:{required:!1,tsType:{name:"AdditionalInfoRowUsage"},description:""}}};function ge(i,e){return i?(e===L?i.styles.before:i.styles.after).textHighlighterColor:void 0}function Lt(i){const e=`${i.tableName}.${i.columnName}`;return!i.schemaName||i.schemaName===Tr?e:`${i.schemaName}.${e}`}function Gr(i){return i.join(", ")}const si=u.memo(i=>{const{target:e,hideBadge:t=!1,textHighlighterColor:n}=i,{navigationLinkBuilder:r,navigationLinkComponent:a}=Hr(),s=u.useMemo(()=>r(e.schemaName,e.tableName,e.columnName),[r,e]),l=u.useMemo(()=>["ddlapi-foreign-key-link",O.highlighter(n)].filter(Boolean).join(" "),[n]),d=o.jsx(a,{href:s,className:l,children:Lt(e)});return t?d:o.jsxs("div",{className:"ddlapi-foreign-key inline-flex flex-row items-center gap-1",children:[o.jsx(en,{text:"FK",colorSchema:St,inline:!0}),d]})});si.__docgenInfo={description:"",methods:[],displayName:"ForeignKey",props:{target:{required:!0,tsType:{name:"DdlApiForeignKeyTarget"},description:""},hideBadge:{required:!1,tsType:{name:"boolean"},description:"When true, only the navigation link is rendered (FK badge supplied by the caller)."},textHighlighterColor:{required:!1,tsType:{name:"Exclude",elements:[{name:"HighlightVariant"},{name:"HighlightVariant.Gray"}],raw:"Exclude<HighlightVariant, HighlightVariant.Gray>"},description:""}}};function Kr(){return o.jsx("span",{className:"inline-block min-h-[19px]","aria-hidden":"true"})}function It(i,e){return!!i||!!e}function ki(i,e){return i?e===L?i.styles.before.isContentVisible:i.styles.after.isContentVisible:!0}function Ur(i,e,t){return It(i,e)&&ki(e,t)}function Ce(i){const{columnId:e,label:t,colorSchema:n,flagValue:r,flagDiff:a,layoutMode:s,layoutSide:l}=i;if(!It(r,a))return null;if(!ki(a,l))return Kr();const d=rr(a)?a==null?void 0:a.data:void 0;return o.jsx(Xi,{label:t,colorSchema:n,layoutMode:s,layoutSide:l,isNodeChanged:!1,isContentChanged:!!d,$changes:d},Wr(e,t))}function Br(i){const{columnId:e,target:t,targetDiff:n,layoutMode:r,layoutSide:a}=i,s=Yr(e,t),l=ge(n,a);if(n&&!ki(n,a))return o.jsx("span",{className:"inline-block min-h-[19px]","aria-hidden":"true"},s);if(!n)return o.jsx(si,{target:t},s);const d=n.data;return o.jsxs("div",{className:"ddlapi-foreign-key inline-flex flex-row items-center gap-1",children:[o.jsx(Xi,{label:"FK",colorSchema:St,layoutMode:r,layoutSide:a,isNodeChanged:!1,isContentChanged:!0,$changes:d}),o.jsx(si,{target:t,hideBadge:!0,textHighlighterColor:l})]},s)}const Ve=u.memo(i=>{const{columnId:e,value:t,flagDiffs:n,foreignKeyTargetDiffs:r,layoutSide:a}=i,s=je(),l=u.useMemo(()=>n??{},[n]),d=u.useMemo(()=>r??{},[r]),f=u.useMemo(()=>Ce({columnId:e,label:"PK",colorSchema:Cr,flagValue:t.isPrimaryKey,flagDiff:l.isPrimaryKey,layoutMode:s,layoutSide:a}),[e,l.isPrimaryKey,s,a,t.isPrimaryKey]),g=u.useMemo(()=>Ur(t.isPrimaryKey,l.isPrimaryKey,a),[l.isPrimaryKey,a,t.isPrimaryKey]),c=u.useMemo(()=>Ce({columnId:e,label:"unique",colorSchema:Sr,flagValue:t.isUnique,flagDiff:l.isUnique,layoutMode:s,layoutSide:a}),[e,l.isUnique,s,a,t.isUnique]),p=u.useMemo(()=>g?null:Ce({columnId:e,label:"not null",colorSchema:Ar,flagValue:t.isNotNull,flagDiff:l.isNotNull,layoutMode:s,layoutSide:a}),[e,l.isNotNull,g,s,a,t.isNotNull]),b=u.useMemo(()=>Ce({columnId:e,label:"generated",colorSchema:qr,flagValue:t.isGenerated,flagDiff:l.isGenerated,layoutMode:s,layoutSide:a}),[e,l.isGenerated,s,a,t.isGenerated]),h=u.useMemo(()=>{const S=t.foreignKeyTargets??[];return S.length===0?[]:S.map(A=>Br({columnId:e,target:A,targetDiff:d[Ln(A)],layoutMode:s,layoutSide:a}))},[e,s,a,d,t.foreignKeyTargets]),D=u.useMemo(()=>[f,c,p,b,...h].filter(Boolean),[h,b,p,f,c]);return D.length===0?null:o.jsx("div",{className:"flex flex-wrap items-center gap-2",children:D})});function Wr(i,e){return`${i}-${e}`}function Yr(i,e){return`${i}-FK-${Lt(e)}`}Ve.__docgenInfo={description:"",methods:[],displayName:"ColumnRowBadgesContent",props:{columnId:{required:!0,tsType:{name:"string"},description:""},value:{required:!0,tsType:{name:"signature",type:"object",raw:`{
...
| {
  ...
  readonly kind: typeof SideListDisplayKinds.PARTIAL_DIFFS
  readonly segments: readonly ListSideSegment[]
}`,signature:{properties:[{key:"kind",value:{name:"SideListDisplayKinds.PARTIAL_DIFFS",required:!0}},{key:"segments",value:{name:"unknown",required:!0}}]}}]},description:""}}};function oa(i){const e=i.findIndex(t=>t.text.startsWith("(")||t.text.startsWith(" ("));return e===-1?{typeNameSegments:i,parameterSegments:[]}:{typeNameSegments:i.slice(0,e),parameterSegments:i.slice(e)}}function sa(i,e,t){return i.diff?o.jsx(Ci,{isVisible:!0,value:i.text,appearance:ie.Text,textHighlighterColor:ge(i.diff,t)},`${i.text}-${e}`):o.jsx(we,{isVisible:!0,value:i.text,appearance:ie.Text},`${i.text}-${e}`)}const jt=u.memo(i=>{const{node:e,layoutSide:t}=i,n=Rn(e,t);if(n.kind===B.NO_DIFFS||n.kind===B.WHOLE_DIFFS)return o.jsx(Me,{layoutSide:t,display:n});const{typeNameSegments:r,parameterSegments:a}=oa(n.segments);return o.jsxs("span",{className:"inline-flex items-center gap-1",children:[r.map((s,l)=>sa(s,l,t)),a.length>0&&o.jsx(Me,{layoutSide:t,display:{kind:B.PARTIAL_DIFFS,segments:a}})]})});jt.__docgenInfo={description:"",methods:[],displayName:"ColumnTypeLabelWithDiffs",props:{node:{required:!0,tsType:{name:"ITreeNodeWithDiffs",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.COLUMN"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  readonly _fragment: unknown
}`,signature:{properties:[{key:"_fragment",value:{name:"unknown",required:!0}}]}}],raw:`Partial<{
  readonly _fragment: unknown
...
| typeof CHANGED_LAYOUT_SIDE`,elements:[{name:"ORIGIN_LAYOUT_SIDE"},{name:"CHANGED_LAYOUT_SIDE"}]},description:""}}};const Ft=i=>{const{node:e,additionalInfoPrecededBy:t=R.DDL_COLUMN_ROW,isLastInList:n=!1,hideLevelIndicatorWhenSideEmpty:r=!1,[W]:a}=i,s=ce(),l=e.value(),d=u.useMemo(()=>Nt(e),[e]),f=u.useMemo(()=>Ct(e),[e]),g=u.useMemo(()=>Jr(e),[e]),c=u.useMemo(()=>Xr(e),[e]),p=u.useMemo(()=>ct(e),[e]),b=u.useMemo(()=>ni(e),[e]),h=u.useMemo(()=>mi(e),[e]),D=u.useMemo(()=>ir(e),[e]),S=u.useMemo(()=>yi(e),[e]),A=u.useMemo(()=>ht(e),[e]),y=u.useMemo(()=>Zr(e,s),[e,s]),m=u.useMemo(()=>ea(n,y),[n,y]),M=u.useCallback(V=>l?ft(d,V)?o.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[o.jsx(jt,{node:e,layoutSide:V}),o.jsx(Ve,{columnId:e.id,layoutSide:V,value:l,flagDiffs:g,foreignKeyTargetDiffs:c})]}):o.jsx(o.Fragment,{}):o.jsx(o.Fragment,{}),[g,c,e,d,l]),q=u.useCallback(V=>{const w=tr(e,V);return w===void 0?o.jsx(o.Fragment,{}):o.jsx(ae,{isVisible:!0,value:w,textHighlighterColor:ge(S,V),borderShadowColor:Ki(S,V)})},[S,e]),T=u.useCallback(V=>{const w=ia(e,V);return w===void 0?o.jsx(o.Fragment,{}):o.jsx(ae,{isVisible:!0,value:w,textHighlighterColor:ge(b,V)})},[b,e]),v=u.useCallback(V=>{const w=nr(e,V);return w.length===0?o.jsx(o.Fragment,{}):o.jsx("div",{className:"flex flex-wrap items-center gap-2",children:w.map((N,x)=>o.jsx(ae,{isVisible:!0,value:N.literal,textHighlighterColor:ge(N.diff,V),borderShadowColor:Ki(N.diff,V),isFontMuted:$r(N.diff,V)},`${N.literal}-${x}`))})},[e]);return l?o.jsxs("div",{"data-testid":"ddl-column-node-viewer",className:"flex flex-col ddlapi-property",children:[o.jsx(te,{"data-precededby":a,[F]:m.isTitleListLastRow||void 0,value:l.columnName,expandable:!1,expanded:!0,variant:H.body2,subheader:M,usage:E.DdlApiProperty,hideLevelIndicatorWhenSideEmpty:r,...f}),y.showDescription&&o.jsx(De,{"data-precededby":R.DDL_COLUMN_ROW,[F]:m.isDescriptionListLastRow||void 0,value:l.description??"",variant:H.body2,textFontWeight:"normal",textColor:Ue,usage:ee.DdlApiProperty,diff:p,diffsSeverities:e.diffsSeverities,hideLevelIndicatorWhenSideEmpty:r}),y.showEnumValuesRow&&o.jsx(oe,{usage:P.DdlApiProperty,"data-precededby":t,[F]:m.isEnumAdditionalInfoListLastRow||void 0,label:Tt,subheader:v,colorizingDiff:D,diffsSeverities:h||D?e.diffsSeverities:void 0,hideLevelIndicatorWhenSideEmpty:r}),y.showDefaultRow&&o.jsx(oe,{usage:P.DdlApiProperty,"data-precededby":Bi(y,"default")?R.DDL_COLUMN_AFTER_ADDITIONAL_INFO_ROW:t,[F]:m.isDefaultAdditionalInfoListLastRow||void 0,label:At,subheader:q,colorizingDiff:A,diffsSeverities:S||A?e.diffsSeverities:void 0,hideLevelIndicatorWhenSideEmpty:r}),y.showGeneratedRow&&o.jsx(oe,{usage:P.DdlApiProperty,"data-precededby":Bi(y,"generated")?R.DDL_COLUMN_AFTER_ADDITIONAL_INFO_ROW:t,[F]:m.isGeneratedAdditionalInfoListLastRow||void 0,label:qt,subheader:T,diff:b,colorizingDiff:e.diffs[z],diffsSeverities:e.diffsSeverities,hideLevelIndicatorWhenSideEmpty:r})]}):null};Ft.__docgenInfo={description:"",methods:[],displayName:"ColumnNodeViewerWithDiffs",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},node:{required:!0,tsType:{name:"ITreeNodeWithDiffs",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.COLUMN"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  readonly _fragment: unknown
}`,signature:{properties:[{key:"_fragment",value:{name:"unknown",required:!0}}]}}],raw:`Partial<{
  readonly _fragment: unknown
}>`},{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]}],raw:`ITreeNodeWithDiffs<
...
| DdlApiTreeNodeWithDiffs<typeof DdlApiTreeNodeKinds.COLUMNS>`,elements:[{name:"ITreeNode",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.COLUMNS"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  ...
  DdlApiTreeNodeMeta,
  DdlApiTreeNodeValue<K> | null
>`}]},description:""}}};let Pt=class{resolveNodeVisibility(e,t){const n=e.value();return{showDescription:this.resolveDescriptionRowVisible(n,t),showSubheader:this.resolveSubheaderVisible(n)}}resolveListLastRowFlags(e,t){return this.resolveListLastRowFlagsFromVisibility(e,t)}resolveListLastRowFlagsFromVisibility(e,t){const{showDescription:n}=t;return{isTitleListLastRow:e&&!n,isDescriptionListLastRow:e&&n}}resolveDescriptionRowVisible(e,t){return X(t)&&!!(e!=null&&e.description)}resolveSubheaderVisible(e){return!!e&&(e.partNames.length>0||e.isUnique)}};const Ot=new Pt;function fa(i,e){return Ot.resolveNodeVisibility(i,e)}function ga(i,e){return Ot.resolveListLastRowFlags(i,e)}const Si=i=>{const{node:e,isLastInList:t=!1,[W]:n}=i,r=ce(),a=e.value(),s=u.useMemo(()=>fa(e,r),[e,r]),l=u.useMemo(()=>ga(t,s),[t,s]),d=(a==null?void 0:a.indexName)??"",f=u.useCallback(c=>{if(!a)return o.jsx(o.Fragment,{});const p=Gr(a.partNames);return o.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[a.partNames.length>0&&o.jsx(we,{isVisible:!0,value:`(${p})`,appearance:ie.Text}),o.jsx(Ve,{columnId:e.id,layoutSide:c,value:a})]})},[e.id,a]),g=s.showDescription;return a?o.jsxs("div",{"data-testid":"ddl-index-node-viewer",className:"flex flex-col ddlapi-property",children:[o.jsx(te,{"data-precededby":n,[F]:l.isTitleListLastRow||void 0,value:d,expandable:!1,expanded:!0,variant:H.body2,subheader:s.showSubheader?f:void 0,usage:E.DdlApiProperty}),g&&o.jsx(De,{"data-precededby":R.DDL_INDEX_ROW,[F]:l.isDescriptionListLastRow||void 0,value:a.description??"",variant:H.body1,textFontWeight:"normal",textColor:Ue,usage:ee.DdlApiProperty})]}):null};Si.__docgenInfo={description:"",methods:[],displayName:"IndexNodeViewer",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},node:{required:!0,tsType:{name:"ITreeNode",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.INDEX"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  readonly _fragment: unknown
}`,signature:{properties:[{key:"_fragment",value:{name:"unknown",required:!0}}]}}],raw:`Partial<{
  readonly _fragment: unknown
}>`}],raw:"ITreeNode<DdlApiTreeNodeValue<K> | null, K, DdlApiTreeNodeMeta>"},description:""},isLastInList:{required:!1,tsType:{name:"boolean"},description:""}}};const ca=new Pt;class pa{resolveNodeVisibility(e,t){var r;const n=e.value();return{showDescription:this.resolveDescriptionRowVisible(n,pt(e),t),showSubheader:this.resolveSubheaderVisible(n,(r=mt(e))==null?void 0:r.isUnique)}}resolveListLastRowFlags(e,t){return ca.resolveListLastRowFlags(e,t)}resolveDescriptionRowVisible(e,t,n){return X(n)&&(!!(e!=null&&e.description)||!!t)}resolveSubheaderVisible(e,t){return!!e&&(e.partNames.length>0||e.isUnique||!!t)}}const Gt=new pa;function ha(i,e){return Gt.resolveNodeVisibility(i,e)}function ma(i,e){return Gt.resolveListLastRowFlags(i,e)}const Kt=i=>{const{node:e,isLastInList:t=!1,hideLevelIndicatorWhenSideEmpty:n=!1,[W]:r}=i,a=ce(),s=e.value(),l=u.useMemo(()=>ha(e,a),[e,a]),d=u.useMemo(()=>ma(t,l),[t,l]),f=u.useMemo(()=>Nt(e),[e]),g=u.useMemo(()=>Ct(e),[e]),c=u.useMemo(()=>zr(e),[e]),p=u.useMemo(()=>pt(e),[e]),b=(s==null?void 0:s.indexName)??"",h=u.useCallback(A=>{const y=Wn(e,A);return o.jsx(Me,{layoutSide:A,display:y})},[e]),D=u.useCallback(A=>{if(!s)return o.jsx(o.Fragment,{});if(!ft(f,A))return o.jsx(o.Fragment,{});const y=s.partNames.length>0;return o.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[y&&h(A),o.jsx(Ve,{columnId:e.id,layoutSide:A,value:s,flagDiffs:c})]})},[c,e.id,f,h,s]),S=l.showDescription;return s?o.jsxs("div",{"data-testid":"ddl-index-node-viewer",className:"flex flex-col ddlapi-property",children:[o.jsx(te,{"data-precededby":r,[F]:d.isTitleListLastRow||void 0,value:b,expandable:!1,expanded:!0,variant:H.body2,subheader:l.showSubheader?D:void 0,usage:E.DdlApiProperty,hideLevelIndicatorWhenSideEmpty:n,...g}),S&&o.jsx(De,{"data-precededby":R.DDL_INDEX_ROW,[F]:d.isDescriptionListLastRow||void 0,value:s.description??"",variant:H.body1,textFontWeight:"normal",textColor:Ue,usage:ee.DdlApiProperty,diff:p,diffsSeverities:e.diffsSeverities,hideLevelIndicatorWhenSideEmpty:n})]}):null};Kt.__docgenInfo={description:"",methods:[],displayName:"IndexNodeViewerWithDiffs",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},node:{required:!0,tsType:{name:"ITreeNodeWithDiffs",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.INDEX"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  readonly _fragment: unknown
}`,signature:{properties:[{key:"_fragment",value:{name:"unknown",required:!0}}]}}],raw:`Partial<{
  readonly _fragment: unknown
}>`},{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]}],raw:`ITreeNodeWithDiffs<
  ...
  DdlApiTreeNodeMeta,
  DdlApiTreeNodeValue<K> | null
>`},description:""},isLastInList:{required:!1,tsType:{name:"boolean"},description:""},hideLevelIndicatorWhenSideEmpty:{required:!1,tsType:{name:"boolean"},description:""}}};function Ut(i){return i.map((e,t)=>({indexNode:e,titlePrecededBy:R.DDL_INDEX_ROW,isLastInList:t===i.length-1}))}const ya=i=>{const{node:e,[W]:t}=i;return wr(e)?o.jsx(Da,{"data-precededby":t,node:e}):o.jsx(ba,{"data-precededby":t,node:e})},ba=i=>{const{node:e,[W]:t}=i,n=se(),r=e.value(),a=Ht(e.childrenNodes()),s=u.useMemo(()=>Ut(a),[a]);return a.length===0?null:o.jsxs("div",{"data-testid":"ddl-indexes-node-viewer",className:"flex flex-col",children:[o.jsx(te,{"data-precededby":t,value:(r==null?void 0:r.title)??"Indexes",expandable:!1,expanded:!0,variant:H.h2,usage:E.DdlApiSection}),o.jsx(Fe.Provider,{value:n+1,children:s.map(({indexNode:l,titlePrecededBy:d,isLastInList:f})=>o.jsx(Si,{"data-precededby":d,isLastInList:f,node:l},l.id))})]})},Da=i=>{const{node:e,[W]:t}=i,n=se(),r=e.value(),a=Ht(e.childrenNodes()),s=u.useMemo(()=>Be(ve(e)),[e]),l=u.useMemo(()=>Ut(a),[a]),d=u.useMemo(()=>gt(e),[e]);return a.length===0?null:o.jsxs("div",{"data-testid":"ddl-indexes-node-viewer",className:"flex flex-col",children:[o.jsx(te,{"data-precededby":t,value:(r==null?void 0:r.title)??"Indexes",expandable:!1,expanded:!0,variant:H.h2,usage:E.DdlApiSection,...s}),o.jsx(Fe.Provider,{value:n+1,children:l.map(({indexNode:f,titlePrecededBy:g,isLastInList:c})=>xt(f)?o.jsx(Kt,{"data-precededby":g,isLastInList:c,hideLevelIndicatorWhenSideEmpty:d,node:f},f.id):o.jsx(Si,{"data-precededby":g,isLastInList:c,node:f},f.id))})]})};ya.__docgenInfo={description:"",methods:[],displayName:"IndexesNodeViewer",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},node:{required:!0,tsType:{name:"union",raw:`| DdlApiTreeNode<typeof DdlApiTreeNodeKinds.INDEXES>
| DdlApiTreeNodeWithDiffs<typeof DdlApiTreeNodeKinds.INDEXES>`,elements:[{name:"ITreeNode",elements:[{name:"union",raw:"DdlApiTreeNodeValue<K> | null",elements:[{name:"unknown"},{name:"null"}]},{name:"DdlApiTreeNodeKinds.INDEXES"},{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  ...
  DdlApiTreeNodeMeta,
  DdlApiTreeNodeValue<K> | null
>`}]},description:""}}};export{Xe as $,W as A,Ma as B,la as C,Tr as D,pe as E,Ea as F,La as G,bn as H,ya as I,ja as J,Ia as K,Zi as L,ge as M,Oe as N,Ge as O,R as P,Ke as Q,Ba as R,le as S,te as T,Ua as U,Xn as V,Ra as W,bi as X,Pa as Y,Ka as Z,tn as _,xr as a,nn as a0,dn as a1,un as a2,an as a3,on as a4,rn as a5,ne as a6,Qi as a7,Na as a8,zi as a9,ae as aA,xi as aB,Ki as aC,$r as aD,Oa as aE,oe as aF,P as aG,jn as aH,Mn as aI,In as aJ,Ca as aa,Ha as ab,ka as ac,Aa as ad,qa as ae,yt as af,ar as ag,pr as ah,bt as ai,ve as aj,Be as ak,E as al,Ta as am,X as an,be as ao,B as ap,ri as aq,jr as ar,Me as as,Ci as at,ie as au,we as av,ee as aw,Di as ax,vi as ay,Qn as az,H as b,De as c,Ue as d,sn as e,Fa as f,Ga as g,Dr as h,vr as i,kr as j,Nr as k,C as l,qn as m,Je as n,Ln as o,Cn as p,at as q,_a as r,it as s,Sa as t,pi as u,Pe as v,I as w,tt as x,nt as y,Dn as z};
