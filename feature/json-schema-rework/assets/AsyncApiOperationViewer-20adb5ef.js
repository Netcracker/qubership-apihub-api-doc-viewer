...
| typeof CHANGED_LAYOUT_SIDE`,elements:[{name:"ORIGIN_LAYOUT_SIDE"},{name:"CHANGED_LAYOUT_SIDE"}]},name:"layoutSide"}],return:{name:"union",raw:"ReactElement | null",elements:[{name:"ReactElement"},{name:"null"}]}}},description:""},diff:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  type: DiffType
  causedAt: JsonPath
}`,signature:{properties:[{key:"type",value:{name:"DiffType",required:!0}},{key:"causedAt",value:{name:"JsonPath",required:!0}}]}}],raw:"Record<NodeDiffsSeverityPlacemennt, NodeDiffsSeverity>"}],raw:"Partial<Record<NodeDiffsSeverityPlacemennt, NodeDiffsSeverity>>"},description:""}}};const kl=m.memo(r=>{const{node:e,[le]:n}=r,t=m.useMemo(()=>e.value(),[e]),i=e.childrenNodes().find(ut),o=yr(e,Ar),{nodeDiffs:l}=o,s=m.useMemo(()=>se(o,{diffKey:"title"}),[o]),u=m.useMemo(()=>se(o,{diffKey:"description",diffsSeverityPlacement:H.DescriptionRow}),[o]),c=m.useMemo(()=>se(o,{diffKey:"summary",diffsSeverityPlacement:H.SummaryRow}),[o]),f=m.useMemo(()=>se(o,{resolveDiff:(w,T)=>{const b=ge.maxChangedPropertyMetaDataByDiffType(T("protocol"),T("host"));return w[R]??b}}),[o]),y=m.useCallback(w=>{var q;if(!t)return null;if(!Ar(e))return d.jsx(d.Fragment,{children:t.protocol});const T=(q=e.diffs)==null?void 0:q.protocol;if(!T)return d.jsx(d.Fragment,{children:t.protocol});const b=new Set,{data:E,styles:C}=T;let A=t.protocol,M=!1;return w===z&&(b.add(ee.highlighter(C.before.textHighlighterColor)),k(E)||O(E)?A=E.beforeValue:ln(E)&&(A=E.beforeKey),x(E)&&(M=!0)),w===te&&(b.add(ee.highlighter(C.after.textHighlighterColor)),x(E)||O(E)?A=E.afterValue:ln(E)&&(A=E.afterKey),k(E)&&(M=!0)),M?null:d.jsx("span",{className:Array.from(b).join(" "),children:A})},[e,t]),p=m.useCallback(w=>{var q;if(!t)return null;if(!Ar(e))return d.jsx(d.Fragment,{children:t.host});const T=(q=e.diffs)==null?void 0:q.host;if(!T)return d.jsx(d.Fragment,{children:t.host});const b=new Set,{data:E,styles:C}=T;let A=t.host,M=!1;return w===z&&(b.add(ee.highlighter(C.before.textHighlighterColor)),k(E)||O(E)?A=E.beforeValue:ln(E)&&(A=E.beforeKey),x(E)&&(M=!0)),w===te&&(b.add(ee.highlighter(C.after.textHighlighterColor)),x(E)||O(E)?A=E.afterValue:ln(E)&&(A=E.afterKey),k(E)&&(M=!0)),M?null:d.jsx("span",{className:Array.from(b).join(" "),children:A})},[e,t]),g=m.useCallback(w=>{var q;function T(J=!1,U=[]){return d.jsx("div",{"data-precededby":V.MESSAGE_SECTION_HEADER_HIGH_LEVEL,className:`${mr} py-2 flex flex-row w-full h-full ${U.join(" ")}`,children:!J&&d.jsxs("div",{className:"server-address-container server-address server-subheader",children:[y(w),"://",p(w)]})})}if(!Ar(e))return T();const b=((q=e.diffs)==null?void 0:q[R])??f.diff;if(!b)return T();const{data:E,styles:C}=b,A=new Set;let M=!1;return w===z&&(x(E)?(A.add(ee.background(N.Gray)),M=!0):A.add(ee.background(C.before.backgroundColor))),w===te&&(k(E)?(A.add(ee.background(N.Gray)),M=!0):A.add(ee.background(C.after.backgroundColor))),T(M,Array.from(A))},[e,p,y,f.diff]),S=m.useMemo(()=>Fe(t,l,"title"),[t,l]),h=m.useMemo(()=>Fe(t,l,"description"),[t,l]),v=m.useMemo(()=>Fe(t,l,"summary"),[t,l]);return t?d.jsxs("div",{className:"flex flex-col",children:[S&&d.jsx(he,{"data-precededby":n,value:t.title,expandable:!1,expanded:!0,variant:B.h4,...s}),!S&&d.jsx(he,{"data-precededby":n,value:e.key.toString(),expandable:!1,expanded:!0,variant:B.h4,...s}),d.jsx(El,{renderAddress:g,...f}),h&&d.jsx(un,{"data-precededby":V.SERVER_ADDRESS_ROW,value:(t==null?void 0:t.description)??"",variant:B.h6,textFontWeight:"normal",textColor:Nn,...u}),v&&d.jsx(un,{"data-precededby":h?V.DESCRIPTION_ROW:V.SERVER_ADDRESS_ROW,value:(t==null?void 0:t.summary)??"",variant:B.h6,textFontWeight:"normal",textColor:Nn,...c}),i&&d.jsx(hr,{"data-precededby":v?V.SUMMARY_ROW:h?V.DESCRIPTION_ROW:V.SERVER_ADDRESS_ROW,node:i,variant:Wr.SECONDARY})]}):null});kl.__docgenInfo={description:"",methods:[],displayName:"MessageChannelServerNodeViewer",props:{"data-precededby":{required:!1,tsType:{name:"PrecededBy"},description:""},node:{required:!0,tsType:{name:"union",raw:`| AsyncApiTreeNode<typeof AsyncApiTreeNodeKinds.SERVER>
