...
export declare class JsonSchemaNestingLevel {
    /**
     ...
     */
    static resolveNextLevelPair(currentBeforeLevel: number, currentAfterLevel: number, colorizingDiff: ChangedPropertyMetaData | undefined): LevelPair;
}
