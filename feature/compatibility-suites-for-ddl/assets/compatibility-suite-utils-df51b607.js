import{j as A}from"./_commonjs-dynamic-modules-6308e768.js";import{k as J,r as de,D as Z,s as ye,S as he,a as ge}from"./DiffBadge-4e6868e6.js";import{g as be,r as B}from"./index-f46741a2.js";import{D as ve}from"./DdlTableDiffsViewer-efacc174.js";import{G as xe}from"./GraphQLOperationDiffViewer-efa1db5a.js";import{b as k}from"./graph-api-transformers-0f74cb65.js";import{T as D}from"./index-8cf80a84.js";import{b as Y}from"./build-from-ddl-browser-3ec9ecee.js";import{r as Ie}from"./ddl-story-realm-utils-c0692776.js";const ee=new Map([["ddlapi/column-type/binary-to-text",{before:`CREATE TABLE t (
    v BYTEA
);
...
xml:
  prefix: "p2"
  namespace: "http://example.com/schema"
`}}]]),ne=new Map([["asyncapi/operation-receive-message-headers",`asyncapi: 3.0.0
info:
        ...
        "200":
          ...
          headers:
            X-Header-1:
              schema:
                __SCHEMA__
`]]),qe=["3.0.0","3.0.0"],V=(e,n)=>{const t=/^openapi:\s*.*$/m;if(!t.test(e))throw new Error(`Invalid OpenAPI sample: missing root "openapi" field. Sample start: ${e.slice(0,100)}...`);return e.replace(t,`openapi: ${n}`)},M="openapi",te="graphql",re="asyncapi",se="ddlapi",oe="/",$=(e,n,t)=>[e,n,t].join(oe),pe=(e,n)=>[e,n].join(oe),Oe=["parameters-schema","request-body-schema","response-body-schema","response-headers-schema"],Pe=["operation-receive-message-headers","operation-send-message-headers","operation-receive-message-payload","operation-send-message-payload","operation-reply-receive-message-headers","operation-reply-send-message-headers","operation-reply-receive-message-payload","operation-reply-send-message-payload"],je={[M]:Oe,[te]:[],[re]:Pe,[se]:[]},Ee=(e,n)=>je[e].includes(n),L="__SCHEMA__",G=e=>e.replace(/\r\n/g,`
`),Ae=(e,n)=>{const t=G(e).trimEnd();return t?n?n+t.replace(/\n(?=.)/g,`
${n}`):t:""},Te=(e,n)=>{var I;const t=G(e),r=t.split(`
`),s=r.map((d,S)=>d.trim()===L?S:-1).filter(d=>d!==-1);if(s.length===0)throw new Error(`Template placeholder '${L}' not found. Template start: ${t.slice(0,120)}...`);if(s.length>1)throw new Error(`Template placeholder '${L}' must appear only once. Found ${s.length} occurrences. Template start: ${t.slice(0,120)}...`);const i=s[0],c=((I=r[i].match(/^\s*/))==null?void 0:I[0])??"",u=Ae(n,c);return u?(r.splice(i,1,...u.split(`
`)),r.join(`
`)):(r.splice(i,1),r.join(`
`))},Ke=(e,n)=>{const t=Te(e,n.schema);return`${G(t).trimEnd()}
`},ae=(e,n)=>Ee(e,n)?ne.has(pe(e,n)):!1,W=(e,n,t,r)=>{const s=pe(e,n),i=ne.get(s);if(!i)throw new Error(`Schema suite template not found: ${s}`);const c=N.get(t);if(!c)throw new Error(`JSON schema case not found: ${t}`);const u=c[r];return Ke(i,u)},Fe=["3.0.0","3.0.0"],H=["unversioned","unversioned"],we=(e,n,t)=>ae(e,n)&&N.has(t),Re=(e,n,t)=>{const r=$(e,n,t),s=ee.get(r);if(s)return[s.before,s.after];if(!ae(e,n))throw new Error(`Unknown compatibility suite case: (${e}, ${n}, ${t})`);if(!N.has(t))throw new Error(`Unknown JSON schema case '${t}' for schema suite (${e}, ${n})`);const i=W(e,n,t,"before"),c=W(e,n,t,"after");return[i,c]},Be={[M]:{defaultPair:qe,patchSamples:(e,n,t)=>[V(e,t[0]),V(n,t[1])]},[te]:{defaultPair:H},[re]:{defaultPair:Fe},[se]:{defaultPair:H}},ie=e=>{const n=Be[e];if(!n)throw new Error(`Unknown suiteType for VersionPairPolicy lookup: ${e}`);return n},me=(e,n)=>{var t;if(e===M)return(t=Se.get(n))==null?void 0:t.versionPairs},Le=(e,n,t)=>{const r=$(e,n,t);if(!ee.has(r)&&!we(e,n,t))throw new Error(`Unknown compatibility suite case: (${e}, ${n}, ${t})`);const s=ie(e);return me(e,r)??[s.defaultPair]},ce=(e,n,t,r)=>{const s=Re(e,n,t);if(r===void 0)return s;const i=ie(e),[c,u]=r;if(!Le(e,n,t).some(K=>K[0]===c&&K[1]===u))throw new Error(`Unsupported specificationVersionPair [${c}, ${u}] for case (${e}, ${n}, ${t})`);if(!i.patchSamples)return s;const S=$(e,n,t);return me(e,S)?i.patchSamples(s[0],s[1],r):s};var ue={exports:{}};(function(e){(function(){function n(o,a){document.addEventListener?o.addEventListener("scroll",a,!1):o.attachEvent("scroll",a)}function t(o){document.body?o():document.addEventListener?document.addEventListener("DOMContentLoaded",function a(){document.removeEventListener("DOMContentLoaded",a),o()}):document.attachEvent("onreadystatechange",function a(){(document.readyState=="interactive"||document.readyState=="complete")&&(document.detachEvent("onreadystatechange",a),o())})}function r(o){this.g=document.createElement("div"),this.g.setAttribute("aria-hidden","true"),this.g.appendChild(document.createTextNode(o)),this.h=document.createElement("span"),this.i=document.createElement("span"),this.m=document.createElement("span"),this.j=document.createElement("span"),this.l=-1,this.h.style.cssText="max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;",this.i.style.cssText="max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;",this.j.style.cssText="max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;",this.m.style.cssText="display:inline-block;width:200%;height:200%;font-size:16px;max-width:none;",this.h.appendChild(this.m),this.i.appendChild(this.j),this.g.appendChild(this.h),this.g.appendChild(this.i)}function s(o,a){o.g.style.cssText="max-width:none;min-width:20px;min-height:20px;display:inline-block;overflow:hidden;position:absolute;width:auto;margin:0;padding:0;top:-999px;white-space:nowrap;font-synthesis:none;font:"+a+";"}function i(o){var a=o.g.offsetWidth,p=a+100;return o.j.style.width=p+"px",o.i.scrollLeft=p,o.h.scrollLeft=o.h.scrollWidth+100,o.l!==a?(o.l=a,!0):!1}function c(o,a){function p(){var l=v;i(l)&&l.g.parentNode!==null&&a(l.l)}var v=o;n(o.h,p),n(o.i,p),i(o)}function u(o,a,p){a=a||{},p=p||window,this.family=o,this.style=a.style||"normal",this.weight=a.weight||"normal",this.stretch=a.stretch||"normal",this.context=p}var I=null,d=null,S=null,T=null;function K(o){return d===null&&(Q(o)&&/Apple/.test(window.navigator.vendor)?(o=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))(?:\.([0-9]+))/.exec(window.navigator.userAgent),d=!!o&&603>parseInt(o[1],10)):d=!1),d}function Q(o){return T===null&&(T=!!o.document.fonts),T}function q(o,a){var p=o.style,v=o.weight;if(S===null){var l=document.createElement("div");try{l.style.font="condensed 100px sans-serif"}catch{}S=l.style.font!==""}return[p,v,S?o.stretch:"","100px",a].join(" ")}u.prototype.load=function(o,a){var p=this,v=o||"BESbswy",l=0,O=a||3e3,_=new Date().getTime();return new Promise(function(X,U){if(Q(p.context)&&!K(p.context)){var le=new Promise(function(P,j){function y(){new Date().getTime()-_>=O?j(Error(""+O+"ms timeout exceeded")):p.context.document.fonts.load(q(p,'"'+p.family+'"'),v).then(function(x){1<=x.length?P():setTimeout(y,25)},j)}y()}),fe=new Promise(function(P,j){l=setTimeout(function(){j(Error(""+O+"ms timeout exceeded"))},O)});Promise.race([fe,le]).then(function(){clearTimeout(l),X(p)},U)}else t(function(){function P(){var m;(m=h!=-1&&g!=-1||h!=-1&&b!=-1||g!=-1&&b!=-1)&&((m=h!=g&&h!=b&&g!=b)||(I===null&&(m=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),I=!!m&&(536>parseInt(m[1],10)||parseInt(m[1],10)===536&&11>=parseInt(m[2],10))),m=I&&(h==F&&g==F&&b==F||h==w&&g==w&&b==w||h==R&&g==R&&b==R)),m=!m),m&&(f.parentNode!==null&&f.parentNode.removeChild(f),clearTimeout(l),X(p))}function j(){if(new Date().getTime()-_>=O)f.parentNode!==null&&f.parentNode.removeChild(f),U(Error(""+O+"ms timeout exceeded"));else{var m=p.context.document.hidden;(m===!0||m===void 0)&&(h=y.g.offsetWidth,g=x.g.offsetWidth,b=E.g.offsetWidth,P()),l=setTimeout(j,50)}}var y=new r(v),x=new r(v),E=new r(v),h=-1,g=-1,b=-1,F=-1,w=-1,R=-1,f=document.createElement("div");f.dir="ltr",s(y,q(p,"sans-serif")),s(x,q(p,"serif")),s(E,q(p,"monospace")),f.appendChild(y.g),f.appendChild(x.g),f.appendChild(E.g),p.context.document.body.appendChild(f),F=y.g.offsetWidth,w=x.g.offsetWidth,R=E.g.offsetWidth,j(),c(y,function(m){h=m,P()}),s(y,q(p,'"'+p.family+'",sans-serif')),c(x,function(m){g=m,P()}),s(x,q(p,'"'+p.family+'",serif')),c(E,function(m){b=m,P()}),s(E,q(p,'"'+p.family+'",monospace'))})})},e.exports=u})()})(ue);var Ce=ue.exports;const De=be(Ce),Ne={schemaName:"public",name:"t"};async function Me(e,n){const[t,r]=await Promise.all([Y(e),Y(n)]),{before:s,after:i}=Ie(t,r),{merged:c}=J(s,i,{unify:!0,validate:!0,metaKey:D.diffsMetaKey,normalizedResult:!1});return c}function $e(e){const n=z(e,D.diffsMetaKey);return n||(z(e)??Ne)}function z(e,n){for(const t of e.schemas??[])for(const r of t.tables??[])if(!(n!==void 0&&!C(r,n)))return{schemaName:t.name,name:r.name}}function C(e,n,t=new Set){return e===null||typeof e!="object"||t.has(e)?!1:(t.add(e),e[n]!==void 0?!0:Array.isArray(e)?e.some(r=>C(r,n,t)):Object.values(e).some(r=>C(r,n,t)))}const Ge=Symbol("synthetic-title"),Qe={validate:!0,liftCombiners:!0,syntheticTitleFlag:Ge,unify:!0,allowNotValidSyntheticChanges:!0},_e=(e,n)=>{const s=J(e,n,{...Qe,beforeSource:e,afterSource:n,mode:de,metaKey:Z});return Xe(s.merged)&&(s.merged.toJSON=()=>ye(s.merged)),s};function Xe(e){return e!=null&&typeof e=="object"}const Ue=["Inter"];function ke(){const[e,n]=B.useState(!1),t=Ue.map(r=>new De(r).load(null,1e4));return Promise.all(t).then(()=>{n(!0)}),e}const Ye={diffsMetaKey:Z,aggregatedDiffsMetaKey:ge};function Ve({before:e,after:n}){const{merged:t}=_e(k(e),k(n));return ke()?A.jsx(xe,{layoutMode:he,metaKeys:Ye,source:t}):A.jsx(A.Fragment,{})}function pn(e,n,t){const[r,s]=ce(e,n,t);return{before:r,after:s}}const We=(e,n,t)=>`#${e}.${n}.${t}`;function He({before:e,after:n}){const[t,r]=B.useState(void 0),[s,i]=B.useState(void 0);return B.useEffect(()=>{let c=!1;return r(void 0),i(void 0),Me(e,n).then(u=>{c||(r(u),i($e(u)))}).catch(u=>{c||console.error(u)}),()=>{c=!0}},[e,n]),!t||!s?A.jsx(A.Fragment,{}):A.jsx(ve,{mergedSource:t,tableKey:s,navigationLinkBuilder:We,diffMetaKeys:D,devMode:!0})}function an(e,n,t){const[r,s]=ce(e,n,t);return{before:r,after:s}}Ve.__docgenInfo={description:"",methods:[],displayName:"GraphQLStoryComponent",props:{before:{required:!0,tsType:{name:"string"},description:""},after:{required:!0,tsType:{name:"string"},description:""}}};He.__docgenInfo={description:"",methods:[],displayName:"DdlStoryComponent",props:{before:{required:!0,tsType:{name:"string"},description:""},after:{required:!0,tsType:{name:"string"},description:""}}};export{He as D,Ve as G,se as T,pn as a,te as b,an as g};
