import{j as A}from"./_commonjs-dynamic-modules-6308e768.js";import{k as z,r as fe,D as J,s as de,S as ye,a as he}from"./DiffBadge-4e6868e6.js";import{g as ge,r as B}from"./index-f46741a2.js";import{D as be}from"./DdlTableDiffsViewer-efacc174.js";import{G as ve}from"./GraphQLOperationDiffViewer-efa1db5a.js";import{b as k}from"./graph-api-transformers-0f74cb65.js";import{T as D}from"./index-8cf80a84.js";import{b as Y}from"./build-from-ddl-browser-b2c42d62.js";import{r as xe}from"./ddl-story-realm-utils-c0692776.js";const Z=new Map([["ddlapi/column-type/binary-to-text",{before:`CREATE TABLE t (
    v BYTEA
);
`,after:`CREATE TABLE t (
    v TEXT
);
`}],["ddlapi/column-type/bool-to-int",{before:`CREATE TABLE t (
    v BOOLEAN
);
`,after:`CREATE TABLE t (
    v INTEGER
);
`}],["ddlapi/column-type/date-to-timestamp",{before:`CREATE TABLE t (
    v DATE
);
`,after:`CREATE TABLE t (
    v TIMESTAMP
);
`}],["ddlapi/column-type/decrease-decimal-precision",{before:`CREATE TABLE t (
    v NUMERIC(15, 2)
);
`,after:`CREATE TABLE t (
    v NUMERIC(10, 2)
);
`}],["ddlapi/column-type/decrease-decimal-scale",{before:`CREATE TABLE t (
    v NUMERIC(10, 4)
);
`,after:`CREATE TABLE t (
    v NUMERIC(10, 2)
);
`}],["ddlapi/column-type/decrease-varchar-size",{before:`CREATE TABLE t (
    v VARCHAR(200)
);
`,after:`CREATE TABLE t (
    v VARCHAR(100)
);
`}],["ddlapi/column-type/enum-to-text",{before:`CREATE TYPE status AS ENUM ('NEW', 'DONE');
...
`}],["ddlapi/column-type/float-to-decimal",{before:`CREATE TABLE t (
    v REAL
);
`,after:`CREATE TABLE t (
    v NUMERIC(10, 2)
);
`}],["ddlapi/column-type/increase-decimal-precision",{before:`CREATE TABLE t (
    v NUMERIC(10, 2)
);
`,after:`CREATE TABLE t (
    v NUMERIC(15, 2)
);
`}],["ddlapi/column-type/increase-decimal-scale",{before:`CREATE TABLE t (
    v NUMERIC(10, 2)
);
`,after:`CREATE TABLE t (
    v NUMERIC(10, 4)
);
`}],["ddlapi/column-type/increase-varchar-size",{before:`CREATE TABLE t (
    v VARCHAR(100)
);
`,after:`CREATE TABLE t (
    v VARCHAR(200)
);
`}],["ddlapi/column-type/int-to-bool",{before:`CREATE TABLE t (
    v INTEGER
);
`,after:`CREATE TABLE t (
    v BOOLEAN
);
`}],["ddlapi/column-type/integer-to-varchar",{before:`CREATE TABLE t (
    v INTEGER
);
`,after:`CREATE TABLE t (
    v VARCHAR(20)
);
`}],["ddlapi/column-type/json-to-jsonb",{before:`CREATE TABLE t (
    v JSON
);
`,after:`CREATE TABLE t (
    v JSONB
);
`}],["ddlapi/column-type/json-to-text",{before:`CREATE TABLE t (
    v JSON
);
`,after:`CREATE TABLE t (
    v TEXT
);
`}],["ddlapi/column-type/jsonb-to-json",{before:`CREATE TABLE t (
    v JSONB
);
`,after:`CREATE TABLE t (
    v JSON
);
`}],["ddlapi/column-type/narrow-bigint-to-smallint",{before:`CREATE TABLE t (
    v BIGINT
);
`,after:`CREATE TABLE t (
    v SMALLINT
);
`}],["ddlapi/column-type/narrow-cross-family-to-text",{before:`CREATE TABLE t (
    v INTEGER
);
`,after:`CREATE TABLE t (
    v TEXT
);
`}],["ddlapi/column-type/narrow-double-to-real",{before:`CREATE TABLE t (
    v DOUBLE PRECISION
);
`,after:`CREATE TABLE t (
    v REAL
);
`}],["ddlapi/column-type/numeric-to-float",{before:`CREATE TABLE t (
    v NUMERIC(10, 2)
);
`,after:`CREATE TABLE t (
    v REAL
);
`}],["ddlapi/column-type/numeric-to-integer",{before:`CREATE TABLE t (
    v NUMERIC(10, 2)
);
`,after:`CREATE TABLE t (
    v INTEGER
);
`}],["ddlapi/column-type/text-to-binary",{before:`CREATE TABLE t (
    v TEXT
);
`,after:`CREATE TABLE t (
    v BYTEA
);
`}],["ddlapi/column-type/text-to-enum",{before:`CREATE TABLE t (
    v TEXT
);
`,after:`CREATE TYPE status AS ENUM ('NEW', 'DONE');

CREATE TABLE t (
    v status
);
`}],["ddlapi/column-type/text-to-json",{before:`CREATE TABLE t (
    v TEXT
);
`,after:`CREATE TABLE t (
    v JSON
);
`}],["ddlapi/column-type/text-to-uuid",{before:`CREATE TABLE t (
    v TEXT
);
`,after:`CREATE TABLE t (
    v UUID
);
`}],["ddlapi/column-type/text-to-varchar-limited",{before:`CREATE TABLE t (
    v TEXT
);
`,after:`CREATE TABLE t (
    v VARCHAR(100)
);
`}],["ddlapi/column-type/text-to-varchar-unlimited",{before:`CREATE TABLE t (
    v TEXT
);
`,after:`CREATE TABLE t (
    v VARCHAR
);
`}],["ddlapi/column-type/timestamp-to-date",{before:`CREATE TABLE t (
    v TIMESTAMP
);
`,after:`CREATE TABLE t (
    v DATE
);
`}],["ddlapi/column-type/uuid-to-text",{before:`CREATE TABLE t (
    v UUID
);
`,after:`CREATE TABLE t (
    v TEXT
);
`}],["ddlapi/column-type/varchar-to-integer",{before:`CREATE TABLE t (
    v VARCHAR(20)
);
`,after:`CREATE TABLE t (
    v INTEGER
);
`}],["ddlapi/column-type/varchar-to-text",{before:`CREATE TABLE t (
    v VARCHAR(100)
);
`,after:`CREATE TABLE t (
    v TEXT
);
`}],["ddlapi/column-type/widen-bigint-to-numeric",{before:`CREATE TABLE t (
    v BIGINT
);
`,after:`CREATE TABLE t (
    v NUMERIC
);
`}],["ddlapi/column-type/widen-float-to-double",{before:`CREATE TABLE t (
    v REAL
);
`,after:`CREATE TABLE t (
    v DOUBLE PRECISION
);
`}],["ddlapi/column-type/widen-integer-to-bigint",{before:`CREATE TABLE t (
    v INTEGER
);
`,after:`CREATE TABLE t (
    v BIGINT
);
`}],["ddlapi/column-type/widen-integer-to-numeric",{before:`CREATE TABLE t (
    v INTEGER
);
`,after:`CREATE TABLE t (
    v NUMERIC
);
`}],["ddlapi/column-type/widen-smallint-to-integer",{before:`CREATE TABLE t (
    v SMALLINT
);
`,after:`CREATE TABLE t (
    v INTEGER
);
`}],["ddlapi/column/add-column",{before:`CREATE TABLE users (
    id INT
);
...
`}],["ddlapi/column/add-column-comment",{before:`CREATE TABLE users (
    name TEXT
);
`,after:`CREATE TABLE users (
    name TEXT
...
`}],["ddlapi/column/remove-column",{before:`CREATE TABLE users (
    id INT,
    email TEXT
);
`,after:`CREATE TABLE users (
...
`}],["ddlapi/column/remove-column-comment",{before:`CREATE TABLE users (
    name TEXT
);
...
`}],["ddlapi/column/rename-column",{before:`CREATE TABLE users (
    id INT,
    email TEXT
);
`,after:`CREATE TABLE users (
...
`}],["ddlapi/column/update-column-comment",{before:`CREATE TABLE users (
    name TEXT
);
...
`}],["ddlapi/constraints/add-foreign-key",{before:`CREATE TABLE t (
    id INT PRIMARY KEY
);
...
`}],["ddlapi/constraints/add-primary-key",{before:`CREATE TABLE users (
    id INT,
    email TEXT
);
`,after:`CREATE TABLE users (
...
`}],["ddlapi/constraints/add-primary-key-column",{before:`CREATE TABLE users (
    id INT,
    tenant_id INT,
    CONSTRAINT pk_users PRIMARY KEY(id)
);
...
`}],["ddlapi/constraints/change-foreign-key-columns",{before:`CREATE TABLE parent (
    id INT PRIMARY KEY
);
...
`}],["ddlapi/constraints/change-primary-key-columns",{before:`CREATE TABLE users (
    id INT,
    email TEXT,
    CONSTRAINT pk_users PRIMARY KEY(id)
);
...
`}],["ddlapi/constraints/change-referenced-columns",{before:`CREATE TABLE t (
    id INT,
    code INT,
    PRIMARY KEY(id,code)
);
...
`}],["ddlapi/constraints/change-referenced-table",{before:`CREATE TABLE legacy (
    id INT PRIMARY KEY
);
...
`}],["ddlapi/constraints/remove-foreign-key",{before:`CREATE TABLE t (
    id INT PRIMARY KEY
);
...
`}],["ddlapi/constraints/remove-primary-key",{before:`CREATE TABLE users (
    id INT PRIMARY KEY,
    email TEXT
);
`,after:`CREATE TABLE users (
...
`}],["ddlapi/constraints/remove-primary-key-column",{before:`CREATE TABLE users (
    id INT,
    tenant_id INT,
    CONSTRAINT pk_users PRIMARY KEY(id, tenant_id)
);
...
`}],["ddlapi/table/add-table",{before:`CREATE TABLE a (
    id INT
);
...
`}],["ddlapi/table/add-table-description",{before:`CREATE TABLE t (
    id INT
);
`,after:`CREATE TABLE t (
    id INT
...
`}],["ddlapi/table/remove-table",{before:`CREATE TABLE a (
    id INT
);
...
`}],["ddlapi/table/remove-table-description",{before:`CREATE TABLE t (
    id INT
);
...
`}],["ddlapi/table/rename-table",{before:`CREATE TABLE a (
    id INT
);
`,after:`CREATE TABLE b (
    id INT
);
`}],["ddlapi/table/update-table-description",{before:`CREATE TABLE t (
    id INT
);
...
`}],["graphql/directives/add-argument-default-value-for-schema-directive",{before:`directive @limit (offset: Int) on FIELD_DEFINITION
    ...
    get:
      responses:
        '200':
          ...
          content: { }
`}]]),Ie=new Map([["openapi/general-operation-parameters/add-method-in-path-item",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/general-operation-parameters/add-unused-method-in-path-item",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/general-operation-parameters/remove-method-in-path-item",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/general-operation-parameters/remove-unused-method-in-path-item",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/general-operation-parameters/replace-inline-path-item-to-ref",{versionPairs:[["3.1.0","3.1.0"],["3.0.0","3.1.0"]]}],["openapi/general-operation-parameters/replace-ref-path-item-to-inline",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/headers/add-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.0.0","3.1.0"]]}],["openapi/headers/change-overriden-description",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/headers/change-referenced-description-when-overridden-exists",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/headers/remove-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/operation-parameters/add-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.0.0","3.1.0"]]}],["openapi/operation-parameters/change-overriden-description",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/operation-parameters/change-referenced-description-when-overridden-exists",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/operation-parameters/remove-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/parameters-examples/add-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.0.0","3.1.0"]]}],["openapi/parameters-examples/add-overriden-summary",{versionPairs:[["3.1.0","3.1.0"],["3.0.0","3.1.0"]]}],["openapi/parameters-examples/change-overriden-description",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/parameters-examples/change-overriden-summary",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/parameters-examples/change-referenced-description-when-overridden-exists",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/parameters-examples/change-referenced-summary-when-overridden-exists",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/parameters-examples/remove-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/parameters-examples/remove-overriden-summary",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/parameters-schema/add-exclusive-maximum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/parameters-schema/add-exclusive-minimum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/parameters-schema/add-null-to-union-type",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/parameters-schema/add-sibling-description-for-ref",{versionPairs:[["3.1.0","3.1.0"],["3.0.0","3.1.0"]]}],["openapi/parameters-schema/add-union-type",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/parameters-schema/change-from-exclusive-maximum-to-inclusive-maximum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/parameters-schema/change-from-exclusive-minimum-to-inclusive-minimum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/parameters-schema/change-from-inclusive-maximum-to-exclusive-maximum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/parameters-schema/change-from-inclusive-minimum-to-exclusive-minimum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/parameters-schema/change-referenced-enum-when-sibling-exists-for-ref",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/parameters-schema/change-sibling-enum-for-ref",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/parameters-schema/decrease-exclusive-maximum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/parameters-schema/decrease-exclusive-minimum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/parameters-schema/increase-exclusive-maximum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/parameters-schema/increase-exclusive-minimum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/parameters-schema/mark-schema-value-as-non-nullable",{versionPairs:[["3.0.0","3.0.0"]]}],["openapi/parameters-schema/mark-schema-value-as-nullable",{versionPairs:[["3.0.0","3.0.0"]]}],["openapi/parameters-schema/nullable-equivalent-to-null",{versionPairs:[["3.0.0","3.1.0"]]}],["openapi/parameters-schema/remove-exclusive-maximum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/parameters-schema/remove-exclusive-minimum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/parameters-schema/remove-null-from-union-type",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/parameters-schema/remove-sibling-maxLength-for-ref",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/parameters-schema/remove-union-type",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/parameters-schema/reorder-types-in-union-type",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/parameters-schema/replace-boolean-exclusive-maximum-to-numeric",{versionPairs:[["3.0.0","3.1.0"]]}],["openapi/parameters-schema/replace-boolean-exclusive-minimum-to-numeric",{versionPairs:[["3.0.0","3.1.0"]]}],["openapi/parameters-schema/union-type-equivalent-to-any-of",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/request-body-examples/add-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.0.0","3.1.0"]]}],["openapi/request-body-examples/change-overriden-description",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/request-body-examples/change-referenced-description-when-overridden-exists",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/request-body-examples/remove-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/request-body-schema/add-exclusive-maximum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/request-body-schema/add-exclusive-minimum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/request-body-schema/add-null-to-union-type",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/request-body-schema/add-sibling-description-for-ref",{versionPairs:[["3.1.0","3.1.0"],["3.0.0","3.1.0"]]}],["openapi/request-body-schema/add-union-type",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/request-body-schema/change-from-exclusive-maximum-to-inclusive-maximum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/request-body-schema/change-from-exclusive-minimum-to-inclusive-minimum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/request-body-schema/change-from-inclusive-maximum-to-exclusive-maximum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/request-body-schema/change-from-inclusive-minimum-to-exclusive-minimum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/request-body-schema/change-referenced-enum-when-sibling-exists-for-ref",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/request-body-schema/change-sibling-enum-for-ref",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/request-body-schema/decrease-exclusive-maximum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/request-body-schema/decrease-exclusive-minimum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/request-body-schema/increase-exclusive-maximum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/request-body-schema/increase-exclusive-minimum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/request-body-schema/mark-schema-value-as-non-nullable",{versionPairs:[["3.0.0","3.0.0"]]}],["openapi/request-body-schema/mark-schema-value-as-nullable",{versionPairs:[["3.0.0","3.0.0"]]}],["openapi/request-body-schema/nullable-equivalent-to-null",{versionPairs:[["3.0.0","3.1.0"]]}],["openapi/request-body-schema/remove-exclusive-maximum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/request-body-schema/remove-exclusive-minimum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/request-body-schema/remove-null-from-union-type",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/request-body-schema/remove-sibling-maxLength-for-ref",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/request-body-schema/remove-union-type",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/request-body-schema/reorder-types-in-union-type",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/request-body-schema/replace-boolean-exclusive-maximum-to-numeric",{versionPairs:[["3.0.0","3.1.0"]]}],["openapi/request-body-schema/replace-boolean-exclusive-minimum-to-numeric",{versionPairs:[["3.0.0","3.1.0"]]}],["openapi/request-body-schema/union-type-equivalent-to-any-of",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/request-body/add-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.0.0","3.1.0"]]}],["openapi/request-body/change-overriden-description",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/request-body/change-referenced-description-when-overridden-exists",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/request-body/remove-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/response-body-examples/add-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.0.0","3.1.0"]]}],["openapi/response-body-examples/change-overriden-description",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-body-examples/change-referenced-description-when-overridden-exists",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-body-examples/remove-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/response-body-schema/add-exclusive-maximum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/response-body-schema/add-exclusive-minimum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/response-body-schema/add-null-to-union-type",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-body-schema/add-sibling-description-for-ref",{versionPairs:[["3.1.0","3.1.0"],["3.0.0","3.1.0"]]}],["openapi/response-body-schema/add-union-type",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/response-body-schema/change-from-exclusive-maximum-to-inclusive-maximum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/response-body-schema/change-from-exclusive-minimum-to-inclusive-minimum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/response-body-schema/change-from-inclusive-maximum-to-exclusive-maximum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/response-body-schema/change-from-inclusive-minimum-to-exclusive-minimum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/response-body-schema/change-referenced-enum-when-sibling-exists-for-ref",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-body-schema/change-sibling-enum-for-ref",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-body-schema/decrease-exclusive-maximum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-body-schema/decrease-exclusive-minimum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-body-schema/increase-exclusive-maximum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-body-schema/increase-exclusive-minimum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-body-schema/mark-schema-value-as-non-nullable",{versionPairs:[["3.0.0","3.0.0"]]}],["openapi/response-body-schema/mark-schema-value-as-nullable",{versionPairs:[["3.0.0","3.0.0"]]}],["openapi/response-body-schema/nullable-equivalent-to-null",{versionPairs:[["3.0.0","3.1.0"]]}],["openapi/response-body-schema/remove-exclusive-maximum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/response-body-schema/remove-exclusive-minimum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/response-body-schema/remove-null-from-union-type",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-body-schema/remove-sibling-maxLength-for-ref",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/response-body-schema/remove-union-type",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/response-body-schema/reorder-types-in-union-type",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-body-schema/replace-boolean-exclusive-maximum-to-numeric",{versionPairs:[["3.0.0","3.1.0"]]}],["openapi/response-body-schema/replace-boolean-exclusive-minimum-to-numeric",{versionPairs:[["3.0.0","3.1.0"]]}],["openapi/response-body-schema/union-type-equivalent-to-any-of",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/add-exclusive-maximum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/add-exclusive-minimum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/add-null-to-union-type",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/add-sibling-description-for-ref",{versionPairs:[["3.1.0","3.1.0"],["3.0.0","3.1.0"]]}],["openapi/response-headers-schema/add-union-type",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/change-from-exclusive-maximum-to-inclusive-maximum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/change-from-exclusive-minimum-to-inclusive-minimum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/change-from-inclusive-maximum-to-exclusive-maximum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/change-from-inclusive-minimum-to-exclusive-minimum",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/change-referenced-enum-when-sibling-exists-for-ref",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/change-sibling-enum-for-ref",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/decrease-exclusive-maximum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/decrease-exclusive-minimum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/increase-exclusive-maximum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/increase-exclusive-minimum-value",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/mark-schema-value-as-non-nullable",{versionPairs:[["3.0.0","3.0.0"]]}],["openapi/response-headers-schema/mark-schema-value-as-nullable",{versionPairs:[["3.0.0","3.0.0"]]}],["openapi/response-headers-schema/nullable-equivalent-to-null",{versionPairs:[["3.0.0","3.1.0"]]}],["openapi/response-headers-schema/remove-exclusive-maximum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/remove-exclusive-minimum",{versionPairs:[["3.1.0","3.0.0"],["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/remove-null-from-union-type",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/remove-sibling-maxLength-for-ref",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/response-headers-schema/remove-union-type",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}],["openapi/response-headers-schema/reorder-types-in-union-type",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response-headers-schema/replace-boolean-exclusive-maximum-to-numeric",{versionPairs:[["3.0.0","3.1.0"]]}],["openapi/response-headers-schema/replace-boolean-exclusive-minimum-to-numeric",{versionPairs:[["3.0.0","3.1.0"]]}],["openapi/response-headers-schema/union-type-equivalent-to-any-of",{versionPairs:[["3.0.0","3.1.0"],["3.1.0","3.1.0"]]}],["openapi/response/add-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.0.0","3.1.0"]]}],["openapi/response/change-overriden-description",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response/change-referenced-description-when-overridden-exists",{versionPairs:[["3.1.0","3.1.0"]]}],["openapi/response/remove-overriden-description",{versionPairs:[["3.1.0","3.1.0"],["3.1.0","3.0.0"]]}]]),N=new Map([["add-all-of",{before:{schema:`type: object
properties:
  prop1:
    type: string
`},after:{schema:`allOf:
...
enum:
  ...
  - val2
  - val3
`}}],["add-exclusive-maximum",{before:{schema:`type: number
`},after:{schema:`type: number
exclusiveMaximum: 200
`}}],["add-exclusive-minimum",{before:{schema:`type: number
`},after:{schema:`type: number
exclusiveMinimum: 5
...
`},after:{schema:`properties:
  ...
  option2:
    type: array
    uniqueItems: false
`}}],["change-from-exclusive-maximum-to-inclusive-maximum",{before:{schema:`type: number
exclusiveMaximum: 10
`},after:{schema:`type: number
maximum: 10
`}}],["change-from-exclusive-minimum-to-inclusive-minimum",{before:{schema:`type: number
exclusiveMinimum: 5
`},after:{schema:`type: number
minimum: 5
`}}],["change-from-inclusive-maximum-to-exclusive-maximum",{before:{schema:`type: number
maximum: 10
`},after:{schema:`type: number
exclusiveMaximum: 10
`}}],["change-from-inclusive-minimum-to-exclusive-minimum",{before:{schema:`type: number
minimum: 5
`},after:{schema:`type: number
exclusiveMinimum: 5
`}}],["decrease-exclusive-maximum-value",{before:{schema:`type: number
exclusiveMaximum: 20
`},after:{schema:`type: number
exclusiveMaximum: 15
`}}],["decrease-exclusive-minimum-value",{before:{schema:`type: number
exclusiveMinimum: 30
`},after:{schema:`type: number
exclusiveMinimum: 20
...
`},after:{schema:`type: number
minimum: 1
`}}],["increase-exclusive-maximum-value",{before:{schema:`type: number
exclusiveMaximum: 10
`},after:{schema:`type: number
exclusiveMaximum: 15
`}}],["increase-exclusive-minimum-value",{before:{schema:`type: number
exclusiveMinimum: 50
`},after:{schema:`type: number
exclusiveMinimum: 60
...
enum:
  - val1
  - val2
`}}],["remove-exclusive-maximum",{before:{schema:`type: number
exclusiveMaximum: 200
`},after:{schema:`type: number
`}}],["remove-exclusive-minimum",{before:{schema:`type: number
exclusiveMinimum: 5
`},after:{schema:`type: number
...
`},after:{schema:`type: [string, "null"]
`}}],["replace-boolean-exclusive-maximum-to-numeric",{before:{schema:`type: number
maximum: 10
exclusiveMaximum: true
`},after:{schema:`type: number
exclusiveMaximum: 10
`}}],["replace-boolean-exclusive-minimum-to-numeric",{before:{schema:`type: number
minimum: 10
exclusiveMinimum: true
`},after:{schema:`type: number
exclusiveMinimum: 10
...
xml:
  prefix: "p2"
  namespace: "http://example.com/schema"
`}}]]),ee=new Map([["asyncapi/operation-receive-message-headers",`asyncapi: 3.0.0
info:
        ...
        "200":
          ...
          headers:
            X-Header-1:
              schema:
                __SCHEMA__
`]]),Se=["3.0.0","3.0.0"],V=(e,n)=>{const t=/^openapi:\s*.*$/m;if(!t.test(e))throw new Error(`Invalid OpenAPI sample: missing root "openapi" field. Sample start: ${e.slice(0,100)}...`);return e.replace(t,`openapi: ${n}`)},M="openapi",ne="graphql",te="asyncapi",re="ddlapi",se="/",$=(e,n,t)=>[e,n,t].join(se),oe=(e,n)=>[e,n].join(se),qe=["parameters-schema","request-body-schema","response-body-schema","response-headers-schema"],Oe=["operation-receive-message-headers","operation-send-message-headers","operation-receive-message-payload","operation-send-message-payload","operation-reply-receive-message-headers","operation-reply-send-message-headers","operation-reply-receive-message-payload","operation-reply-send-message-payload"],Pe={[M]:qe,[ne]:[],[te]:Oe,[re]:[]},je=(e,n)=>Pe[e].includes(n),L="__SCHEMA__",G=e=>e.replace(/\r\n/g,`
`),Ee=(e,n)=>{const t=G(e).trimEnd();return t?n?n+t.replace(/\n(?=.)/g,`
${n}`):t:""},Ae=(e,n)=>{var I;const t=G(e),r=t.split(`
`),s=r.map((d,S)=>d.trim()===L?S:-1).filter(d=>d!==-1);if(s.length===0)throw new Error(`Template placeholder '${L}' not found. Template start: ${t.slice(0,120)}...`);if(s.length>1)throw new Error(`Template placeholder '${L}' must appear only once. Found ${s.length} occurrences. Template start: ${t.slice(0,120)}...`);const i=s[0],c=((I=r[i].match(/^\s*/))==null?void 0:I[0])??"",u=Ee(n,c);return u?(r.splice(i,1,...u.split(`
`)),r.join(`
`)):(r.splice(i,1),r.join(`
`))},Te=(e,n)=>{const t=Ae(e,n.schema);return`${G(t).trimEnd()}
`},pe=(e,n)=>je(e,n)?ee.has(oe(e,n)):!1,H=(e,n,t,r)=>{const s=oe(e,n),i=ee.get(s);if(!i)throw new Error(`Schema suite template not found: ${s}`);const c=N.get(t);if(!c)throw new Error(`JSON schema case not found: ${t}`);const u=c[r];return Te(i,u)},Ke=["3.0.0","3.0.0"],W=["unversioned","unversioned"],Fe=(e,n,t)=>pe(e,n)&&N.has(t),we=(e,n,t)=>{const r=$(e,n,t),s=Z.get(r);if(s)return[s.before,s.after];if(!pe(e,n))throw new Error(`Unknown compatibility suite case: (${e}, ${n}, ${t})`);if(!N.has(t))throw new Error(`Unknown JSON schema case '${t}' for schema suite (${e}, ${n})`);const i=H(e,n,t,"before"),c=H(e,n,t,"after");return[i,c]},Re={[M]:{defaultPair:Se,patchSamples:(e,n,t)=>[V(e,t[0]),V(n,t[1])]},[ne]:{defaultPair:W},[te]:{defaultPair:Ke},[re]:{defaultPair:W}},ae=e=>{const n=Re[e];if(!n)throw new Error(`Unknown suiteType for VersionPairPolicy lookup: ${e}`);return n},ie=(e,n)=>{var t;if(e===M)return(t=Ie.get(n))==null?void 0:t.versionPairs},Be=(e,n,t)=>{const r=$(e,n,t);if(!Z.has(r)&&!Fe(e,n,t))throw new Error(`Unknown compatibility suite case: (${e}, ${n}, ${t})`);const s=ae(e);return ie(e,r)??[s.defaultPair]},me=(e,n,t,r)=>{const s=we(e,n,t);if(r===void 0)return s;const i=ae(e),[c,u]=r;if(!Be(e,n,t).some(K=>K[0]===c&&K[1]===u))throw new Error(`Unsupported specificationVersionPair [${c}, ${u}] for case (${e}, ${n}, ${t})`);if(!i.patchSamples)return s;const S=$(e,n,t);return ie(e,S)?i.patchSamples(s[0],s[1],r):s};var ce={exports:{}};(function(e){(function(){function n(o,a){document.addEventListener?o.addEventListener("scroll",a,!1):o.attachEvent("scroll",a)}function t(o){document.body?o():document.addEventListener?document.addEventListener("DOMContentLoaded",function a(){document.removeEventListener("DOMContentLoaded",a),o()}):document.attachEvent("onreadystatechange",function a(){(document.readyState=="interactive"||document.readyState=="complete")&&(document.detachEvent("onreadystatechange",a),o())})}function r(o){this.g=document.createElement("div"),this.g.setAttribute("aria-hidden","true"),this.g.appendChild(document.createTextNode(o)),this.h=document.createElement("span"),this.i=document.createElement("span"),this.m=document.createElement("span"),this.j=document.createElement("span"),this.l=-1,this.h.style.cssText="max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;",this.i.style.cssText="max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;",this.j.style.cssText="max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;",this.m.style.cssText="display:inline-block;width:200%;height:200%;font-size:16px;max-width:none;",this.h.appendChild(this.m),this.i.appendChild(this.j),this.g.appendChild(this.h),this.g.appendChild(this.i)}function s(o,a){o.g.style.cssText="max-width:none;min-width:20px;min-height:20px;display:inline-block;overflow:hidden;position:absolute;width:auto;margin:0;padding:0;top:-999px;white-space:nowrap;font-synthesis:none;font:"+a+";"}function i(o){var a=o.g.offsetWidth,p=a+100;return o.j.style.width=p+"px",o.i.scrollLeft=p,o.h.scrollLeft=o.h.scrollWidth+100,o.l!==a?(o.l=a,!0):!1}function c(o,a){function p(){var l=v;i(l)&&l.g.parentNode!==null&&a(l.l)}var v=o;n(o.h,p),n(o.i,p),i(o)}function u(o,a,p){a=a||{},p=p||window,this.family=o,this.style=a.style||"normal",this.weight=a.weight||"normal",this.stretch=a.stretch||"normal",this.context=p}var I=null,d=null,S=null,T=null;function K(o){return d===null&&(Q(o)&&/Apple/.test(window.navigator.vendor)?(o=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))(?:\.([0-9]+))/.exec(window.navigator.userAgent),d=!!o&&603>parseInt(o[1],10)):d=!1),d}function Q(o){return T===null&&(T=!!o.document.fonts),T}function q(o,a){var p=o.style,v=o.weight;if(S===null){var l=document.createElement("div");try{l.style.font="condensed 100px sans-serif"}catch{}S=l.style.font!==""}return[p,v,S?o.stretch:"","100px",a].join(" ")}u.prototype.load=function(o,a){var p=this,v=o||"BESbswy",l=0,O=a||3e3,_=new Date().getTime();return new Promise(function(X,U){if(Q(p.context)&&!K(p.context)){var ue=new Promise(function(P,j){function y(){new Date().getTime()-_>=O?j(Error(""+O+"ms timeout exceeded")):p.context.document.fonts.load(q(p,'"'+p.family+'"'),v).then(function(x){1<=x.length?P():setTimeout(y,25)},j)}y()}),le=new Promise(function(P,j){l=setTimeout(function(){j(Error(""+O+"ms timeout exceeded"))},O)});Promise.race([le,ue]).then(function(){clearTimeout(l),X(p)},U)}else t(function(){function P(){var m;(m=h!=-1&&g!=-1||h!=-1&&b!=-1||g!=-1&&b!=-1)&&((m=h!=g&&h!=b&&g!=b)||(I===null&&(m=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),I=!!m&&(536>parseInt(m[1],10)||parseInt(m[1],10)===536&&11>=parseInt(m[2],10))),m=I&&(h==F&&g==F&&b==F||h==w&&g==w&&b==w||h==R&&g==R&&b==R)),m=!m),m&&(f.parentNode!==null&&f.parentNode.removeChild(f),clearTimeout(l),X(p))}function j(){if(new Date().getTime()-_>=O)f.parentNode!==null&&f.parentNode.removeChild(f),U(Error(""+O+"ms timeout exceeded"));else{var m=p.context.document.hidden;(m===!0||m===void 0)&&(h=y.g.offsetWidth,g=x.g.offsetWidth,b=E.g.offsetWidth,P()),l=setTimeout(j,50)}}var y=new r(v),x=new r(v),E=new r(v),h=-1,g=-1,b=-1,F=-1,w=-1,R=-1,f=document.createElement("div");f.dir="ltr",s(y,q(p,"sans-serif")),s(x,q(p,"serif")),s(E,q(p,"monospace")),f.appendChild(y.g),f.appendChild(x.g),f.appendChild(E.g),p.context.document.body.appendChild(f),F=y.g.offsetWidth,w=x.g.offsetWidth,R=E.g.offsetWidth,j(),c(y,function(m){h=m,P()}),s(y,q(p,'"'+p.family+'",sans-serif')),c(x,function(m){g=m,P()}),s(x,q(p,'"'+p.family+'",serif')),c(E,function(m){b=m,P()}),s(E,q(p,'"'+p.family+'",monospace'))})})},e.exports=u})()})(ce);var Le=ce.exports;const Ce=ge(Le),De={schemaName:"public",name:"t"};async function Ne(e,n){const[t,r]=await Promise.all([Y(e),Y(n)]),{before:s,after:i}=xe(t,r),{merged:c}=z(s,i,{unify:!0,validate:!0,metaKey:D.diffsMetaKey,normalizedResult:!1});return c}function Me(e){const n=D.diffsMetaKey;for(const t of e.schemas??[]){const r=t.tables??[];for(let s=0;s<r.length;s+=1){const i=r[s];if(Ge(r,s,n)||C(i,n))return{schemaName:t.name,name:i.name}}}return $e(e)??De}function $e(e){var n;for(const t of e.schemas??[]){const r=(n=t.tables)==null?void 0:n[0];if(r)return{schemaName:t.name,name:r.name}}}function Ge(e,n,t){const r=Reflect.get(e,t);return r===void 0?!1:r[n]!==void 0||r[String(n)]!==void 0}function C(e,n,t=new Set){return e===null||typeof e!="object"||t.has(e)?!1:(t.add(e),e[n]!==void 0?!0:Array.isArray(e)?e.some(r=>C(r,n,t)):Object.values(e).some(r=>C(r,n,t)))}const Qe=Symbol("synthetic-title"),_e={validate:!0,liftCombiners:!0,syntheticTitleFlag:Qe,unify:!0,allowNotValidSyntheticChanges:!0},Xe=(e,n)=>{const s=z(e,n,{..._e,beforeSource:e,afterSource:n,mode:fe,metaKey:J});return Ue(s.merged)&&(s.merged.toJSON=()=>de(s.merged)),s};function Ue(e){return e!=null&&typeof e=="object"}const ke=["Inter"];function Ye(){const[e,n]=B.useState(!1),t=ke.map(r=>new Ce(r).load(null,1e4));return Promise.all(t).then(()=>{n(!0)}),e}const Ve={diffsMetaKey:J,aggregatedDiffsMetaKey:he};function He({before:e,after:n}){const{merged:t}=Xe(k(e),k(n));return Ye()?A.jsx(ve,{layoutMode:ye,metaKeys:Ve,source:t}):A.jsx(A.Fragment,{})}function an(e,n,t){const[r,s]=me(e,n,t);return{before:r,after:s}}const We=(e,n,t)=>`#${e}.${n}.${t}`;function ze({before:e,after:n}){const[t,r]=B.useState(void 0),[s,i]=B.useState(void 0);return B.useEffect(()=>{let c=!1;return r(void 0),i(void 0),Ne(e,n).then(u=>{c||(r(u),i(Me(u)))}).catch(u=>{c||console.error(u)}),()=>{c=!0}},[e,n]),!t||!s?A.jsx(A.Fragment,{}):A.jsx(be,{mergedSource:t,tableKey:s,navigationLinkBuilder:We,diffMetaKeys:D,devMode:!0})}function mn(e,n,t){const[r,s]=me(e,n,t);return{before:r,after:s}}He.__docgenInfo={description:"",methods:[],displayName:"GraphQLStoryComponent",props:{before:{required:!0,tsType:{name:"string"},description:""},after:{required:!0,tsType:{name:"string"},description:""}}};ze.__docgenInfo={description:"",methods:[],displayName:"DdlStoryComponent",props:{before:{required:!0,tsType:{name:"string"},description:""},after:{required:!0,tsType:{name:"string"},description:""}}};export{ze as D,He as G,re as T,an as a,ne as b,mn as g};
