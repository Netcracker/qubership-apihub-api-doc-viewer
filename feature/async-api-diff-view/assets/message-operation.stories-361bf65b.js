...
}))`,...(_=(q=s.parameters)==null?void 0:q.docs)==null?void 0:_.source}}};var K,R,$;a.parameters={...a.parameters,docs:{...(K=a.parameters)==null?void 0:K.docs,source:{originalSource:`createStory(createSource({
  operation: {
    bindings: {
      kafka: {
...
}))`,...($=(R=a.parameters)==null?void 0:R.docs)==null?void 0:$.source}}};var M,h,C;c.parameters={...c.parameters,docs:{...(M=c.parameters)==null?void 0:M.docs,source:{originalSource:`createStory(createSource({
  operation: {
    bindings: {
      kafka: {
        bindingVersion: "0.5.0",
...
}))`,...(C=(h=c.parameters)==null?void 0:h.docs)==null?void 0:C.source}}};var P,X,Y;p.parameters={...p.parameters,docs:{...(P=p.parameters)==null?void 0:P.docs,source:{originalSource:`createStory(createSource({
  operation: {
    bindings: {
      kafka: {
        bindingVersion: "0.5.0",
