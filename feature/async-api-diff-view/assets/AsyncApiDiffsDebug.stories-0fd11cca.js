import{j as l}from"./_commonjs-dynamic-modules-6308e768.js";import{a as u}from"./AsyncApiOperationViewer-29985ec8.js";import{j as m}from"./js-yaml-71a24e1f.js";import{T as g,a,b as S}from"./preprocess-ffc0f2cc.js";import"./index-f46741a2.js";import"./GraphPropNodeViewer-e1f85955.js";import"./index-415bee12.js";import"./GraphQLOperationDiffViewer-033fa5ce.js";import"./GraphQLOperationViewer-2793585b.js";const c=n=>{let e;try{e=JSON.parse(n)}catch(s){console.error("Cannot parse JSON:",s),e=void 0}try{e||(e=m.load(n))}catch(s){console.error("Cannot parse YAML:",s),e=void 0}return!e||typeof e!="object"?{}:e},M={title:"Debug/Async Api Diffs Viewer",component:u,argTypes:{mergedSource:{control:{disable:!0},table:{disable:!0}},beforeSourceText:{control:"text"},afterSourceText:{control:"text"},displayMode:{control:"select",options:["simple","detailed"],defaultValue:"detailed"}},args:{beforeSourceText:`{
  "asyncapi": "3.0.0",
  "operations": {
