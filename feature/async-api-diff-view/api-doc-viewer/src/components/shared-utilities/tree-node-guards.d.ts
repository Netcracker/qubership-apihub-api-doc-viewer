...
export declare function isTreeNodeWithDiffs<T extends {
    ...
    kind: PropertyKey;
} | null | undefined, withDiffsConstructor: abstract new (...args: never[]) => object, kind?: PropertyKey): node is T;
...
export declare function isNodeWithDiffs(node: AsyncApiTreeNode<typeof AsyncApiTreeNodeKinds.SERVERS> | AsyncApiTreeNodeWithDiffs<typeof AsyncApiTreeNodeKinds.SERVERS>): node is AsyncApiTreeNodeWithDiffs<typeof AsyncApiTreeNodeKinds.SERVERS>;
