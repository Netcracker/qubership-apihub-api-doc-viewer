import{j as k}from"./_commonjs-dynamic-modules-6308e768.js";import{o as oe,C as ae,D as X,s as ie,S as pe,a as me}from"./UxBadge-c7aafe76.js";import{g as ce,r as de}from"./index-f46741a2.js";import{G as fe}from"./GraphQLOperationDiffViewer-066bafbc.js";import{b as C}from"./graph-api-transformers-e0c84cb5.js";const U=new Map([["asyncapi/semantic-mapping/all-ids-changed",{before:`asyncapi: 3.0.0
info:
...
operations:
  sendOrderEvent_2002:
    action: send
    channel:
      $ref: '#/channels/orderEvents_2002'
    title: orderEvents_1001 send
    description: Publish priority order events to order-events
    messages:
      - $ref: '#/channels/orderEvents_2002/messages/OrderEvent_2002'
  sendOrderEvent:
    action: send
    channel:
      $ref: '#/channels/orderEvents'
...
channels:
  ...
  orderEvents_2002:
    ...
    messages:
      OrderEvent_2002:
        $ref: '#/components/messages/OrderEvent_2002'
`}],["asyncapi/semantic-mapping/both-channel-ids-changed",{before:`asyncapi: 3.0.0
info:
  title: Order Service AsyncAPI Specification
  version: 1.0.0
  description: AsyncAPI specification of Kafka consumers and producers
...
operations:
  sendOrderEvent_1001:
    ...
    description: Publish priority order events to order-events
    messages:
      - $ref: '#/channels/orderEvents_2002/messages/OrderEvent_1001'
  sendOrderEvent:
    action: send
    channel:
      $ref: '#/channels/orderEvents_3003'
    title: orderEvents send
    description: Publish order events to order-events
    messages:
      - $ref: '#/channels/orderEvents_3003/messages/OrderEvent'
servers:
  kafka-server:
    host: /
    protocol: kafka
...
channels:
  ...
  orderEvents_2002:
    ...
    messages:
      OrderEvent_1001:
        $ref: '#/components/messages/OrderEvent_1001'
`}],["asyncapi/semantic-mapping/channel-id-changed",{before:`asyncapi: 3.0.0
info:
  title: Order Service AsyncAPI Specification
  version: 1.0.0
  description: AsyncAPI specification of Kafka consumers and producers
...
channels:
  ...
  orderEvents_2002:
    ...
    messages:
      OrderEvent_1001:
        $ref: '#/components/messages/OrderEvent_1001'
`}],["asyncapi/semantic-mapping/message-id-changed",{before:`asyncapi: 3.0.0
info:
  title: Order Service AsyncAPI Specification
  version: 1.0.0
  description: AsyncAPI specification of Kafka consumers and producers
...
operations:
  sendOrderEvent_1001:
    ...
    description: Publish priority order events to order-events
    messages:
      - $ref: '#/channels/orderEvents_1001/messages/OrderEvent_2002'
  sendOrderEvent:
    action: send
    channel:
      $ref: '#/channels/orderEvents'
...
channels:
  ...
  orderEvents_1001:
    ...
    messages:
      OrderEvent_2002:
        $ref: '#/components/messages/OrderEvent_2002'
`}],["asyncapi/semantic-mapping/message-id-changed-and-message-added",{before:`asyncapi: 3.0.0
info:
  title: Order Service AsyncAPI Specification
  version: 1.0.0
  description: AsyncAPI specification of Kafka consumers and producers
...
operations:
  ...
  sendOrderCancelled:
    ...
    channel:
      $ref: '#/channels/orderEvents'
    title: orderEvents send cancellations
    description: Publish order cancellations to order-events
    messages:
...
components:
  schemas:
    ...
    OrderCancelled:
      ...
      description: Kafka payload for order cancellations
    OrderEvent:
      title: OrderEvent
      $schema: https://json-schema.org/draft/2020-12/schema
      type: object
  ...
  messages:
    OrderCancelled:
      ...
      name: OrderCancelled
      title: OrderCancelled
      description: Event representing an order cancellation
    OrderEvent:
      headers:
        anyOf:
          - $ref: '#/components/schemas/TenantHeader'
...
channels:
  ...
  orderEvents_1001:
    ...
    messages:
      OrderEvent_2002:
        $ref: '#/components/messages/OrderEvent_2002'
`}],["asyncapi/semantic-mapping/message-id-changed-and-message-removed",{before:`asyncapi: 3.0.0
info:
  title: Order Service AsyncAPI Specification
  version: 1.0.0
  description: AsyncAPI specification of Kafka consumers and producers
...
channels:
  ...
  orderEvents_1001:
    ...
    messages:
      OrderEvent_2002:
        $ref: '#/components/messages/OrderEvent_2002'
`}],["asyncapi/semantic-mapping/message-id-changed-in-multi-message-operation",{before:`asyncapi: 3.0.0
info:
  title: Order Service AsyncAPI Specification
  version: 1.0.0
  description: AsyncAPI specification of Kafka consumers and producers
...
operations:
  sendOrderEvent_1001:
    ...
    messages:
      - $ref: '#/channels/orderEvents_1001/messages/OrderEvent_2002'
      - $ref: '#/channels/orderEvents_1001/messages/OrderShipped_2003'
servers:
  kafka-server:
    host: /
    protocol: kafka
  ...
  orderEvents_1001:
    ...
    messages:
      OrderEvent_2002:
        $ref: '#/components/messages/OrderEvent_2002'
      OrderShipped_2003:
        $ref: '#/components/messages/OrderShipped_2003'
`}],["asyncapi/semantic-mapping/message-id-changed-in-operation-reply",{before:`asyncapi: 3.0.0
info:
  title: Order Service AsyncAPI Specification
  version: 1.0.0
  description: AsyncAPI specification of Kafka consumers and producers
operations:
  sendOrderCommand_1001:
    action: send
    channel:
      $ref: '#/channels/orderCommands_1001'
    title: orderCommands_1001 send
    description: Publish priority order commands to order-commands
    messages:
      - $ref: '#/channels/orderCommands_1001/messages/OrderCommand_1001'
    reply:
      channel:
        $ref: '#/channels/orderReplies'
      messages:
        - $ref: '#/channels/orderReplies/messages/OrderEvent_1001'
servers:
  kafka-server:
    host: /
    protocol: kafka
...
components:
  schemas:
    OrderCommand:
      ...
      description: Kafka payload for order commands
    OrderEvent:
      title: OrderEvent
      $schema: https://json-schema.org/draft/2020-12/schema
      type: object
  ...
  messages:
    OrderCommand_1001:
      ...
      name: OrderCommand
      title: OrderCommand
      description: Command requesting a priority order change
    OrderEvent_1001:
      payload:
        $ref: '#/components/schemas/OrderEvent'
      name: OrderEvent
...
channels:
  orderCommands_1001:
    ...
    description: Kafka topic for priority order commands
    servers:
      - $ref: '#/servers/kafka-server'
    messages:
      OrderCommand_1001:
        $ref: '#/components/messages/OrderCommand_1001'
  orderReplies:
    address: order-replies
    title: order-replies
    description: Kafka topic for order command replies
    servers:
      - $ref: '#/servers/kafka-server'
    messages:
      OrderEvent_1001:
  ...
  sendOrderCommand_1001:
    ...
    reply:
      channel:
        $ref: '#/channels/orderReplies'
      messages:
        - $ref: '#/channels/orderReplies/messages/OrderEvent_2002'
servers:
  kafka-server:
    host: /
    protocol: kafka
...
channels:
  ...
  orderReplies:
    ...
    messages:
      OrderEvent_2002:
        $ref: '#/components/messages/OrderEvent_2002'
`}],["asyncapi/semantic-mapping/message-id-changed-with-description",{before:`asyncapi: 3.0.0
info:
  title: Order Service AsyncAPI Specification
  version: 1.0.0
  description: AsyncAPI specification of Kafka consumers and producers
...
components:
  ...
  messages:
    ...
    OrderEvent_2002:
      ...
      name: OrderEvent
      title: OrderEvent
      description: Event representing high-priority order changes
channels:
  orderEvents:
    address: order-events
    title: order-events
  ...
  orderEvents_1001:
    ...
    messages:
      OrderEvent_2002:
        $ref: '#/components/messages/OrderEvent_2002'
`}],["asyncapi/semantic-mapping/message-id-changed-with-inline-payload",{before:`asyncapi: 3.0.0
info:
  title: Order Service AsyncAPI Specification
  version: 1.0.0
  description: AsyncAPI specification of Kafka consumers and producers
...
channels:
  ...
  orderEvents_1001:
    ...
    messages:
      OrderEvent_2002:
        $ref: '#/components/messages/OrderEvent_2002'
`}],["asyncapi/semantic-mapping/message-id-changed-with-payload",{before:`asyncapi: 3.0.0
info:
  title: Order Service AsyncAPI Specification
  version: 1.0.0
  description: AsyncAPI specification of Kafka consumers and producers
  ...
  schemas:
    ...
    OrderEvent:
      ...
      properties:
        ...
        orderId:
          type: string
          description: Identifier of the order the event is about
      description: Kafka payload for order events
  messages:
    OrderEvent:
      headers:
...
channels:
  ...
  orderEvents_1001:
    ...
    messages:
      OrderEvent_2002:
        $ref: '#/components/messages/OrderEvent_2002'
`}],["asyncapi/semantic-mapping/message-id-renamed-manually",{before:`asyncapi: 3.0.0
info:
  title: Order Service AsyncAPI Specification
  version: 1.0.0
  description: AsyncAPI specification of Kafka consumers and producers
...
operations:
  sendOrderEvent_1001:
    ...
    description: Publish priority order events to order-events
    messages:
      - $ref: '#/channels/orderEvents_1001/messages/OrderEventPriority'
  sendOrderEvent:
    action: send
    channel:
      $ref: '#/channels/orderEvents'
...
channels:
  ...
  orderEvents_1001:
    ...
    messages:
      OrderEventPriority:
        $ref: '#/components/messages/OrderEventPriority'
`}],["asyncapi/semantic-mapping/no-ids-changed",{before:`asyncapi: 3.0.0
info:
  title: Order Service AsyncAPI Specification
  version: 1.0.0
  description: AsyncAPI specification of Kafka consumers and producers
...
channels:
  ...
  orderEvents_1001:
    ...
    messages:
      OrderEvent_1001:
        $ref: '#/components/messages/OrderEvent_1001'
`}],["asyncapi/semantic-mapping/operation-id-changed",{before:`asyncapi: 3.0.0
info:
  title: Order Service AsyncAPI Specification
  version: 1.0.0
  description: AsyncAPI specification of Kafka consumers and producers
...
xml:
  prefix: "p2"
  namespace: "http://example.com/schema"
`}}]]),V=new Map([["asyncapi/operation-receive-message-headers",`asyncapi: 3.0.0
info:
        ...
        "200":
          ...
          headers:
            X-Header-1:
              schema:
                __SCHEMA__
`]]),ue=["3.0.0","3.0.0"],N=(e,n)=>{const t=/^openapi:\s*.*$/m;if(!t.test(e))throw new Error(`Invalid OpenAPI sample: missing root "openapi" field. Sample start: ${e.slice(0,100)}...`);return e.replace(t,`openapi: ${n}`)},R="openapi",W="graphql",z="asyncapi",Y="/",D=(e,n,t)=>[e,n,t].join(Y),J=(e,n)=>[e,n].join(Y),ye=["parameters-schema","request-body-schema","response-body-schema","response-headers-schema"],he=["operation-receive-message-headers","operation-send-message-headers","operation-receive-message-payload","operation-send-message-payload","operation-reply-receive-message-headers","operation-reply-send-message-headers","operation-reply-receive-message-payload","operation-reply-send-message-payload"],ge={[R]:ye,[W]:[],[z]:he},ve=(e,n)=>ge[e].includes(n),_="__SCHEMA__",B=e=>e.replace(/\r\n/g,`
`),be=(e,n)=>{const t=B(e).trimEnd();return t?n?n+t.replace(/\n(?=.)/g,`
${n}`):t:""},Oe=(e,n)=>{var x;const t=B(e),a=t.split(`
`),s=a.map((u,I)=>u.trim()===_?I:-1).filter(u=>u!==-1);if(s.length===0)throw new Error(`Template placeholder '${_}' not found. Template start: ${t.slice(0,120)}...`);if(s.length>1)throw new Error(`Template placeholder '${_}' must appear only once. Found ${s.length} occurrences. Template start: ${t.slice(0,120)}...`);const m=s[0],c=((x=a[m].match(/^\s*/))==null?void 0:x[0])??"",l=be(n,c);return l?(a.splice(m,1,...l.split(`
`)),a.join(`
`)):(a.splice(m,1),a.join(`
`))},xe=(e,n)=>{const t=Oe(e,n.schema);return`${B(t).trimEnd()}
`},Z=(e,n)=>ve(e,n)?V.has(J(e,n)):!1,H=(e,n,t,a)=>{const s=J(e,n),m=V.get(s);if(!m)throw new Error(`Schema suite template not found: ${s}`);const c=T.get(t);if(!c)throw new Error(`JSON schema case not found: ${t}`);const l=c[a];return xe(m,l)},Ie=["3.0.0","3.0.0"],qe=["unversioned","unversioned"],Ee=(e,n,t)=>Z(e,n)&&T.has(t),Se=(e,n,t)=>{const a=D(e,n,t),s=U.get(a);if(s)return[s.before,s.after];if(!Z(e,n))throw new Error(`Unknown compatibility suite case: (${e}, ${n}, ${t})`);if(!T.has(t))throw new Error(`Unknown JSON schema case '${t}' for schema suite (${e}, ${n})`);const m=H(e,n,t,"before"),c=H(e,n,t,"after");return[m,c]},Pe={[R]:{defaultPair:ue,patchSamples:(e,n,t)=>[N(e,t[0]),N(n,t[1])]},[W]:{defaultPair:qe},[z]:{defaultPair:Ie}},ee=e=>{const n=Pe[e];if(!n)throw new Error(`Unknown suiteType for VersionPairPolicy lookup: ${e}`);return n},ne=(e,n)=>{var t;if(e===R)return(t=le.get(n))==null?void 0:t.versionPairs},je=(e,n,t)=>{const a=D(e,n,t);if(!U.has(a)&&!Ee(e,n,t))throw new Error(`Unknown compatibility suite case: (${e}, ${n}, ${t})`);const s=ee(e);return ne(e,a)??[s.defaultPair]},Ke=(e,n,t,a)=>{const s=Se(e,n,t);if(a===void 0)return s;const m=ee(e),[c,l]=a;if(!je(e,n,t).some($=>$[0]===c&&$[1]===l))throw new Error(`Unsupported specificationVersionPair [${c}, ${l}] for case (${e}, ${n}, ${t})`);if(!m.patchSamples)return s;const I=D(e,n,t);return ne(e,I)?m.patchSamples(s[0],s[1],a):s};var te={exports:{}};(function(e){(function(){function n(r,i){document.addEventListener?r.addEventListener("scroll",i,!1):r.attachEvent("scroll",i)}function t(r){document.body?r():document.addEventListener?document.addEventListener("DOMContentLoaded",function i(){document.removeEventListener("DOMContentLoaded",i),r()}):document.attachEvent("onreadystatechange",function i(){(document.readyState=="interactive"||document.readyState=="complete")&&(document.detachEvent("onreadystatechange",i),r())})}function a(r){this.g=document.createElement("div"),this.g.setAttribute("aria-hidden","true"),this.g.appendChild(document.createTextNode(r)),this.h=document.createElement("span"),this.i=document.createElement("span"),this.m=document.createElement("span"),this.j=document.createElement("span"),this.l=-1,this.h.style.cssText="max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;",this.i.style.cssText="max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;",this.j.style.cssText="max-width:none;display:inline-block;position:absolute;height:100%;width:100%;overflow:scroll;font-size:16px;",this.m.style.cssText="display:inline-block;width:200%;height:200%;font-size:16px;max-width:none;",this.h.appendChild(this.m),this.i.appendChild(this.j),this.g.appendChild(this.h),this.g.appendChild(this.i)}function s(r,i){r.g.style.cssText="max-width:none;min-width:20px;min-height:20px;display:inline-block;overflow:hidden;position:absolute;width:auto;margin:0;padding:0;top:-999px;white-space:nowrap;font-synthesis:none;font:"+i+";"}function m(r){var i=r.g.offsetWidth,o=i+100;return r.j.style.width=o+"px",r.i.scrollLeft=o,r.h.scrollLeft=r.h.scrollWidth+100,r.l!==i?(r.l=i,!0):!1}function c(r,i){function o(){var d=b;m(d)&&d.g.parentNode!==null&&i(d.l)}var b=r;n(r.h,o),n(r.i,o),m(r)}function l(r,i,o){i=i||{},o=o||window,this.family=r,this.style=i.style||"normal",this.weight=i.weight||"normal",this.stretch=i.stretch||"normal",this.context=o}var x=null,u=null,I=null,K=null;function $(r){return u===null&&(L(r)&&/Apple/.test(window.navigator.vendor)?(r=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))(?:\.([0-9]+))/.exec(window.navigator.userAgent),u=!!r&&603>parseInt(r[1],10)):u=!1),u}function L(r){return K===null&&(K=!!r.document.fonts),K}function q(r,i){var o=r.style,b=r.weight;if(I===null){var d=document.createElement("div");try{d.style.font="condensed 100px sans-serif"}catch{}I=d.style.font!==""}return[o,b,I?r.stretch:"","100px",i].join(" ")}l.prototype.load=function(r,i){var o=this,b=r||"BESbswy",d=0,E=i||3e3,G=new Date().getTime();return new Promise(function(M,Q){if(L(o.context)&&!$(o.context)){var re=new Promise(function(S,P){function y(){new Date().getTime()-G>=E?P(Error(""+E+"ms timeout exceeded")):o.context.document.fonts.load(q(o,'"'+o.family+'"'),b).then(function(O){1<=O.length?S():setTimeout(y,25)},P)}y()}),se=new Promise(function(S,P){d=setTimeout(function(){P(Error(""+E+"ms timeout exceeded"))},E)});Promise.race([se,re]).then(function(){clearTimeout(d),M(o)},Q)}else t(function(){function S(){var p;(p=h!=-1&&g!=-1||h!=-1&&v!=-1||g!=-1&&v!=-1)&&((p=h!=g&&h!=v&&g!=v)||(x===null&&(p=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent),x=!!p&&(536>parseInt(p[1],10)||parseInt(p[1],10)===536&&11>=parseInt(p[2],10))),p=x&&(h==A&&g==A&&v==A||h==F&&g==F&&v==F||h==w&&g==w&&v==w)),p=!p),p&&(f.parentNode!==null&&f.parentNode.removeChild(f),clearTimeout(d),M(o))}function P(){if(new Date().getTime()-G>=E)f.parentNode!==null&&f.parentNode.removeChild(f),Q(Error(""+E+"ms timeout exceeded"));else{var p=o.context.document.hidden;(p===!0||p===void 0)&&(h=y.g.offsetWidth,g=O.g.offsetWidth,v=j.g.offsetWidth,S()),d=setTimeout(P,50)}}var y=new a(b),O=new a(b),j=new a(b),h=-1,g=-1,v=-1,A=-1,F=-1,w=-1,f=document.createElement("div");f.dir="ltr",s(y,q(o,"sans-serif")),s(O,q(o,"serif")),s(j,q(o,"monospace")),f.appendChild(y.g),f.appendChild(O.g),f.appendChild(j.g),o.context.document.body.appendChild(f),A=y.g.offsetWidth,F=O.g.offsetWidth,w=j.g.offsetWidth,P(),c(y,function(p){h=p,S()}),s(y,q(o,'"'+o.family+'",sans-serif')),c(O,function(p){g=p,S()}),s(O,q(o,'"'+o.family+'",serif')),c(j,function(p){v=p,S()}),s(j,q(o,'"'+o.family+'",monospace'))})})},e.exports=l})()})(te);var $e=te.exports;const Ae=ce($e),Fe=Symbol("synthetic-title"),we={validate:!0,liftCombiners:!0,syntheticTitleFlag:Fe,unify:!0,allowNotValidSyntheticChanges:!0},ke=(e,n)=>{const s=oe(e,n,{...we,beforeSource:e,afterSource:n,mode:ae,metaKey:X});return _e(s.merged)&&(s.merged.toJSON=()=>ie(s.merged)),s};function _e(e){return e!=null&&typeof e=="object"}const Te=["Inter"];function Re(){const[e,n]=de.useState(!1),t=Te.map(a=>new Ae(a).load(null,1e4));return Promise.all(t).then(()=>{n(!0)}),e}const De={diffsMetaKey:X,aggregatedDiffsMetaKey:me};function Be({before:e,after:n}){const{merged:t}=ke(C(e),C(n));return Re()?k.jsx(fe,{layoutMode:pe,metaKeys:De,source:t}):k.jsx(k.Fragment,{})}function Ne(e,n,t){const[a,s]=Ke(e,n,t);return{before:a,after:s}}Be.__docgenInfo={description:"",methods:[],displayName:"GraphQLStoryComponent",props:{before:{required:!0,tsType:{name:"string"},description:""},after:{required:!0,tsType:{name:"string"},description:""}}};export{Be as G,W as T,Ne as g};
