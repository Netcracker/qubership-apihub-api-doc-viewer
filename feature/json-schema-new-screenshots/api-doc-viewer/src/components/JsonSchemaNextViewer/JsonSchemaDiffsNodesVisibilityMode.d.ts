...
export type JsonSchemaDiffsNodesVisibilityMode = typeof SHOW_ALL_NODES_MODE | typeof SHOW_ONLY_CHANGED_NODES_MODE;
...
export declare function resolveJsonSchemaDiffsNodesVisibilityMode(hideUnchangedNodes: boolean): JsonSchemaDiffsNodesVisibilityMode;
 ...
 * that mode is added. */
export declare function isHideUnchangedNodesMode(mode: JsonSchemaDiffsNodesVisibilityMode): boolean;
