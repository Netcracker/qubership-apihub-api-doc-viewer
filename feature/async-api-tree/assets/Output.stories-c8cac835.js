import{q as Pe,I as Te,S as Q,D as we,a as qe}from"./NestingIndicatorTitleRow-c1b12f14.js";import{b as e}from"./graph-api-transformers-c83cd09a.js";import{j as ve}from"./_commonjs-dynamic-modules-6308e768.js";import{p as xe}from"./preprocess-30322e5f.js";import{G as je}from"./GraphQLOperationDiffViewer-be7fa3a9.js";import"./index-f46741a2.js";import"./index-415bee12.js";import"./buildASTSchema-f14864f0.js";import"./GraphPropNodeViewer-0b3a3ef6.js";import"./model-44d591da.js";const Oe=f=>{const{beforeSource:Ge,afterSource:Ne,circular:Be=!1}=f,De=xe({beforeSource:Ge,afterSource:Ne,circular:Be});return ve.jsx(je,{...f,source:De})};Oe.__docgenInfo={description:"",methods:[],displayName:"TestGraphQLOperationDiffViewer",props:{beforeSource:{required:!1,tsType:{name:"unknown"},description:""},afterSource:{required:!0,tsType:{name:"unknown"},description:""},circular:{required:!1,tsType:{name:"boolean"},description:""}}};const Ke={title:"GraphQL Operation Diff Viewer/Output",component:Oe,parameters:{},argTypes:{beforeSource:{control:"object"},afterSource:{control:"object"},layoutMode:{control:"radio",options:[Pe,Te,Q]},filters:{control:"check",options:["breaking","non-breaking","annotation","unclassified","deprecated"]}},args:{layoutMode:Q,metaKeys:{diffsMetaKey:we,aggregatedDiffsMetaKey:qe}}},r={args:{beforeSource:e(`
      type Query {
...
}`,...(P=(D=n.parameters)==null?void 0:D.docs)==null?void 0:P.source}}};var T,w,q;a.parameters={...a.parameters,docs:{...(T=a.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    beforeSource: buildGraphApiSchema(\`
      type Query {
        """Returns a random string"""
...
}`,...(q=(w=a.parameters)==null?void 0:w.docs)==null?void 0:q.source}}};var v,x,j;o.parameters={...o.parameters,docs:{...(v=o.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    beforeSource: buildGraphApiSchema(\`
      type Query {
        """Returns a random string"""
