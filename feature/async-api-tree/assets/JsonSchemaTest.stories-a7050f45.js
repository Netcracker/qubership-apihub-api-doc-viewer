import{J as u}from"./JsonSchemaViewer-398b85ea.js";import{c as h,d as g}from"./preprocess-d28f46f8.js";import"./_commonjs-dynamic-modules-6308e768.js";import"./index-f46741a2.js";import"./NestingIndicatorTitleRow-cf6a04d5.js";import"./index-415bee12.js";import"./JsonPropNodeViewer-63225ef9.js";const b={title:"Json Schema Viewer",component:u,parameters:{},argTypes:{},args:{schema:{}}},e={args:{schema:{}}},n={args:{schema:h({schema:{type:"object",properties:{a:{$ref:"#/components/schemas/A"},b:{$ref:"#/components/schemas/A"},c:{type:"string"},d:{type:"object",properties:{e:{type:"number"}}}}},target:g,additionalComponents:{schemas:{A:{type:"object",properties:{c:{$ref:"#/components/schemas/A"}}}}},circular:!0})}},r={args:{schema:h({target:g,schema:{type:"string",format:"date-time",description:"Date Time in Range","x-min-date":"2026-01-01","x-max-date":"2026-12-31"}})}};var s,t,a;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    schema: {}
  }
