import{D as Pe,a as Te}from"./constants-2b09506c.js";import{b as e}from"./graph-api-transformers-1523e75e.js";import{g as we,I as ve,S as Q}from"./NestingIndicatorTitleRow-5a23a188.js";import{j as qe}from"./_commonjs-dynamic-modules-6308e768.js";import{p as xe}from"./preprocess-9ed914ff.js";import{G as je}from"./GraphQLOperationDiffViewer-3eabfae4.js";import"./index-f46741a2.js";import"./buildASTSchema-062943ba.js";import"./model-26badf15.js";import"./index-415bee12.js";const Oe=f=>{const{beforeSource:Ge,afterSource:Ne,circular:Be=!1}=f,De=xe({beforeSource:Ge,afterSource:Ne,circular:Be});return qe.jsx(je,{...f,source:De})};Oe.__docgenInfo={description:"",methods:[],displayName:"TestGraphQLOperationDiffViewer",props:{beforeSource:{required:!1,tsType:{name:"unknown"},description:""},afterSource:{required:!0,tsType:{name:"unknown"},description:""},circular:{required:!1,tsType:{name:"boolean"},description:""}}};const Ke={title:"GraphQL Operation Diff Viewer/Output",component:Oe,parameters:{},argTypes:{beforeSource:{control:"object"},afterSource:{control:"object"},layoutMode:{control:"radio",options:[we,ve,Q]},filters:{control:"check",options:["breaking","non-breaking","annotation","unclassified","deprecated"]}},args:{layoutMode:Q,metaKeys:{diffsMetaKey:Pe,aggregatedDiffsMetaKey:Te}}},r={args:{beforeSource:e(`
      type Query {
