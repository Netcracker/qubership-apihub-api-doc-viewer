 ...
 */
export declare const DEFAULT_EXPANDED_DEPTH: number;
export declare const INFINITY_EXPANDING_DEPTH: number;
export declare const DIFF_META_KEY: unique symbol;
...
export declare const DEFAULT_ROW_PADDING_LEFT = "pl-0";
export declare const SHIFTED_ROW_PADDING_LEFT = "pl-5";
