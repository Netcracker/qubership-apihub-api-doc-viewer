...
export declare function isColumnsNodeWithDiffs(node: ITreeNode): node is DdlApiTreeNodeWithDiffs<typeof DdlApiTreeNodeKinds.COLUMNS>;
export declare function isIndexesNodeWithDiffs(node: ITreeNode): node is DdlApiTreeNodeWithDiffs<typeof DdlApiTreeNodeKinds.INDEXES>;
